...
public class BeanProcessor {
    ...
    private String getCamelName(String name){
		...
		if(name.indexOf("_")!=-1){
			...
			aname = name.substring(0,indexOf);
			bname = name.substring(indexOf+2);
			fname = name.substring(indexOf+1,indexOf+2).toUpperCase();
			name = aname + fname + bname;
			name = getCamelName(name);
		}
		ename = name.substring(0,1).toUpperCase();
    ...
    protected int[] mapColumnsToProperties(ResultSetMetaData rsmd,
        ...
        for (int col = 1; col <= cols; col++) {
            ...
            columnName = getCamelName(columnName);
