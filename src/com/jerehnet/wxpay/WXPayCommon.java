...
import java.net.*;
import java.util.*;
import com.jerehnet.wxpay.*;

import javax.servlet.http.HttpServletRequest;
import com.jerehnet.wxpay.RandomUtils;
import com.jerehnet.wxpay.WXPayConstants.SignType;
public class WXPayCommon {
	...
	public String weixinPay(HttpServletRequest request){
		...
		try{
			...
			querys.put("notify_url", "http://192.168.40.88:10031/tools/wxpay/notify_url.jsp");//支付回调地址 todo
