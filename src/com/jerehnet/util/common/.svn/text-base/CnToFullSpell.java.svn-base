...
public class CnToFullSpell {
	...
	public static void main(String[] args) {
		String str = null;
		str = "谢海101普降喜雨";
		System.out.println("Spell=" + CnToFullSpell.getFullSpell(str));

		str = "张牙舞爪》。，";
		System.out.println("Spell=" + CnToFullSpell.getFirstSpell(str));
