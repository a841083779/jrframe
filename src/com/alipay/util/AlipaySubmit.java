...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        }else if(AlipayConfig.getSign_type().equals("RSA") ){
            mysign = RSA.sign(prestr, AlipayConfig.getKey(), AlipayConfig.getInput_charset());
        }
        return mysign;
    }
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfig.getPartner() + "&_input_charset" + AlipayConfig.getInput_charset();
