...
<form name="theform" id="theform" action="/admin/action/crud.jsp">
  <div class="formDiv">
    ...
    <div class="formRight">
      <input type="text" dataType='Require' msg='请输入用户名' class="jr_text" name="zd_usern" id="zd_usern" value="<%=CommonString.getFormatPara(model.get("usern")) %>"  readonly="readonly"/>
    </div>
