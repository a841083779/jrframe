...
<form name="theform" id="theform" action="/admin/action/crud.jsp">
  <div class="formDiv">
  　<div class="group"> <span> <img src="/plugin/ui/ligerUI/ligerUI/skins/icons/communication.gif"/> </span> <span class="groupTitle">产品信息</span> </div>
    ...
    <div class="formRight">
      <input type="text" class="jr_text" name="zd_product_name" id="zd_product_name" value="<%=CommonString.getFormatPara(model.get("product_name")) %>" readonly="readonly"/>
    </div>
