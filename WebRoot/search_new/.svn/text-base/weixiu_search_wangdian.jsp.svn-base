...
<%
	...
	if((keywordCheck+tempFactory+tempCatalog).equals("")){
	   ...
	   whereStr="full_name:" + keywordCheck+tempFactory+tempCatalog;
	}
    /*查询*/	
    query.setQuery(whereStr);	
	int pageSize = 10;
   ...
   %>    <form name="theform" id="theform">
      <div class="border03 l Condition mb10 nwx_net_sea">
        <div class="ConditionTop">
          <div class="l"> </div>
          <h1 class="r" style="font-size:14px;">工程机械维修网点</h1>
        </div>
    ...
    <div class="rp clearfix mb10 nwx_zxlist repairList border0">
      <div class="agent_list border0">
		...
		for(SolrDocument m : products){	
            ...
            String city= CommonString.getFormatPara(m.getFieldValue("city"));
