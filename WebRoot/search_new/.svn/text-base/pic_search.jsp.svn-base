...
<li class="cblist">
  <dt> 品牌 </dt>
  <dd><a href="/<%=keywordCheck%>_0_0_0_0.htm"  class="select" >不限</a> <a  href="/<%=keywordCheck%>_0_174_0_0.htm" >卡特彼勒</a> <a href="/<%=keywordCheck%>_0_137_0_0.htm" >临工</a> <a  href="/<%=keywordCheck%>_0_136_0_0.htm" >柳工</a> <a  href="/<%=keywordCheck%>_0_138_0_0.htm" >山工</a> <a  href="/<%=keywordCheck%>_0_135_0_0.htm" >龙工</a> <a  href="/<%=keywordCheck%>_0_209_0_0.htm" >徐工</a> <a  href="/<%=keywordCheck%>_0_144_0_0.htm" >山推</a> <a  href="/<%=keywordCheck%>_0_133_0_0.htm" >三一</a> <a  href="/<%=keywordCheck%>_0_192_0_0.htm" >斗山</a> <a  href="/<%=keywordCheck%>_0_182_0_0.htm" >小松</a> <a  href="/<%=keywordCheck%>_0_175_0_0.htm" >沃尔沃</a> <a  href="/<%=keywordCheck%>_0_157_0_0.htm" >力士德</a>
		 ...
		 %>
          	<li>
            	<a href="<%=url%>" title="<%=titleAlt%>" target="_blank">
                	<img src="<%=img%>" alt="<%=titleAlt%>"/>
                    <div class="pse_title"><%=title%></div>
					
                    <p class="pse_all">共6张图</p>
      ...
      <div class=" border03 l Condition mb10">
        ...
        jQuery(document).ready(function() {
          ...
          <li class="cblist" id="grab">
            <dt> 图片<br>分类</dt>
            <dd> 
               <a href="/0_0_0_0_0.htm">产品图片</a>
               <a href="/0_107001_0_0_0.htm">行业图片</a>
               <a href="/0_107003_0_0_0.htm">施工图片</a>
               <a href="/0_107004_0_0_0.htm">维修图片</a>
               <a href="/0_107005_0_0_0.htm">展会图片</a>
			   <a href="/0_107006_0_0_0.htm">趣味图片</a>          
            </dd>
          </li>
        </ul>
      </div>
...
<div class="contain980">  
	<div class="nse_foot_search"><span>重新搜索</span><input onkeypress="tj();" value="挖掘机" name="keyword" id="keywords" type="text" class="nse_foot_seinp">
