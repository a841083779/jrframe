...
-->
          ...
          <li class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_psum">
                  <div style="width:300px;float:left">总长度：9531</div>
                  <div style="width:300px;float:left">总宽度：3170</div>
                  <div style="width:300px;float:left">总高度（至驾驶棚顶部）：2960</div>
              ...
              <div class="oi"> <span class="pmh">
                ...
                <div class="tsx_pprice tsx_duibi0726"> <a data-val="30221" href="javascript:;">+加入对比</a> </div>
                </span> </div>
            </div>
          </li>
          <%}%>
          ...
          <li class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_psum">
                  <div style="width:300px;float:left">总长度：6369mm</div>
                  <div style="width:300px;float:left">总宽度：2030mm</div>
                  <div style="width:300px;float:left">总高度：2710mm</div>
          ...
          <li class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_psum">
                  <div style="width:300px;float:left">总长度：312 mm</div>
                  <div style="width:300px;float:left">总宽度：1878 mm</div>
                  <div style="width:300px;float:left">总高度（至驾驶棚顶部）：2540 mm</div>
          ...
          <li class="active">
            <div class="box">
              <div class="tsx_pimg"> <a href="http://product.21-sun.com/proDetail/DX150LC-9C-82.shtm" title="斗山DX150LC-9C履带挖掘机" target="_blank"><img src="http://product.21-sun.com/uploadfiles//image/2016/12/20161216154302_436.jpg" alt="斗山DX150LC-9C履带挖掘机" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
              <div class="tsx_pnr">
                <h2 class="txs_ptitle"><a href="http://product.21-sun.com/proDetail/DX150LC-9C-82.shtm" target="_blank" title="斗山DX150LC-9C履带挖掘机">斗山DX150LC-9C履带挖掘机</a></h2>
                <div class="txs_plink"><span class="pmhide"></span> <a href="http://product.21-sun.com/proDetail/DX150LC-9C-82.shtm#xingn" target="_blank" title="斗山DX150LC-9C履带挖掘机性能">性能</a><em>|</em> <a href="http://product.21-sun.com/proDetail/DX150LC-9C-82.shtm#cans" target="_blank" title="斗山DX150LC-9C履带挖掘机参数">参数</a><em>|</em> <a href="http://product.21-sun.com/proDetail/DX150LC-9C-82_message.shtm#position" target="_blank" title="斗山DX150LC-9C履带挖掘机口碑">口碑</a><em>|</em> <a href="http://product.21-sun.com/proDetail/DX150LC-9C-82_pic.shtm#position" target="_blank" title="斗山DX150LC-9C履带挖掘机图片">图片</a><em>|</em> <a href="http://product.21-sun.com/proDetail/DX150LC-9C-82_agent.shtm#position" target="_blank" title="斗山DX150LC-9C履带挖掘机代理商">代理商</a> </div>
                <div class="txs_psum"> <div style="width:300px;float:left">总长度：7662</div><div style="width:300px;float:left">总宽度：2530</div><div style="width:300px;float:left">总高度（至驾驶棚顶部）：2773</div> <a href="http://product.21-sun.com/proDetail/DX150LC-9C-82.shtm" target="_blank">[查看详情]</a> </div>
                <div class="" style=""> <span class="thisxj"> <b>询价（474）</b> </span> <a href="javascript:void(0)" class="add_inquiry" data-val="29007"> <b>加入询价</b></a> <a href="javascript:void(0)" class="add_compare" data-val="29007" style="color: #6666dd;"> <b>加入对比</b></a> <a title="更多斗山挖掘机" class="morepro" href="http://product.21-sun.com/products/prolist.jsp?factory=192&catalog=101001" target="_blank"><b>更多斗山挖掘机</b></a>
					<div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div> 
                </div>
              </div>
              <div class="oi"> <span class="pmh">
                <div class="tsx_pprice"> <a href="javascript:;" onclick="showinquery('29007','')">询低价</a> </div>
                <div class="tsx_pprice tsx_duibi0726"> <a data-val="29007" href="javascript:;" class="add_compare_param">+对比参数</a> </div>
                </span> </div>
            </div>
          </li>
          <%}%>
         ...
         <li class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                <h2 class="txs_ptitle"><a href="http://product.21-sun.com/proDetail/320GC.shtm" target="_blank" title="卡特彼勒Cat<sup>®</sup> 320 GC液压挖掘机">卡特彼勒Cat<sup>®</sup> 320 GC液压挖掘机</a></h2>
                <div class="txs_plink"><span class="pmhide"></span> <a href="http://product.21-sun.com/proDetail/320GC.shtm#xingn" target="_blank" title="卡特彼勒Cat<sup>®</sup> 320 GC液压挖掘机性能">性能</a><em>|</em> <a href="http://product.21-sun.com/proDetail/320GC.shtm#cans" target="_blank" title="卡特彼勒Cat<sup>®</sup> 320 GC液压挖掘机参数">参数</a><em>|</em> <a href="http://product.21-sun.com/proDetail/320GC_message.shtm#position" target="_blank" title="卡特彼勒Cat<sup>®</sup> 320 GC液压挖掘机口碑">口碑</a><em>|</em> <a href="http://product.21-sun.com/proDetail/320GC_pic.shtm#position" target="_blank" title="卡特彼勒Cat<sup>®</sup> 320 GC液压挖掘机图片">图片</a><em>|</em> <a href="http://product.21-sun.com/proDetail/320GC_agent.shtm#position" target="_blank" title="卡特彼勒Cat<sup>®</sup> 320 GC液压挖掘机代理商">代理商</a> </div>
                <div class="txs_psum"> <div style="width:300px;float:left">总长度：9531</div><div style="width:300px;float:left">总宽度：3170</div><div style="width:300px;float:left">总高度（至驾驶棚顶部）：2960</div> <a href="http://product.21-sun.com/proDetail/320GC.shtm" target="_blank">[查看详情]</a> </div>
                <div class="" style=""> <span class="thisxj"> <b>询价（209）</b> </span> <a href="javascript:void(0)" class="add_inquiry" data-val="30221"> <b>加入询价</b></a> <a href="javascript:void(0)" class="add_compare" data-val="30221" style="color: #6666dd;"> <b>加入对比</b></a> <a title="更多卡特挖掘机" class="morepro" href="http://product.21-sun.com/products/prolist.jsp?factory=174&catalog=101001" target="_blank"><b>更多卡特挖掘机</b></a>
					<div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>
                </div>
              </div>
          ...
          <%if(wajueji==2){%>
            <li class="active">
            <div class="box">
              <div class="tsx_pimg"> <a href="http://product.21-sun.com/proDetail/SY35.shtm" title="三一SY35U微型液压挖掘机" target="_blank"><img src="http://product.21-sun.com/uploadfiles//image/2018/05/20180522085852_189.jpg" alt="三一SY35U微型液压挖掘机" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
              <div class="tsx_pnr">
                ...
                <div class="txs_psum"> <div style="width:300px;float:left">总长度：4915</div><div style="width:300px;float:left">总宽度：1720</div><div style="width:300px;float:left">总高度（至动臂顶部）：2515</div> <a href="http://product.21-sun.com/proDetail/SY35.shtm" target="_blank">[查看详情]</a> </div>
           ...
           <li class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_psum"> <div style="width:300px;float:left">总长度：8062</div><div style="width:300px;float:left">总宽度：2963</div><div style="width:300px;float:left">总高度：3348</div> <a href="http://product.21-sun.com/proDetail/SEM652D.shtm" target="_blank">[查看详情]</a> </div>
          ...
          <li  class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_psum"> <div style="width:300px;float:left">斗容范围：2.2～3.6</div><div style="width:300px;float:left">整机操作质量：16800</div><div style="width:300px;float:left">额定载重量：5000</div> <a href="http://product.21-sun.com/proDetail/XG951H.shtm" target="_blank">[查看详情]</a> </div>
           ...
           <li class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_psum"> <div style="width:300px;float:left">总宽度：3024</div><div style="width:300px;float:left">总高度：3480</div><div style="width:300px;float:left">总长度：8125</div> <a href="http://product.21-sun.com/proDetail/YX656HPLUS.shtm" target="_blank">[查看详情]</a> </div>
           ...
           <li class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_psum"> <div style="width:300px;float:left">整机操作质量：20000±5%(kg)</div><div style="width:300px;float:left">斗容范围：3.5(m3)</div><div style="width:300px;float:left">额定载重量：6000(Kg)</div> <a href="http://product.21-sun.com/proDetail/966.shtm" target="_blank">[查看详情]</a> </div>
          ...
          <li class="active">
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_psum"> <div style="width:300px;float:left">总长度：5600</div><div style="width:300px;float:left">总宽度：1840</div><div style="width:300px;float:left">总高度：2670</div> <a href="http://product.21-sun.com/proDetail/926-93.shtm" target="_blank">[查看详情]</a> </div>
...
<span><a style="color:red;font-weight:bold" target="_blank" href="http://product.21-sun.com/3d/detail.jsp?id=<%=id%>">写口碑</a></span>
<%}%>
