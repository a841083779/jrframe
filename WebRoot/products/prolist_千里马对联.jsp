...
<div class="w757 r mb10">
  ...
  <div style="clear:both; padding:0px 0px 10px;">
  	...
  	%>
  	<a href="http://www.wajueji.com/cat/index.jsp" target="_blank"><img src="/images/cat_xw_ad.jpg" width="757" height="70" /></a>
  	<%
  		}else if(catalog.startsWith("101002")){ //装载机-山工广告
  	%>
  	<a href="http://product.21-sun.com<%=url%>?factory=138&catalog=101002" target="_blank"><img src="/images/shangong_ad.jpg" width="757" height="70" /></a>
  	<%
  		}else{
  	%>
...
<script type="text/javascript">
	...
	jQuery.ajax({
		...
		type:"post",
		data:{"flag":"product","factoryid":"<%=factoryid%>","catalog":"<%=catalog%>","url":"<%=url%>"},
...
<!--对联广告-->
<div id="ads01">
<a href="http://used.21-sun.com/qlmtuan/index.htm" target="blank" title="千里马二手机大惠战" onMouseOver="document.getElementById('ads01').className='ads_hover';document.getElementById('ads02').className='ads_hover'" onMouseOut="document.getElementById('ads01').className='';document.getElementById('ads02').className=''" style="display:block;"><img src="http://ad.21-sun.com/homepic/qlm/qlm_x.jpg" width="42" height="330" alt="千里马二手机大惠战" class="ads_small" /><img src="http://ad.21-sun.com/homepic/qlm/qlm_d.jpg" width="95" height="330" alt="千里马二手机大惠战" class="ads_big" /></a>
