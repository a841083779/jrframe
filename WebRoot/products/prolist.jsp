...
<div class="wrap main fix">
  ...
  <div class="page_right r">
    ...
    <div class="screening">
      ...
      <div class="sc_line fix line_kind">
        ...
        <div class="line_main l fix">
          ...
          <%
		  if(CommonString.getFormatInt(cataProMap.get(CommonString.getFormatPara(oneMap.get("num"))))>0){
		  %>
      ...
      <div class="sc_line fix line_kind">
		...
		%>
          ...
          <%
		  if(CommonString.getFormatInt(brandProMap.get((CommonString.getFormatPara(oneMap.get("num")))))>0){
		  %>
      ...
      <div class="sc_line fix line_kind">
        ...
        <div class="line_main l fix">
          ...
          <%if(allSum>0){%><a title="<%=CommonString.getFormatPara(oneMap.get("name"))%>" href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=<%=CommonString.getFormatPara(oneMap.get("num"))%><%=tonandmeter.equals("")?"":"&tonandmeter="+tonandmeter%><%=year.equals("1")?"":"&year="+year%>" class="l"><%=CommonString.getFormatPara(oneMap.get("name"))%><span>(<%=allSum%>)</span></a><%}%>
          <%}else if(factoryid.equals("")){%>
          <%if(CommonString.getFormatInt(cataProMap.get((CommonString.getFormatPara(oneMap.get("num")))))>0){%><a title="<%=CommonString.getFormatPara(oneMap.get("name"))%>" href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=<%=CommonString.getFormatPara(oneMap.get("num"))%><%=tonandmeter.equals("")?"":"&tonandmeter="+tonandmeter%><%=year.equals("1")?"":"&year="+year%>" class="l"><%=CommonString.getFormatPara(oneMap.get("name"))%><span>(<%=CommonString.getFormatInt(cataProMap.get((CommonString.getFormatPara(oneMap.get("num")))))%>)</span></a><%}%>
          <%}else{if(CommonString.getFormatInt(brandProMap.get(factoryid+"_"+(CommonString.getFormatPara(oneMap.get("num")))))!=0){%>
          <%if(CommonString.getFormatInt(brandProMap.get(factoryid+"_"+(CommonString.getFormatPara(oneMap.get("num")))))>0){%><a title="<%=CommonString.getFormatPara(oneMap.get("name"))%>" href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=<%=CommonString.getFormatPara(oneMap.get("num"))%><%=tonandmeter.equals("")?"":"&tonandmeter="+tonandmeter%><%=year.equals("1")?"":"&year="+year%>" class="l"><%=CommonString.getFormatPara(oneMap.get("name"))%><span>(<%=CommonString.getFormatInt(brandProMap.get(factoryid+"_"+(CommonString.getFormatPara(oneMap.get("num")))))%>)</span></a><%}%>
          <%}}%>
          <%}%>
          <%}%>
        </div>
    ...
    <div class="marketing">
	  ...
	  <a title="三一SY60C挖掘机" target="_blank" href="http://product.21-sun.com/proDetail/28675.shtm" class="l el">三一SY60C挖掘机</a>
	  <a title="小松PC70-8挖掘机" target="_blank" href="http://product.21-sun.com/proDetail/PC70-8.shtm" class="l el">小松PC70-8挖掘机</a>
	  <a title="卡特彼勒307E2挖掘机" target="_blank" href="http://product.21-sun.com/proDetail/307E2.shtm" class="l el">卡特彼勒307E2挖掘机</a> 
	  <a title="卡特彼勒Cat®320GC挖掘机" target="_blank" href="http://product.21-sun.com/proDetail/320GC.shtm" class="l el">卡特彼勒Cat®320GC挖掘机</a>
	  <a title="山工机械SEM618D装载机" target="_blank" href="http://product.21-sun.com/proDetail/SEM618B.shtm" class="l el">山工机械SEM618D装载机</a> 
	  <a title="山东临工L933装载机" target="_blank" href="http://product.21-sun.com/proDetail/L933.shtm" class="l el">山东临工L933装载机</a> 
	  <a title="英轩重工YX655装载机" target="_blank" href="http://product.21-sun.com/proDetail/YX655.shtm" class="l el">英轩重工YX655装载机</a> 
	  <a title="厦工XG932H轮式装载机" target="_blank" href="http://product.21-sun.com/proDetail/XG932H.shtm" class="l el">厦工XG932H轮式装载机</a>
	  <a title="三一SAC12000起重机" target="_blank" href="http://product.21-sun.com/proDetail/SAC12000.shtm" class="l el">三一SAC12000起重机</a> 
	  <a title="徐工QY25K5-I起重机" target="_blank" href="http://product.21-sun.com/proDetail/QY25K5-I.shtm" class="l el">徐工QY25K5-I起重机</a>
	  </div>
    </div>
    <!--热门机型 end-->
    <%}%>
    ...
    <div class="show_main">
      ...
      <div class="shm_con">
		 ...
		 if(factoryid.equals("174")){
	     %>
          <a href="http://zhuanti.21-sun.com/cat2019_1212/" target="_blank" ><img src="/images/cat2019_1212_list.jpg" /></a>
         <%}%>
        ...
        <%}%>
		<%if(( catalog.indexOf("106001")>=0)&&factoryid.equals("")&&nowPage==1){%>
        <div class="con_item fix on">
          <div class="item_img l"> <a title="三一SSR220AC-8H全液压单驱单钢轮压路机" href="http://product.21-sun.com/proDetail/38130.shtm" target="_blank"><img alt="三一SSR220AC-8H全液压单驱单钢轮压路机" src="http://product.21-sun.com/uploadfiles//image/2019/08/20190816104228_433.jpg" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
          <div class="item_main l fix">
            <div class="title l fix">
              <h2 class="l"><a href="http://product.21-sun.com/proDetail/38130.shtm" target="_blank">三一SSR220AC-8H全液压单驱单钢轮压路机</a></h2>
              <div class="links fix l"> <a href="http://product.21-sun.com/proDetail/38130.shtm" target="_blank" title="三一SSR220AC-8H全液压单驱单钢轮压路机性能">性能</a>| <a href="http://product.21-sun.com/proDetail/38130_parameter.shtm" target="_blank" title="三一SSR220AC-8H全液压单驱单钢轮压路机参数">参数</a>| <a href="http://product.21-sun.com/proDetail/38130_message.shtm" target="_blank" title="三一SSR220AC-8H全液压单驱单钢轮压路机口碑">口碑</a>| <a href="http://product.21-sun.com/proDetail/38130_pic.shtm" target="_blank" title="三一SSR220AC-8H全液压单驱单钢轮压路机图片">图片</a>| <a href="http://product.21-sun.com/proDetail/38130_agent.shtm" target="_blank" title="三一SSR220AC-8H全液压单驱单钢轮压路机代理商">代理商</a> </div>
            </div>
            <div class="paras l fix">
              <p class="l">工作重量：22000</p>
              <p class="l">钢轮直径：1600</p>
              <p class="l">振动频率：29/35</p>
              <a href="http://product.21-sun.com/proDetail/38130.shtm" target="_blank" class="l">[查看详情]</a> </div>
            <div class="btns l fix"> <a href="javascript:;" onclick="showinquery('38130','')" class="r ask_it">询低价</a> <a data-val="38130" href="javascript:void(0)" class="r com_it add_compare_param">+对比参数</a> </div>
            <div class="oths l"> <span>询价（10）</span> <a class="add_inquiry" data-val="38130" href="javascript:void(0)">加入询价</a> <a class="add_compare" data-val="38130" href="javascript:void(0)">加入对比</a> <a title="更多三一压路机" href="http://product.21-sun.com/products/prolist.jsp?factory=133&catalog=106001" target="_blank">更多三一压路机</a> </div>
          </div>
        </div>
        <%}%>
        ...
        <%if(wajueji!=0&&wajueji!=2&&wajueji!=5&&wajueji!=6&&wajueji!=7&&wajueji!=8){%>
        <div class="con_item fix on">
          <div class="item_img l"> <a title="卡特彼勒新一代CAT<sup>®</sup>301.5迷你型挖掘机" href="http://product.21-sun.com/proDetail/3015.shtm" target="_blank"><img alt="卡特彼勒新一代CAT<sup>®</sup>301.5迷你型挖掘机" src="http://product.21-sun.com/uploadfiles//image/2019/09/20190918132503_887.jpg" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
          <div class="item_main l fix">
            <div class="title l fix">
              <h2 class="l"><a href="http://product.21-sun.com/proDetail/3015.shtm" target="_blank">卡特彼勒新一代CAT<sup>®</sup>301.5迷你型挖掘机</a></h2>
              <div class="links fix l"> <a href="http://product.21-sun.com/proDetail/3015.shtm" target="_blank" title="卡特彼勒新一代CAT<sup>®</sup>301.5迷你型挖掘机性能">性能</a>| <a href="http://product.21-sun.com/proDetail/3015_parameter.shtm" target="_blank" title="卡特彼勒新一代CAT<sup>®</sup>301.5迷你型挖掘机参数">参数</a>| <a href="http://product.21-sun.com/proDetail/3015_message.shtm" target="_blank" title="卡特彼勒新一代CAT<sup>®</sup>301.5迷你型挖掘机口碑">口碑</a>| <a href="http://product.21-sun.com/proDetail/3015_pic.shtm" target="_blank" title="卡特彼勒新一代CAT<sup>®</sup>301.5迷你型挖掘机图片">图片</a>| <a href="http://product.21-sun.com/proDetail/3015_agent.shtm" target="_blank" title="卡特彼勒新一代CAT<sup>®</sup>301.5迷你型挖掘机代理商">代理商</a> </div>
            </div>
            <div class="paras l fix">
              
              <p class="l">最大挖掘高度：3430 mm</p><p class="l">最大卸载高度：2450 mm</p><p class="l">工作重量：1630 kg(配顶篷)</p>
              
              
              <a href="http://product.21-sun.com/proDetail/3015.shtm" target="_blank" class="l">[查看详情]</a>
              
            </div>
            <div class="btns l fix"> <a href="javascript:;" onclick="showinquery('31806','')" class="r ask_it">询低价</a> <a data-val="31806" href="javascript:void(0)" class="r com_it add_compare_param">+对比参数</a> </div>
            <div class="oths l"> <span>询价（262）</span> <a class="add_inquiry" data-val="31806" href="javascript:void(0)">加入询价</a> <a class="add_compare" data-val="31806" href="javascript:void(0)">加入对比</a> <a title="更多卡特挖掘机" href="http://product.21-sun.com/products/prolist.jsp?factory=174&amp;catalog=101001" target="_blank">更多卡特挖掘机</a> </div>
          </div>
        </div>
        <%}%>
        <%if(wajueji==2){%>
	...
	<div class="con_item fix on">
          <div class="item_img l"> <a title="山东临工ER616F履带挖掘机" href="http://product.21-sun.com/proDetail/ER616F.shtm" target="_blank"><img alt="山东临工ER616F履带挖掘机" src="http://product.21-sun.com/uploadfiles//image/2017/10/20171027085459_379.jpg" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
          <div class="item_main l fix">
            <div class="title l fix">
              <h2 class="l"><a href="http://product.21-sun.com/proDetail/ER616F.shtm" target="_blank">山东临工ER616F履带挖掘机</a></h2>
              <div class="links fix l"> <a href="http://product.21-sun.com/proDetail/ER616F.shtm" target="_blank" title="山东临工ER616F履带挖掘机性能">性能</a>| <a href="http://product.21-sun.com/proDetail/ER616F_parameter.shtm" target="_blank" title="山东临工ER616F履带挖掘机参数">参数</a>| <a href="http://product.21-sun.com/proDetail/ER616F_message.shtm" target="_blank" title="山东临工ER616F履带挖掘机口碑">口碑</a>| <a href="http://product.21-sun.com/proDetail/ER616F_pic.shtm" target="_blank" title="山东临工ER616F履带挖掘机图片">图片</a>| <a href="http://product.21-sun.com/proDetail/ER616F_agent.shtm" target="_blank" title="山东临工ER616F履带挖掘机代理商">代理商</a> </div>
            </div>
            <div class="paras l fix">
              
              <p class="l">最大卸载高度：2490</p><p class="l">工作重量：1880</p><p class="l">标准铲斗容量：0.04</p>
              
              
              <a href="http://product.21-sun.com/proDetail/ER616F.shtm" target="_blank" class="l">[查看详情]</a>
              
            </div>
            <div class="btns l fix"> <a href="javascript:;" onclick="showinquery('30265','')" class="r ask_it">询低价</a> <a data-val="30265" href="javascript:void(0)" class="r com_it add_compare_param">+对比参数</a> </div>
            <div class="oths l"> <span>询价（111）</span> <a class="add_inquiry" data-val="30265" href="javascript:void(0)">加入询价</a> <a class="add_compare" data-val="30265" href="javascript:void(0)">加入对比</a> <a title="更多山东临工挖掘机" href="http://product.21-sun.com/products/prolist.jsp?factory=137&amp;catalog=101001" target="_blank">更多山东临工挖掘机</a> </div>
          </div>
        </div>
		 <%}%>
		 <%if(wajueji==8){%>
        <div class="con_item fix on">
          <div class="item_img l"> <a title="山河智能SWE60E挖掘机" href="http://product.21-sun.com/proDetail/SWE60E.shtm" target="_blank"><img alt="山河智能SWE60E挖掘机" src="http://product.21-sun.com/uploadfiles//image/2014/01/20140128085111_45.jpg" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
          <div class="item_main l fix">
            <div class="title l fix">
              <h2 class="l"><a href="http://product.21-sun.com/proDetail/SWE60E.shtm" target="_blank">山河智能SWE60E挖掘机</a></h2>
              <div class="links fix l"> <a href="http://product.21-sun.com/proDetail/SWE60E.shtm" target="_blank" title="山河智能SWE60E挖掘机性能">性能</a>| <a href="http://product.21-sun.com/proDetail/SWE60E_parameter.shtm" target="_blank" title="山河智能SWE60E挖掘机参数">参数</a>| <a href="http://product.21-sun.com/proDetail/SWE60E_message.shtm" target="_blank" title="山河智能SWE60E挖掘机口碑">口碑</a>| <a href="http://product.21-sun.com/proDetail/SWE60E_pic.shtm" target="_blank" title="山河智能SWE60E挖掘机图片">图片</a>| <a href="http://product.21-sun.com/proDetail/SWE60E_agent.shtm" target="_blank" title="山河智能SWE60E挖掘机代理商">代理商</a> </div>
            </div>
            <div class="paras l fix">
              <p class="l">最大挖掘高度：5610</p>
              <p class="l">最大卸载高度：3995</p>
              <p class="l">工作重量：6.13</p>
              <a href="http://product.21-sun.com/proDetail/SWE60E.shtm" target="_blank" class="l">[查看详情]</a> </div>
            <div class="btns l fix"> <a href="javascript:;" onclick="showinquery('21017','')" class="r ask_it">询低价</a> <a data-val="21017" href="javascript:void(0)" class="r com_it add_compare_param">+对比参数</a> </div>
            <div class="oths l"> <span>询价（240）</span> <a class="add_inquiry" data-val="21017" href="javascript:void(0)">加入询价</a> <a class="add_compare" data-val="21017" href="javascript:void(0)">加入对比</a> <a title="更多山河智能挖掘机" href="http://product.21-sun.com/products/prolist.jsp?factory=142&catalog=101001" target="_blank">更多山河智能挖掘机</a> </div>
          </div>
        </div>
        <%}%>
        <%}%>
        ...
        <%}%>
        <%}%>
		<%if(catalog.equals("105")&&factoryid.equals("")&&nowPage==1){Random rand =new Random();int xuanwazuan;xuanwazuan=rand.nextInt(3);%>
		<%if(xuanwazuan==0){%>
        <div class="con_item fix on">
          <div class="item_img l"> <a title="三一SR200C旋挖钻机" href="http://product.21-sun.com/proDetail/SR200C.shtm" target="_blank"><img alt="三一SR200C旋挖钻机" src="http://product.21-sun.com/uploadfiles//image/2015/12/20151223134724_968.jpg" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
          <div class="item_main l fix">
            <div class="title l fix">
              <h2 class="l"><a href="http://product.21-sun.com/proDetail/SR200C.shtm" target="_blank">三一SR200C旋挖钻机</a></h2>
              <div class="links fix l"> <a href="http://product.21-sun.com/proDetail/SR200C.shtm" target="_blank" title="三一SR200C旋挖钻机性能">性能</a>| <a href="http://product.21-sun.com/proDetail/SR200C_parameter.shtm" target="_blank" title="三一SR200C旋挖钻机参数">参数</a>| <a href="http://product.21-sun.com/proDetail/SR200C_message.shtm" target="_blank" title="三一SR200C旋挖钻机口碑">口碑</a>| <a href="http://product.21-sun.com/proDetail/SR200C_pic.shtm" target="_blank" title="三一SR200C旋挖钻机图片">图片</a>| <a href="http://product.21-sun.com/proDetail/SR200C_agent.shtm" target="_blank" title="三一SR200C旋挖钻机代理商">代理商</a> </div>
            </div>
            <div class="paras l fix">
              <p class="l">最大钻孔直径：1800</p>
              <p class="l">最大钻孔深度：60</p>
              <p class="l">最大起拨力：160</p>
              <a href="http://product.21-sun.com/proDetail/SR200C.shtm" target="_blank" class="l">[查看详情]</a> </div>
            <div class="btns l fix"> <a href="javascript:;" onclick="showinquery('2532','')" class="r ask_it">询低价</a> <a data-val="2532" href="javascript:void(0)" class="r com_it add_compare_param">+对比参数</a> </div>
            <div class="oths l"> <span>询价（492）</span> <a class="add_inquiry" data-val="2532" href="javascript:void(0)">加入询价</a> <a class="add_compare" data-val="2532" href="javascript:void(0)">加入对比</a> <a title="更多三一旋挖钻机" href="http://product.21-sun.com/products/prolist.jsp?factory=133&catalog=105003" target="_blank">更多三一旋挖钻机</a> </div>
          </div>
        </div>
        <%}%>
		<%if(xuanwazuan==1){%>
        <div class="con_item fix on">
          <div class="item_img l"> <a title="徐工XR360旋挖钻机" href="http://product.21-sun.com/proDetail/XR360XWZJ.shtm" target="_blank"><img alt="徐工XR360旋挖钻机" src="http://product.21-sun.com/uploadfiles//image/2015/05/20150525192438_863.jpg" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
          <div class="item_main l fix">
            <div class="title l fix">
              <h2 class="l"><a href="http://product.21-sun.com/proDetail/XR360XWZJ.shtm" target="_blank">徐工XR360旋挖钻机</a></h2>
              <div class="links fix l"> <a href="http://product.21-sun.com/proDetail/XR360XWZJ.shtm" target="_blank" title="徐工XR360旋挖钻机性能">性能</a>| <a href="http://product.21-sun.com/proDetail/XR360XWZJ_parameter.shtm" target="_blank" title="徐工XR360旋挖钻机参数">参数</a>| <a href="http://product.21-sun.com/proDetail/XR360XWZJ_message.shtm" target="_blank" title="徐工XR360旋挖钻机口碑">口碑</a>| <a href="http://product.21-sun.com/proDetail/XR360XWZJ_pic.shtm" target="_blank" title="徐工XR360旋挖钻机图片">图片</a>| <a href="http://product.21-sun.com/proDetail/XR360XWZJ_agent.shtm" target="_blank" title="徐工XR360旋挖钻机代理商">代理商</a> </div>
            </div>
            <div class="paras l fix">
              <p class="l">最大钻孔直径：2500</p>
              <p class="l">最大钻孔深度：96</p>
              <p class="l">最大起拨力：250</p>
              <a href="http://product.21-sun.com/proDetail/XR360XWZJ.shtm" target="_blank" class="l">[查看详情]</a> </div>
            <div class="btns l fix"> <a href="javascript:;" onclick="showinquery('6491','')" class="r ask_it">询低价</a> <a data-val="6491" href="javascript:void(0)" class="r com_it add_compare_param">+对比参数</a> </div>
            <div class="oths l"> <span>询价（929）</span> <a class="add_inquiry" data-val="6491" href="javascript:void(0)">加入询价</a> <a class="add_compare" data-val="6491" href="javascript:void(0)">加入对比</a> <a title="更多徐工旋挖钻机" href="http://product.21-sun.com/products/prolist.jsp?factory=209&catalog=105003" target="_blank">更多徐工旋挖钻机</a> </div>
          </div>
        </div>
        <%}%>
		...
		<%if(xuanwazuan==2){%>
        <div class="con_item fix on">
          <div class="item_img l"> <a title="山河智能SWDM220旋挖钻机" href="http://product.21-sun.com/proDetail/SWDM22.shtm" target="_blank"><img alt="山河智能SWDM220旋挖钻机" src="http://product.21-sun.com/uploadfiles//image/2014/01/20140128104720_328.jpg" onerror="this.src='/uploadfiles/no_big.gif';"></a> </div>
          <div class="item_main l fix">
            <div class="title l fix">
              <h2 class="l"><a href="http://product.21-sun.com/proDetail/SWDM22.shtm" target="_blank">山河智能SWDM220旋挖钻机</a></h2>
              <div class="links fix l"> <a href="http://product.21-sun.com/proDetail/SWDM22.shtm" target="_blank" title="山河智能SWDM220旋挖钻机性能">性能</a>| <a href="http://product.21-sun.com/proDetail/SWDM22_parameter.shtm" target="_blank" title="山河智能SWDM220旋挖钻机参数">参数</a>| <a href="http://product.21-sun.com/proDetail/SWDM22_message.shtm" target="_blank" title="山河智能SWDM220旋挖钻机口碑">口碑</a>| <a href="http://product.21-sun.com/proDetail/SWDM22_pic.shtm" target="_blank" title="山河智能SWDM220旋挖钻机图片">图片</a>| <a href="http://product.21-sun.com/proDetail/SWDM22_agent.shtm" target="_blank" title="山河智能SWDM220旋挖钻机代理商">代理商</a> </div>
            </div>
            <div class="paras l fix">
              <p class="l">最大钻孔直径：2000</p>
              <p class="l">最大钻孔深度：63</p>
              <p class="l">最大起拨力：210</p>
              <a href="http://product.21-sun.com/proDetail/SWDM22.shtm" target="_blank" class="l">[查看详情]</a> </div>
            <div class="btns l fix"> <a href="javascript:;" onclick="showinquery('2436','')" class="r ask_it">询低价</a> <a data-val="2436" href="javascript:void(0)" class="r com_it add_compare_param">+对比参数</a> </div>
            <div class="oths l"> <span>询价（62）</span> <a class="add_inquiry" data-val="2436" href="javascript:void(0)">加入询价</a> <a class="add_compare" data-val="2436" href="javascript:void(0)">加入对比</a> <a title="更多山河智能旋挖钻机" href="http://product.21-sun.com/products/prolist.jsp?factory=142&catalog=105003" target="_blank">更多山河智能旋挖钻机</a> </div>
          </div>
        </div>
        <%}%>
		<%}%>
