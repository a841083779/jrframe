...
<%
		...
		//List<Map> catalogList = (List) application.getAttribute("catalogListNew"); //新类别
		//Map catalogMap = (Map) application.getAttribute("catalogMapNew");
		//Map brandUsernMap = (HashMap) application.getAttribute("brandUsernMap"); // id 和 品牌代号对应
...
<div class="contain980 mb10"> 
  ...
  <div class="w210 l np_left">
	...
	<div id="leftId">
	 ...
	 <jsp:include page="/include/left_brandlist_new.jsp" flush="true">
      ...
      <li> <a href="/proDetail/<%=oneMap.get("file_name")%>"
        ...
        <div class="w618 r">
          ...
          <span class="info"> <a
								...
								.getFormatPara(oneMap.get("catalognum")).substring(0, 6))).replace("混凝土泵车","泵车").replace("混凝土布料设备","布料机") : CommonString.getFormatPara(oneMap.get("catalogname")).replace("混凝土泵车","泵车").replace("混凝土布料设备","布料机")%></a><em>|</em><a
