...
<% 
	...
	if((!c.equals("")&&!c.equals("0"))&&(catalog.equals("")||catalog.equals("0"))){
		catalog=c;
	}
	if((!f.equals("")&&!f.equals("0"))&&(factory.equals("")||factory.equals("0"))){
		factory=f;
	}
	if((!tont.equals("")&&!tont.equals("0"))&&(tonandmeter.equals("")||tonandmeter.equals("0"))){
		tonandmeter=tont;
	}	
	...
	Map cataTopProMap=(Map)application.getAttribute("cataTopProMap");
	
	if(request.getQueryString()!=null){
	String param_url = request.getQueryString().toString();

    if(offset.equals("0")&&param_url.indexOf("catalog")>=0&&param_url.indexOf("factory")>=0&&!factory.equals("")&&!catalog.equals("")&&param_url.indexOf("factory")>param_url.indexOf("catalog")){
		
		//response.setStatus(301);
		//response.setHeader("Location", "http://product.21-sun.com/products/prolist.jsp?factory="+factory+"&catalog="+catalog); 
		//return;	
	}	
	}
	//顶级类别
	...
	if(cataTopProMap==null){
		cataTopProMap=new HashMap();
	}
	...
	if (!"".equals(factoryid)) {  
		...
		filterQuery.add("factoryid:"+factoryid)	;
	}
	...
	int pageCount =0;
	if(totalParts%pageSize>0){
		pageCount=(int)(totalParts/pageSize)+1;
	}else{
		pageCount=(int)(totalParts/pageSize);
	}
	SolrDocumentList products = res.getResults();
	//TDK
	String seoKey="";
	if(catalognum_new.equals("106001")&&!ton.equals("")){
		seoKey=ton+"吨";
	}
	if(catalog.equals("102007")&&!ton.equals("")){
		seoKey=ton+"吨";
	}
	if(catalognum_new.equals("103001")&&!ton.equals("")){
		seoKey=ton+"米";
	}
	if(catalognum_new.indexOf("101001")>=0&&!ton.equals("")){
		seoKey=ton+"吨";
	}
	
	if(catalognum_new.indexOf("101001")>=0&&!m.equals("")&&!m.equals("yy")){
		seoKey=m+"";
	}
	...
	if(!ton.equals("")){
		newTitle=newTitle.replace("混凝土泵车","泵车");
		newTitleEnd=newTitleEnd.replace("混凝土泵车","泵车");
		newKeyWord=newKeyWord.replace("混凝土泵车","泵车");
		newDesc=newDesc.replace("混凝土泵车","泵车");
	}
	...
	if(m.equals("yy")){
			newKeyWord=newKeyWord.replace("履带挖掘机","液压挖掘机");
		    newDesc=newDesc.replace("履带挖掘机","液压挖掘机");
			newTitle=newTitle.replace("履带挖掘机","液压挖掘机");
	}
	if(ton.equals("3")&&catalog.equals("101002")){
		    newKeyWord="30装载机,30铲车,3吨装载机";
	}
	if(ton.equals("5")&&catalog.equals("101002")){
		    newKeyWord="50装载机,50铲车,5吨装载机";
	}
	
	
	if(catalog.equals("101001")&&tonandmeter.equals("g_4_8")&&factory.equals("")&&factoryids.equals("")){
			newDesc=newDesc.replace("挖掘机","小型挖掘机");
			newTitle=newTitle.replace("挖掘机","小型挖掘机");
	}
	if(catalog.equals("106001001")&&tonandmeter.equals("r_0_10")&&factory.equals("")&&factoryids.equals("")){
			newDesc=newDesc.replace("单钢轮压路机","小型压路机");
			newTitle=newTitle.replace("单钢轮压路机","小型压路机");
	}
	if(catalog.equals("101002")&&tonandmeter.equals("l_5_1")&&factory.equals("")&&factoryids.equals("")){
			newDesc=newDesc.replace("装载机","大型装载机");
			newTitle=newTitle.replace("装载机","大型装载机");
	}
	if(catalog.equals("105003")&&tonandmeter.equals("d_0.5_1")&&factory.equals("")&&factoryids.equals("")){
			newDesc=newDesc.replace("旋挖钻机","小型旋挖钻机");
			newTitle=newTitle.replace("旋挖钻机","小型旋挖钻机");
	}
	if(catalognum_new.equals("102007")&&tonandmeter.equals("")&&factory.equals("")&&factoryids.equals("")&&ton.equals("")){
		    newKeyWord="汽车起重机,汽车吊";
	}
	if(catalognum_new.equals("102006")&&tonandmeter.equals("")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord=newKeyWord.replace("随车起重机","随车吊");
		    newDesc=newDesc.replace("随车起重机","随车吊");
			newTitle=newTitle.replace("随车起重机","随车吊");
		    newTitleEnd=newTitleEnd.replace("随车起重机","随车吊");
	}
	if(catalognum_new.equals("101001")&&tonandmeter.equals("g_0_4")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord="微挖,微型挖掘机,迷你小挖机,挖掘机";
	}
	if(catalognum_new.equals("101002008")&&tonandmeter.equals("")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord="两头忙,挖掘装载机";
	}
	if(catalognum_new.equals("101001004")&&tonandmeter.equals("")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord="轮挖,轮式挖掘机,挖掘机";
	}
    if(catalognum_new.equals("101002")&&tonandmeter.equals("l_0_3")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord="小装,小型装载机,小铲车";
	}
	if(catalognum_new.equals("101001")&&tonandmeter.equals("g_30_1")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord="大型挖掘机,矿用挖掘机,挖掘机";
	}
	if(catalognum_new.equals("101001")&&tonandmeter.equals("")&&factory.equals("174")&&factoryids.equals("")){
		    newKeyWord="卡特挖掘机,卡特彼勒挖掘机";
	}
	if(catalognum_new.equals("106001001")&&tonandmeter.equals("r_0_10")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord="小型压路机";
			newTitle="小型压路机";
	}
	if(catalognum_new.equals("101002")&&tonandmeter.equals("l_5_1")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord="大型装载机";
			newTitle="大型装载机";
	}
	if(catalognum_new.equals("105003")&&tonandmeter.equals("d_0.5_1")&&factory.equals("")&&factoryids.equals("")){
		    newKeyWord="小型旋挖钻机";
			newTitle="小型旋挖钻机";
	}
	if(catalognum_new.equals("101001")&&tonandmeter.equals("g_0_4")&&factory.equals("")&&factoryids.equals("")){
	...
	if(catalognum_new.equals("101001")&&tonandmeter.equals("g_35_1")&&factory.equals("")&&factoryids.equals("")){
			newTitle="大型挖掘机";
	}
	if(catalognum_new.equals("101001")&&tonandmeter.equals("g_4_8")&&factory.equals("")&&factoryids.equals("")){
			newTitle="小型挖掘机";
			newKeyWord="小型挖掘机";
	}
	if(catalognum_new.equals("101002")&&tonandmeter.equals("l_0_3")&&factory.equals("")&&factoryids.equals("")){
	...
	if(catalognum_new.equals("140")){
		brandList = dbHelper.getMapList("select name,id,english_name,is_inner,upper_index  from pro_agent_factory where flag=1 and  is_show=1  and  id in(select distinct(pro_products.factoryid) from pro_products  where is_show=1 and (catalognum ='101001098' or catalognum ='101001098'  ))  order by  view_count desc",connection) ;
	}else if(catalognum_new.equals("101001")){
		brandList = dbHelper.getMapList("select name,id,english_name,is_inner,upper_index  from pro_agent_factory where flag=1 and  is_show=1  and  id in(select distinct(pro_products.factoryid) from pro_products  where is_show=1 and (catalognum ='101001001' or catalognum ='101001004' or catalognum ='101001007' ))  order by  view_count desc",connection) ;
	} else{
		if(!catalognum_new.equals("")){
		brandList = dbHelper.getMapList("select name,id,english_name,is_inner,upper_index  from pro_agent_factory where flag=1 and  is_show=1  and  id in(select distinct(pro_products.factoryid) from pro_products  where is_show=1 and catalognum like '"+catalognum_new+"%')  order by  view_count desc",connection) ;
	    }else{
		brandList = dbHelper.getMapList("select name,id,english_name,is_inner,upper_index  from pro_agent_factory where flag=1 and  is_show=1  order by view_count desc",connection) ;
	    }	
	}
	
	//品牌
	Map aa = (Map) application.getAttribute("cataFromBrandMap");
	//二级
	...
	//catalogSecondList = dbHelper.getMapList("select num,name from pro_catalog where is_show=1 and  parentid=? ",new Object[]{CommonString.getFormatPara(catalogMap3.get(catalog))}) ;
    
	//当选择品牌后加载类别
	List<Map> factoryCatalogList=null;
	if(!factoryid.equals("")){
		//factoryCatalogList = dbHelper.getMapList("select substring(catalognum, 0, 7) as  catalognum   from pro_products where is_show=1 and factoryid="+factoryid+"  GROUP BY substring(catalognum, 0, 7) ") ;
	    factoryCatalogList=(List)(aa.get(factoryid));
	}
	if(!factoryids.equals("")){
		factoryCatalogList = dbHelper.getMapList("select substring(catalognum, 0, 7) as  catalognum   from pro_products where is_show=1 and factoryid in ("+factoryids+"0)  GROUP BY substring(catalognum, 0, 7) ") ;
	}
%>
<!doctype html>
<html>
...
<% if(ton.equals("3")&&catalog.equals("101002")){ %>
<meta name="description" content="铁臂商城30装载机专区,为您提供30装载机,30铲车,3吨装载机等详细信息,帮您全面了解30装载机,买30装载机产品就上铁臂商城。" />
<% }else if(ton.equals("5")&&catalog.equals("101002")){ %>
<meta name="description" content="铁臂商城50装载机专区,为您提供50装载机,50铲车,5吨装载机等详细信息,帮您全面了解50装载机,买50装载机产品就上铁臂商城。" />
<% }else if(catalognum_new.equals("102007")&&tonandmeter.equals("")&&factory.equals("")&&factoryids.equals("")&&ton.equals("")){ %>
<meta name="description" content="铁臂商城汽车起重机专区,为您提供汽车起重机,汽车吊等详细信息,帮您全面了解汽车起重机,买汽车起重机产品就上铁臂商城。" />
<%}else if(catalognum_new.equals("101002008")&&tonandmeter.equals("")&&factory.equals("")&&factoryids.equals("")){%>
<meta name="description" content="铁臂商城两头忙专区,为您提供两头忙,挖掘装载机等详细信息,帮您全面了解两头忙,买两头忙产品就上铁臂商城。" />
<%}else if(catalognum_new.equals("101001")&&tonandmeter.equals("g_0_4")&&factory.equals("")&&factoryids.equals("")){%>
<meta name="description" content="铁臂商城微挖专区,为您提供微挖,微型挖掘机,迷你小挖机,挖掘机等详细信息,帮您全面了解微挖,买微挖产品就上铁臂商城。" />	
<%}else if(catalognum_new.equals("101001004")&&tonandmeter.equals("")&&factory.equals("")&&factoryids.equals("")){ %>
<meta name="description" content="铁臂商城轮挖专区,为您提供轮挖,轮式挖掘机,挖掘机等详细信息,帮您全面了解轮挖,买轮挖产品就上铁臂商城。" />	
<%}else if(catalognum_new.equals("101002")&&tonandmeter.equals("l_1_3")&&factory.equals("")&&factoryids.equals("")){ %>
<meta name="description" content="铁臂商城小装专区,为您提供小装,小型装载机,小铲车,装载机等详细信息,帮您全面了解小装,买小装产品就上铁臂商城。" />	
<%}else if(catalognum_new.equals("101001")&&tonandmeter.equals("g_35_1")&&factory.equals("")&&factoryids.equals("")){%>
<meta name="description" content="铁臂商城大型挖掘机专区,为您提供大型挖掘机,矿用挖掘机,挖掘机等详细信息,帮您全面了解大型挖掘机,买大型挖掘机产品就上铁臂商城。" />	
<%}else 	if(catalognum_new.equals("101001")&&tonandmeter.equals("")&&factory.equals("174")&&factoryids.equals("")){%>
<meta name="description" content="铁臂商城卡特挖掘机专区,为您提供卡特挖掘机,卡特彼勒挖掘机等详细信息,帮您全面了解卡特挖掘机,买卡特挖掘机产品就上铁臂商城。" />	
<%}else if(catalognum_new.equals("101002")&&tonandmeter.equals("l_0_3")&&factory.equals("")&&factoryids.equals("")){%>
<meta name="description" content="铁臂商城小装专区,为您提供小装,小型装载机,小铲车等详细信息,帮您全面了解小型装载机,买小型装载机产品就上铁臂商城。" />
<%}else{%>
...
关注21SUN，跟随21SUN，倾听行业的声音，探寻行业的足迹，感受行业的脉搏。探索行业的未来 </p>
      ...
      <div class="links-show links-list app-download">
        <a class="has-list" href="javascript:;">APP下载</a>
        <div class="list-box list-app">
          <span class="over-line"></span>
          <ul class="fix">
            <li>
              <div class="pic-box l"><img src="http://toutiao.21-sun.com/static/images/app/android.jpg"></div>
              <div class="txt-box"><p>微信扫一扫<br>下载iPhone客户端</p></div>
            </li>
            <li>
              <div class="pic-box l"><img src="http://toutiao.21-sun.com/static/images/app/ios.jpg"></div>
              <div class="txt-box"><p>微信扫一扫<br>下载Android客户端</p></div>
            </li>
          </ul>
        </div>
      </div>
...
<div class="txd_nmain">
  <div class="wrap fix listbg">
    ...
    <div class="txd_nright">
      ...
      我的位置：<a href="/">商城首页</a><em>&gt;&gt;</em><a href="/products/prolist.jsp" >设备导购</a><em>&gt;&gt;</em><%=newTitle%>
      </div>
      <!--面包屑 end-->
      <!--筛选-->
      <div id="main1">
        <div id="main"  style="background-color:white">
          <div class="filter fix" >
            <div class="filter_hd" style="background-color:white">
              <h1 class="_n"><%if(catalog.equals("101002")&&ton.equals("3")){%>30装载机<%}else if(catalog.equals("101002")&&ton.equals("5")){%>50装载机<%}else{%><%=newTitle%><%}%></h1>
            ...
            <div class="j_Prop attr" id="select_condition">
              ...
              <div class="attrValues selectValues">
                <ul class="select_val">
                  <%if(!factoryid.equals("")){%>
                  <li><a href="/products/prolist.jsp<%=catalog.equals("")?"":"?catalog="+catalog%>" title="<%=CommonString.getFormatPara(brandMap.get(factoryid))%>">品牌：<strong><%=CommonString.getFormatPara(brandMap.get(factoryid))%></strong></a><b></b></li>
                  <%}%>
                  <%if(!factoryids.equals("")){%>
                  <li><a href="/products/prolist.jsp<%=catalog.equals("")?"":"?catalog="+catalog%>" title="<%=factoryNames%>">品牌：<strong><%=factoryNames%></strong></a><b></b></li>
                  <%}%>
                  <%if(!catalog.equals("")){%>
                  <li><a href="/products/prolist.jsp<%=factoryid.equals("")?"":"?factory="+factoryid%>" title="<%=CommonString.getFormatPara(catalogMap.get(catalog))%>">类型：<strong><%=CommonString.getFormatPara(catalogMap.get(catalog))%></strong></a><b></b></li>
                  <%}%>
                  <%
				  if(!tonandmeter.equals("")){
					String showname="吨位";
					if(catalog_detail.equals("105003")){ showname="直径(m)";}
					if(catalog_detail.equals("103001")){ showname="臂架长度";}
				  %>
                  <li><a href="/products/prolist.jsp?catalog=<%=catalog%><%=factoryid.equals("")?"":"&factory="+factoryid%>" title="<%=showtonandmeter%>"><%=showname%>：<strong><%=showtonandmeter%></strong></a><b></b></li>
                  <%}%>
                </ul>
            ...
            <%
			   if(catalog.equals("")){
			   if(factoryid.equals("")&&factoryids.equals("")){
			   if(topCatalogList!=null&&topCatalogList.size()>0){
			%>
			...
			<div class="j_Prop attr j_Propli" id="select_category">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;height:auto">
                     <%
					    for(Map oneMap:topCatalogList){
					        for(Map oneMapSecond:factoryCatalogList){
							    if(CommonString.getFormatPara(oneMapSecond.get("catalognum")).equals(CommonString.getFormatPara(oneMap.get("num")))||CommonString.getFormatPara(oneMapSecond.get("catalognum")).indexOf(CommonString.getFormatPara(oneMap.get("num")))>=0){
					                if(!factoryids.equals("")){
					                    int allSum=0;
						                for(int i=0;i<factoryArray.length;i++){
					  ...
					  %>
					  <li style="margin: 0 10px 10px 0;"><a title="<%=CommonString.getFormatPara(oneMap.get("name"))%>" href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=<%=CommonString.getFormatPara(oneMap.get("num"))%><%=tonandmeter.equals("")?"":"&tonandmeter="+tonandmeter%>"><%=CommonString.getFormatPara(oneMap.get("name"))%><span style="color:red">(<%=allSum%>)</span></a></li>
	       ...
	       <%}}%>
             <%if(!catalog.equals("")){
				   if(catalogSecondList!=null&&catalogSecondList.size()>0){
				 %>
            <div class="j_Prop attr j_Propli" id="select_catalog">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;height:auto">
				  ...
				  %>
				  <li><a title="<%=CommonString.getFormatPara(oneMap.get("name"))%>" href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=<%=CommonString.getFormatPara(oneMap.get("num"))%><%=tonandmeter.equals("")?"":"&tonandmeter="+tonandmeter%>"><%=CommonString.getFormatPara(oneMap.get("name"))%><span style="color:red">(<%=allSum%>)</span></a></li>
				  <%}else if(factoryid.equals("")){%>
                  ...
                  <%}else{
					if(CommonString.getFormatInt(brandProMap.get(factoryid+"_"+(CommonString.getFormatPara(oneMap.get("num")))))!=0){
					%>
				   <li><a title="<%=CommonString.getFormatPara(oneMap.get("name"))%>" href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=<%=CommonString.getFormatPara(oneMap.get("num"))%><%=tonandmeter.equals("")?"":"&tonandmeter="+tonandmeter%>"><%=CommonString.getFormatPara(oneMap.get("name"))%><span style="color:red">(<%=CommonString.getFormatInt(brandProMap.get(factoryid+"_"+(CommonString.getFormatPara(oneMap.get("num")))))%>)</span></a></li>
				  <%}}%>
				 <%}%>
         ...
         <%if(catalog.equals("140")){%>
            <div class="j_Prop attr j_Propli" id="select_catalog">
               ...
               <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;height:auto">
                  <li><a title="破碎器" href="/products/prolist.jsp?catalog=101001098">破碎器<span style="color:red">(<%=CommonString.getFormatInt(cataProMap.get((CommonString.getFormatPara("101001098"))))%>)</span></a></li>
                  <li><a title="液压剪" href="/products/prolist.jsp?catalog=101001099">液压剪<span style="color:red">(<%=CommonString.getFormatInt(cataProMap.get((CommonString.getFormatPara("101001099"))))%>)</span></a></li> 
                </ul>
              </div>
            </div>
		 <%}%> 
            ...
            <div class="j_Prop attr j_Propli" id="select_tonandmeter">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;">
				  ...
				  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=<%=catalog%>&ton=g_0_6">微挖(3T以下)</a></li>
                  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=<%=catalog%>&ton=g_1_13">小挖(4T～8T)</a></li>
				  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=<%=catalog%>&ton=g_8_15">中小挖(8T～15T)</a></li>
                  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=<%=catalog%>&ton=g_14_30">中挖(15T～25T)</a></li>
				  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=<%=catalog%>&ton=g_25_35">中大挖(25T～35T)</a></li>
                  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=<%=catalog%>&ton=g_30_1">大挖(35T以上)</a></li>
				  <%} else if(catalog.equals("101001004")){%> 
				  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=101001004&ton=g_0_6">微挖(3T以下)</a></li>
                  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=101001004&ton=g_1_13">小挖(4T～8T)</a></li>
				  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=101001004&ton=g_8_15">中小挖(8T～15T)</a></li>
                  <li style="margin:0 15px 10px 0"><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=101001004&ton=g_14_30">中挖(15T～25T)</a></li>
                  <%  }else if(catalog.equals("101002007")){%>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=101002007&ton=l_1_3">小装(3T以下)</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=101002007&ton=l_3_01">3T</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=101002007&ton=l_3_5">5T</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=101002007&ton=l_5_1">5T以上</a></li>
                  <%}else if(catalog_detail.equals("102")){%>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=102&ton=c_1_16">16T以下</a> </li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=102&ton=c_20_70">20T～70T</a> </li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=102&ton=c_70_1">70T以上</a></li>
                  <%}else if(catalog_detail.equals("102007")){%>
				  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=102007&ton=c_1_16">16T以下</a> </li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=102007&ton=c_20_70">20T～70T</a> </li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=102007&ton=c_70_1">70T以上</a></li>
				  <%}else if(catalog.equals("106001001")){%>
				  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=106001001&ton=r_0_10">10T以下</a> </li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=106001001&ton=r_12_18">12T～18T</a> </li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=106001001&ton=r_20_01">20T</a></li>
				  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?f="+factoryid+"&"%>c=106001001&ton=r_20_1">20T以上</a></li>
				  <%}%> 
            ...
            <div class="j_Prop attr j_Propli" id="select_tonandmeter">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;">
				  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=105003&tonandmeter=drill_0.5_1">0.5～1</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=105003&tonandmeter=drill_0.8_1.8">0.8～1.8</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=105003&tonandmeter=drill_1_2.5">1～2.5</a></li>
			   </ul>
              </div>
            </div>
            <%}%>
            ...
            <div class="j_Prop attr j_Propli" id="select_tonandmeter">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;">
				  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=103001&tonandmeter=lift_0_36">36米以下</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=103001&tonandmeter=lift_36_44">36-44米</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=103001&tonandmeter=lift_45_47">45-47米</a></li>
			   	  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=103001&tonandmeter=lift_48_52">48-52米</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=103001&tonandmeter=lift_53_56">53-56米</a></li>
                  <li><a href="/products/prolist.jsp<%= factoryid.equals("")?"?":"?factory="+factoryid+"&"%>catalog=103001&tonandmeter=lift_56_1">56米以上</a></li>
			   </ul>
              </div>
            </div>
            <%}%>	
			...
			<div class="j_Prop attr j_Propli" id="select_catalog">
              <div class="attrKey">热门机型</div>
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;height:auto">
                  <li><a title="12吨压路机" href="/products/prolist.jsp?catalog=106001&t=12">12吨压路机</a></li>
				  <li><a title="16吨压路机" href="/products/prolist.jsp?catalog=106001&t=16">16吨压路机</a></li>
				  <li><a title="18吨压路机" href="/products/prolist.jsp?catalog=106001&t=18">18吨压路机</a></li>
				  <li><a title="20吨压路机" href="/products/prolist.jsp?catalog=106001&t=20">20吨压路机</a></li>
                  <li><a title="22吨压路机" href="/products/prolist.jsp?catalog=106001&t=22">22吨压路机</a></li>
                </ul>
              </div>
            </div>
			<%}%>
		...
		<%if(catalog.indexOf("101002")>=0){%>
			<div class="j_Prop attr j_Propli" id="select_catalog">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;height:auto">
                  <li><a title="30铲车" href="/products/prolist.jsp?catalog=101002&t=3">30铲车</a></li>
				  <li><a title="3吨装载机" href="/products/prolist.jsp?catalog=101002&t=3">3吨装载机</a></li>
				  <li><a title="30装载机" href="/products/prolist.jsp?catalog=101002&t=3">30装载机</a></li>
				  <li><a title="50装载机" href="/products/prolist.jsp?catalog=101002&t=5">50装载机</a></li>
                  <li><a title="50铲车" href="/products/prolist.jsp?catalog=101002&t=5">50铲车</a></li>
				  <li><a title="5吨装载机" href="/products/prolist.jsp?catalog=101002&t=5">5吨装载机</a></li>
                </ul>
              </div>
            </div>
			<%}%>
		   ...
		   <%if(catalog.indexOf("102007")>=0){%>
			<div class="j_Prop attr j_Propli" id="select_catalog">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;height:auto">
				  <li><a title="8吨汽车吊" href="/products/prolist.jsp?catalog=102007&t=8">8吨汽车吊</a></li>
				  <li><a title="12吨汽车吊" href="/products/prolist.jsp?catalog=102007&t=12">12吨汽车吊</a></li>
                  <li><a title="16吨汽车吊" href="/products/prolist.jsp?catalog=102007&t=16">16吨汽车吊</a></li>
				  <li><a title="25吨汽车吊" href="/products/prolist.jsp?catalog=102007&t=25">25吨汽车吊</a></li>
                  <li><a title="50吨汽车吊" href="/products/prolist.jsp?catalog=102007&t=50">50吨汽车吊</a></li>
                </ul>
              </div>
            </div>
			<%}%>
			...
			<div class="j_Prop attr j_Propli" id="select_catalog">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;height:auto">
				  <li style="margin:0 20px 10px 0"><a title="26米泵车" href="/products/prolist.jsp?catalog=103001&t=26">26米泵车</a></li>
				  <li style="margin:0 20px 10px 0"><a title="37米泵车" href="/products/prolist.jsp?catalog=103001&t=37">37米泵车</a></li>
				  <li style="margin:0 20px 10px 0"><a title="38米泵车" href="/products/prolist.jsp?catalog=103001&t=38">38米泵车</a></li>
				  <li style="margin:0 20px 10px 0"><a title="47米泵车" href="/products/prolist.jsp?catalog=103001&t=47">47米泵车</a></li>
				  <li style="margin:0 20px 10px 0"><a title="48米泵车" href="/products/prolist.jsp?catalog=103001&t=48">48米泵车</a></li>
				  <li style="margin:0 20px 10px 0"><a title="52米泵车" href="/products/prolist.jsp?catalog=103001&t=52">52米泵车</a></li>
				  <li style="margin:0 20px 10px 0"><a title="56米泵车" href="/products/prolist.jsp?catalog=103001&t=56">56米泵车</a></li>
				  <li style="margin:0 20px 10px 0"><a title="62米泵车" href="/products/prolist.jsp?catalog=103001&t=62">62米泵车</a></li>
                </ul>
              </div>
            </div>
			<%}%>
			...
			<div class="j_Prop attr j_Propli" id="select_catalog">
              ...
              <div class="attrValues">
                <ul class="av-collapse" style="visibility:visible;height:auto">
                        <li><a title="液压挖掘机" href="/products/prolist.jsp?catalog=101001&m=yy">液压挖掘机</a></li>
						<li><a title="15吨挖掘机" href="/products/prolist.jsp?catalog=101001&t=15">15吨挖掘机</a></li>
						<li><a title="200挖掘机" href="/products/prolist.jsp?catalog=101001&t=20">200挖掘机</a></li>
						<li><a title="20吨挖掘机" href="/products/prolist.jsp?catalog=101001&t=20">20吨挖掘机</a></li>
						<li><a title="220挖掘机" href="/products/prolist.jsp?catalog=101001&m=220">220挖掘机</a></li>
						<li><a title="30吨挖掘机" href="/products/prolist.jsp?catalog=101001&t=30">30吨挖掘机</a></li>
						<li><a title="360挖掘机" href="/products/prolist.jsp?catalog=101001&m=360">360挖掘机</a></li>
						<li><a title="55挖掘机" href="/products/prolist.jsp?catalog=101001&m=55">55挖掘机</a></li>
						<li><a title="60挖掘机" href="/products/prolist.jsp?catalog=101001&m=60">60挖掘机</a></li>
						<li><a title="65挖掘机" href="/products/prolist.jsp?catalog=101001&m=65">65挖掘机</a></li>
						<li><a title="70挖掘机" href="/products/prolist.jsp?catalog=101001&m=70">70挖掘机</a></li>
						<li><a title="85挖掘机" href="/products/prolist.jsp?catalog=101001&m=85">85挖掘机</a></li>
                </ul>
              </div>
            </div>
			<%}%>
      ...
      <div class="txd_sx_plist mainList listMode">
        <ul class="fix">
			...
			<%
			    if((catalog.equals("101001")||catalog.equals("101001001"))&&factoryid.equals("")&&nowPage==1){
				Random rand =new Random();
                int wajueji;
                wajueji=rand.nextInt(3);
	        %><!--挖掘机广告-->
...
<li class="active">
  <div class="box">
    <div class="tsx_pimg"><a href="/proDetail/DX150LC-9C-82.shtm" title="斗山DX150LC-9C履带挖掘机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2016/12/20161216154302_436.jpg" alt="斗山DX150LC-9C履带挖掘机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
    <div class="tsx_pnr">
      <h2 class="txs_ptitle"><a href="/proDetail/DX150LC-9C-82.shtm" target="_blank" title="斗山DX150LC-9C履带挖掘机">斗山DX150LC-9C履带挖掘机</a></h2>
      <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/DX150LC-9C-82.shtm#xingn" target="_blank" title="斗山DX150LC-9C履带挖掘机性能">性能</a> <em>|</em><a href="/proDetail/DX150LC-9C-82.shtm#cans" target="_blank" title="斗山DX150LC-9C履带挖掘机参数">参数</a> <em>|</em><a href="/proDetail/DX150LC-9C-82_message.shtm#position" target="_blank" title="斗山DX150LC-9C履带挖掘机口碑">口碑</a><em>|</em><a href="/proDetail/DX150LC-9C-82_pic.shtm#position" target="_blank" title="斗山DX150LC-9C履带挖掘机图片">图片</a><em>|</em><a href="/proDetail/DX150LC-9C-82_agent.shtm#position" target="_blank" title="斗山DX150LC-9C履带挖掘机代理商">代理商</a> </div>
      <div class="txs_psum">
        <div style="width:300px;float:left">总长度：7662</div>
        <div style="width:300px;float:left">总宽度：2530</div>
        <div style="width:300px;float:left">总高度（至驾驶棚顶部）：2773</div>
        <a href="/proDetail/DX150LC-9C-82.shtm" target="_blank">[查看详情]</a></div>
    </div>
    <div class="oi">
      <div class="l"> <span class="thisxj"><b>询价（134）</b></span><a href="javascript:void(0)" class="add_inquiry" data-val="29007"><b>加入询价</b></a><a href="javascript:void(0)" class="add_compare" data-val="29007"><b>加入对比</b></a><a title="更多斗山挖掘机" class="morepro" href="/products/prolist.jsp?factory=192&amp;catalog=101001" target="_blank"><b>更多斗山挖掘机</b></a>
        <div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>
      </div>
      <span class="pmh">
      <div class="tsx_pprice"><a href="javascript:;" onclick="showinquery('29007','')">询最低价</a></div>
      <div class="r">134人已询价</div>
      </span> </div>
  </div>
</li>
<%}%>
...
<li class="active">
  <div class="box">
    <div class="tsx_pimg"><a href="/proDetail/320D2GC.shtm" title="卡特彼勒320D2 GC挖掘机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2016/03/20160318171550_303.jpg" alt="卡特彼勒320D2 GC挖掘机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
    <div class="tsx_pnr">
      <h2 class="txs_ptitle"><a href="/proDetail/320D2GC.shtm" target="_blank" title="卡特彼勒320D2 GC挖掘机">卡特彼勒320D2 GC挖掘机</a></h2>
      <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/320D2GC.shtm#xingn" target="_blank" title="卡特彼勒320D2 GC挖掘机性能">性能</a> <em>|</em><a href="/proDetail/320D2GC.shtm#cans" target="_blank" title="卡特彼勒320D2 GC挖掘机参数">参数</a> <em>|</em><a href="/proDetail/320D2GC_message.shtm#position" target="_blank" title="卡特彼勒320D2 GC挖掘机口碑">口碑</a><em>|</em><a href="/proDetail/320D2GC_pic.shtm#position" target="_blank" title="卡特彼勒320D2 GC挖掘机图片">图片</a><em>|</em><a href="/proDetail/320D2GC_agent.shtm#position" target="_blank" title="卡特彼勒320D2 GC挖掘机代理商">代理商</a> </div>
      <div class="txs_psum">
        <div style="width:300px;float:left">总长度：9460</div>
        <div style="width:300px;float:left">总宽度：2800</div>
        <div style="width:300px;float:left">总高度（至驾驶棚顶部）：2950</div>
        <a href="/proDetail/320D2GC.shtm" target="_blank">[查看详情]</a></div>
    </div>
    <div class="oi">
      <div class="l"> <span class="thisxj"><b>询价（9）</b></span><a href="javascript:void(0)" class="add_inquiry" data-val="23364"><b>加入询价</b></a><a href="javascript:void(0)" class="add_compare" data-val="23364"><b>加入对比</b></a><a title="更多卡特挖掘机" class="morepro" href="/products/prolist.jsp?factory=174&amp;catalog=101001" target="_blank"><b>更多卡特挖掘机</b></a>
        <div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>
      </div>
      <span class="pmh">
      <div class="tsx_pprice"><a href="javascript:;" onclick="showinquery('23364','')">询最低价</a></div>
      <div class="r">9人已询价</div>
      </span> </div>
  </div>
</li>
<%}%>
...
<li class="active">
  <div class="box">
    <div class="tsx_pimg"><a href="/proDetail/SY55U.shtm" title="三一SY55U履带挖掘机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2017/04/20170426080828_326.jpg" alt="三一SY55U履带挖掘机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
    <div class="tsx_pnr">
      <h2 class="txs_ptitle"><a href="/proDetail/SY55U.shtm" target="_blank" title="三一SY55U履带挖掘机">三一SY55U履带挖掘机</a></h2>
      <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/SY55U.shtm#xingn" target="_blank" title="三一SY55U履带挖掘机性能">性能</a> <em>|</em><a href="/proDetail/SY55U.shtm#cans" target="_blank" title="三一SY55U履带挖掘机参数">参数</a> <em>|</em><a href="/proDetail/SY75C-10_message.shtm#position" target="_blank" title="三一SY55U履带挖掘机口碑">口碑</a><em>|</em><a href="/proDetail/SY75C-10_pic.shtm#position" target="_blank" title="三一SY55U履带挖掘机图片">图片</a><em>|</em><a href="/proDetail/SY75C-10_agent.shtm#position" target="_blank" title="三一SY55U履带挖掘机代理商">代理商</a> </div>
      <div class="txs_psum">
        <div style="width:300px;float:left">最大挖掘高度：5425</div>
        <div style="width:300px;float:left">最大卸载高度：3780</div>
        <div style="width:300px;float:left">工作重量：5200</div>
        <a href="/proDetail/SY55U.shtm" target="_blank">[查看详情]</a></div>
    </div>
    <div class="oi">
      <div class="l"> <span class="thisxj"><b>询价（113）</b></span><a href="javascript:void(0)" class="add_inquiry" data-val="28673"><b>加入询价</b></a><a href="javascript:void(0)" class="add_compare" data-val="28673"><b>加入对比</b></a><a title="更多三一挖掘机" class="morepro" href="/products/prolist.jsp?factory=133&amp;catalog=101001" target="_blank"><b>更多三一挖掘机</b></a>
        <div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>
      </div>
      <span class="pmh">
      <div class="tsx_pprice"><a href="javascript:;" onclick="showinquery('28673','')">询最低价</a></div>
      <div class="r">113人已询价</div>
      </span> </div>
  </div>
</li>
<%}%>
<%}%>			  
			   ...
			   <%if((catalog.equals("101002")||catalog.equals("101002007"))&&factoryid.equals("")&&nowPage==1){
				   
				Random rand =new Random();
                int zhuangzaiji;
                zhuangzaiji=rand.nextInt(5);
				%><!--装载机广告-->
	<%if(zhuangzaiji==0){%>		
<li class="active">
  <div class="box">
    <div class="tsx_pimg"><a href="/proDetail/SEM652D.shtm" title="山工SEM652D轮式装载机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2016/04/20160414084318_701.jpg" alt="山工SEM652D轮式装载机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
    <div class="tsx_pnr">
      <h2 class="txs_ptitle"><a href="/proDetail/SEM652D.shtm" target="_blank" title="山工SEM652D轮式装载机">山工SEM652D轮式装载机</a></h2>
      <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/SEM652D.shtm#xingn" target="_blank" title="山工SEM652D轮式装载机性能">性能</a> <em>|</em><a href="/proDetail/SEM652D.shtm#cans" target="_blank" title="山工SEM652D轮式装载机参数">参数</a> <em>|</em><a href="/proDetail/SEM652D_message.shtm#position" target="_blank" title="山工SEM652D轮式装载机口碑">口碑</a><em>|</em><a href="/proDetail/SEM652D_pic.shtm#position" target="_blank" title="山工SEM652D轮式装载机图片">图片</a><em>|</em><a href="/proDetail/SEM652D_agent.shtm#position" target="_blank" title="山工SEM652D轮式装载机代理商">代理商</a> </div>
      <div class="txs_psum">
        <div style="width:300px;float:left">总长度：8062</div>
        <div style="width:300px;float:left">总宽度：2963</div>
        <div style="width:300px;float:left">总高度：3348</div>
        <a href="/proDetail/SEM652D.shtm" target="_blank">[查看详情]</a></div>
    </div>
    <div class="oi">
      <div class="l"> <span class="thisxj"><b>询价（1266）</b></span><a href="javascript:void(0)" class="add_inquiry" data-val="863"><b>加入询价</b></a><a href="javascript:void(0)" class="add_compare" data-val="863"><b>加入对比</b></a><a title="更多山工装载机" class="morepro" href="/products/prolist.jsp?factory=138&amp;catalog=101002" target="_blank"><b>更多山工装载机</b></a>
        <div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>
      </div>
      <span class="pmh">
      <div class="tsx_pprice"><a href="javascript:;" onclick="showinquery('863','')">询最低价</a></div>
      <div class="r">1266人已询价</div>
      </span> </div>
  </div>
</li>
...
<li class="active">
  <div class="box">
    <div class="tsx_pimg"><a href="/proDetail/XG951H.shtm" title="厦工XG951H轮式装载机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2015/12/20151218090248_746.jpg" alt="厦工XG951H轮式装载机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
    <div class="tsx_pnr">
      <h2 class="txs_ptitle"><a href="/proDetail/XG951H.shtm" target="_blank" title="厦工XG951H轮式装载机">厦工XG951H轮式装载机</a></h2>
      <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/XG951H.shtm#xingn" target="_blank" title="厦工XG951H轮式装载机性能">性能</a> <em>|</em><a href="/proDetail/XG951H.shtm#cans" target="_blank" title="厦工XG951H轮式装载机参数">参数</a> <em>|</em><a href="/proDetail/XG951H_message.shtm#position" target="_blank" title="厦工XG951H轮式装载机口碑">口碑</a><em>|</em><a href="/proDetail/XG951H_pic.shtm#position" target="_blank" title="厦工XG951H轮式装载机图片">图片</a><em>|</em><a href="/proDetail/XG951H_agent.shtm#position" target="_blank" title="厦工XG951H轮式装载机代理商">代理商</a> </div>
      <div class="txs_psum">
        <div style="width:300px;float:left">斗容范围：2.2～4.5</div>
        <div style="width:300px;float:left">整机操作质量：16800</div>
        <div style="width:300px;float:left">额定载重量：5000</div>
        <a href="/proDetail/XG951H.shtm" target="_blank">[查看详情]</a></div>
    </div>
    <div class="oi">
      <div class="l"> <span class="thisxj"><b>询价（522）</b></span><a href="javascript:void(0)" class="add_inquiry" data-val="20381"><b>加入询价</b></a><a href="javascript:void(0)" class="add_compare" data-val="20381"><b>加入对比</b></a><a title="更多厦工装载机" class="morepro" href="/products/prolist.jsp?factory=139&amp;catalog=101002" target="_blank"><b>更多厦工装载机</b></a>
        <div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>
      </div>
      <span class="pmh">
      <div class="tsx_pprice"><a href="javascript:;" onclick="showinquery('20381','')">询最低价</a></div>
      <div class="r">522人已询价</div>
      </span> </div>
  </div>
</li>
...
<li class="active">
            <div class="box">
              <div class="tsx_pimg"><a href="/proDetail/YX656.shtm" title="英轩重工YX656轮式装载机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2015/09/20150906101721_560.jpg" alt="英轩重工YX656轮式装载机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
              <div class="tsx_pnr">
                <h2 class="txs_ptitle"><a href="/proDetail/YX656.shtm" target="_blank" title="英轩重工YX656轮式装载机">英轩重工YX656轮式装载机</a></h2>
                <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/YX656.shtm#xingn" target="_blank" title="英轩重工YX656轮式装载机性能">性能</a> <em>|</em><a href="/proDetail/YX656.shtm#cans" target="_blank" title="英轩重工YX656轮式装载机参数">参数</a> <em>|</em><a href="/proDetail/YX656_message.shtm#position" target="_blank" title="英轩重工YX656轮式装载机口碑">口碑</a><em>|</em><a href="/proDetail/YX656_pic.shtm#position" target="_blank" title="英轩重工YX656轮式装载机图片">图片</a><em>|</em><a href="/proDetail/YX656_agent.shtm#position" target="_blank" title="英轩重工YX656轮式装载机代理商">代理商</a> </div>
                <div class="txs_psum"><div style="width:300px;float:left">总长度：7930</div><div style="width:300px;float:left">总宽度：3024</div><div style="width:300px;float:left">总高度：3480</div><a href="/proDetail/YX656.shtm" target="_blank">[查看详情]</a></div>
              </div>
              <div class="oi">
                <div class="l"> <span class="thisxj"><b>询价（344）</b></span><a href="javascript:void(0)" class="add_inquiry" data-val="15108"><b>加入询价</b></a><a href="javascript:void(0)" class="add_compare" data-val="15108"><b>加入对比</b></a><a title="更多英轩重工装载机" class="morepro" href="/products/prolist.jsp?factory=1777&amp;catalog=101002" target="_blank"><b>更多英轩重工装载机</b></a>
	        <div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>			
				
				</div>
                <span class="pmh">
                <div class="tsx_pprice"><a href="javascript:;" onclick="showinquery('15108','')">询最低价</a></div>
                <div class="r">344人已询价</div>
                </span> </div>
            </div>
          </li>	
	<%}%>
...
<li class="active">
  <div class="box">
    <div class="tsx_pimg"><a href="/proDetail/956.shtm" title="常林公司956轮式装载机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2015/06/20150618165626_621.jpg" alt="常林公司956轮式装载机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
    <div class="tsx_pnr">
      <h2 class="txs_ptitle"><a href="/proDetail/956.shtm" target="_blank" title="常林公司956轮式装载机">常林公司956轮式装载机</a></h2>
      <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/956.shtm#xingn" target="_blank" title="常林公司956轮式装载机性能">性能</a> <em>|</em><a href="/proDetail/956.shtm#cans" target="_blank" title="常林公司956轮式装载机参数">参数</a> <em>|</em><a href="/proDetail/956_message.shtm#position" target="_blank" title="常林公司956轮式装载机口碑">口碑</a><em>|</em><a href="/proDetail/956_pic.shtm#position" target="_blank" title="常林公司956轮式装载机图片">图片</a><em>|</em><a href="/proDetail/956_agent.shtm#position" target="_blank" title="常林公司956轮式装载机代理商">代理商</a> </div>
      <div class="txs_psum">
        <div style="width:300px;float:left">轴距：3300</div>
        <div style="width:300px;float:left">斗容范围：2.2-4.5</div>
        <div style="width:300px;float:left">额定载重量：5000</div>
        <a href="/proDetail/956.shtm" target="_blank">[查看详情]</a></div>
    </div>
    <div class="oi">
      <div class="l"> <span class="thisxj"><b>询价（130）</b></span><a href="javascript:void(0)" class="add_inquiry" data-val="651"><b>加入询价</b></a><a href="javascript:void(0)" class="add_compare" data-val="651"><b>加入对比</b></a><a title="更多常林公司装载机" class="morepro" href="/products/prolist.jsp?factory=148&amp;catalog=101002" target="_blank"><b>更多常林公司装载机</b></a>
        <div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>
      </div>
      <span class="pmh">
      <div class="tsx_pprice"><a href="javascript:;" onclick="showinquery('651','')">询最低价</a></div>
      <div class="r">130人已询价</div>
      </span> </div>
  </div>
</li>
...
<li class="active">
  <div class="box">
    <div class="tsx_pimg"><a href="/proDetail/630G.shtm" title="雷乔曼630G轮式装载机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2016/09/20160906105256_910.jpg" alt="雷乔曼630G轮式装载机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
    <div class="tsx_pnr">
      <h2 class="txs_ptitle"><a href="/proDetail/630G.shtm" target="_blank" title="雷乔曼630G轮式装载机">雷乔曼630G轮式装载机</a></h2>
      <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/630G.shtm#xingn" target="_blank" title="雷乔曼630G轮式装载机性能">性能</a> <em>|</em><a href="/proDetail/630G.shtm#cans" target="_blank" title="雷乔曼630G轮式装载机参数">参数</a> <em>|</em><a href="/proDetail/630G_message.shtm#position" target="_blank" title="雷乔曼630G轮式装载机口碑">口碑</a><em>|</em><a href="/proDetail/630G_pic.shtm#position" target="_blank" title="雷乔曼630G轮式装载机图片">图片</a><em>|</em><a href="/proDetail/630G_agent.shtm#position" target="_blank" title="雷乔曼630G轮式装载机代理商">代理商</a> </div>
      <div class="txs_psum">
        <div style="width:300px;float:left">总长度：6890</div>
        <div style="width:300px;float:left">总宽度：2440</div>
        <div style="width:300px;float:left">总高度：3080</div>
        <a href="/proDetail/630G.shtm" target="_blank">[查看详情]</a></div>
    </div>
    <div class="oi">
      <div class="l"> <span class="thisxj"><b>询价（139）</b></span><a href="javascript:void(0)" class="add_inquiry" data-val="24952"><b>加入询价</b></a><a href="javascript:void(0)" class="add_compare" data-val="24952"><b>加入对比</b></a><a title="更多雷乔曼装载机" class="morepro" href="/products/prolist.jsp?factory=16683&amp;catalog=101002" target="_blank"><b>更多雷乔曼装载机</b></a> 
              <div class="pro-tip" style="position:relative; right:-350px; top:-24px; font-size:14px; font-weight:bold; color:#f00;"> [推广]</div>
      </div>
      <span class="pmh">
      <div class="tsx_pprice"><a href="javascript:;" onclick="showinquery('24952','')">询最低价</a></div>
          ...
          <%	  
							...
							int flagNum=1;
								for(SolrDocument mm : products){
			                        ...
			                        String title = CommonString.getFormatPara(mm.getFieldValue("title"));
			                        ...
			                        String intro = CommonString.getFormatPara(mm.getFieldValue("intro"));
          ...
          <li>
            <div class="box">
              ...
              <div class="tsx_pnr">
                ...
                <div class="txs_plink"><span class="pmhide"></span><a href="<%=file_name%>#xingn" target="_blank" title="<%=title%>性能">性能</a> <em>|</em><a href="<%=file_name%>#cans" target="_blank" title="<%=title%>参数">参数</a> <em>|</em><a href="<%=file_name.replace(".shtm","_message.shtm#position")%>" target="_blank" title="<%=title%>口碑">口碑</a><em>|</em><a href="<%=file_name.replace(".shtm","_pic.shtm#position")%>"  target="_blank" title="<%=title%>图片">图片</a><em>|</em><a href="<%=file_name.replace(".shtm","_agent.shtm#position")%>"  target="_blank" title="<%=title%>代理商">代理商</a> </div>
                <div class="txs_psum"><%=intro%><a href="<%=file_name%>" target="_blank">[查看详情]</a></div>
              </div>
              <div class="oi">
                <div class="l"> <span class="thisxj"><b>询价（<%=inquiryCount%>）</b></span><a  href="javascript:void(0)"  class="add_inquiry" data-val="<%=id%>"><b>加入询价</b></a><a  href="javascript:void(0)"  class="add_compare" data-val="<%=id%>"><b>加入对比</b></a><a title="更多<%=factoryname%><%=CommonString.getFormatPara(seoTitleKeywordMapNew.get(catalognum)).replace("混凝土泵车","泵车").replace("混凝土布料设备","布料机")%>" class="morepro"  href="/products/prolist.jsp?factory=<%=factory_id%>&catalog=<%=catalognum%>"   target="_blank" ><b>更多<%=factoryname%><%=CommonString.getFormatPara(seoTitleKeywordMapNew.get(catalognum)).replace("混凝土泵车","泵车").replace("混凝土布料设备","布料机")%></b></a>
	 
				</div>
                <span class="pmh">
                <div class="tsx_pprice"><a href="javascript:;" onClick="showinquery('<%=id%>','')">询最低价</a></div>
                <div class="r"><%=inquiryCount%>人已询价</div>
                </span> </div>
            </div>
          </li>
									<%}}%>
		  <%if(flagNum==3&&catalognum.equals("101002")&&factory_id.equals("")){%><!--英轩产品广告20151216-->
		  <li>
            <div class="box">
              <div class="tsx_pimg"><a href="/proDetail/YX655.shtm" title="英轩重工YX655轮式装载机" target="_blank"> <img src="http://product.21-sun.com/uploadfiles//image/2015/09/20150906101703_207.jpg" alt="英轩重工YX655轮式装载机" onerror="this.src='/uploadfiles/no_big.gif';"></a></div>
              <div class="tsx_pnr">
                <h2 class="txs_ptitle"><a href="/proDetail/YX655.shtm" target="_blank" title="英轩重工YX655轮式装载机">英轩重工YX655轮式装载机</a></h2>
                <div class="txs_plink"><span class="pmhide"></span><a href="/proDetail/YX655.shtm#xingn" target="_blank" title="英轩重工YX655轮式装载机性能">性能</a> <em>|</em><a href="/proDetail/YX655.shtm#cans" target="_blank" title="英轩重工YX655轮式装载机参数">参数</a> <em>|</em><a href="/proDetail/YX655_message.shtm#position" target="_blank" title="英轩重工YX655轮式装载机口碑">口碑</a><em>|</em><a href="/proDetail/YX655_pic.shtm#position" target="_blank" title="英轩重工YX655轮式装载机图片">图片</a><em>|</em><a href="/proDetail/YX655_agent.shtm#position" target="_blank" title="英轩重工YX655轮式装载机代理商">代理商</a> </div>
                <div class="txs_psum">●全景车窗，外观时尚；高强度整体式框架结构，安全性高；密封减震性好，●豪华座椅，可选装空调，给用户提供舒适的操作环境；●采用符合非公路II阶段排放要求的节能型低速<a href="/proDetail/YX655.shtm" target="_blank">[查看详情]</a></div>
              </div>
              <div class="oi">
...
<!--main end-->
<!--最新订单-->
<%if(catalog.indexOf("101001")>=0||catalog.indexOf("101002")>=0||catalog.indexOf("101003")>=0||catalog.equals("102007")||catalog.equals("103001")||catalog.equals("105003")||catalog.indexOf("106001")>=0||catalog.indexOf("107")>=0){%>
      ...
      <div id="MarqueeDiv" class="fix">
        <ul>
		   <%if(catalog.indexOf("101001")>=0){%>
               <li style="width: 120px;"><a href="/products/prolist.jsp?factory=174&catalog=101001">卡特彼勒</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=133&catalog=101001">三一</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=182&catalog=101001">小松</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=183&catalog=101001">神钢</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=139&catalog=101001">厦工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=136&catalog=101001">柳工</a></li>
		   <%}%>
			<%if(catalog.indexOf("101002")>=0){%>
               <li style="width: 120px;"><a href="/products/prolist.jsp?factory=137&catalog=101002">山东临工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=136&catalog=101002">柳工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=139&catalog=101002">厦工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=135&catalog=101002">龙工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=138&catalog=101002">山工机械</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=209&catalog=101002">徐工</a></li>
		   <%}%>  
			<%if(catalog.indexOf("101003")>=0){%>
               <li style="width: 120px;"><a href="/products/prolist.jsp?factory=144&catalog=101003">山推</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=154&catalog=101003">宣工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=136&catalog=101003">柳工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=138&catalog=101003">山工机械</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=161&catalog=101003">移山</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=139&catalog=101003">厦工</a></li>
		   <%}%>	
			<%if(catalog.indexOf("102007")>=0){%>
               <li style="width: 120px;"><a href="/products/prolist.jsp?factory=209&catalog=102007">徐工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=133&catalog=102007">三一</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=134&catalog=102007">中联重科</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=176&catalog=102007">特雷克斯</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=1225&catalog=102007">抚挖锦重</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=166&catalog=102007">京城重工</a></li>
		   <%}%>
		   <%if(catalog.indexOf("103001")>=0){%>
               <li style="width: 120px;"><a href="/products/prolist.jsp?factory=133&catalog=103001">三一</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=134&catalog=103001">中联重科</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=209&catalog=103001">徐工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=202&catalog=103001">鸿得利</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=144&catalog=103001">山推</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=1718&catalog=103001">雷萨重机</a></li>
		   <%}%>
		   <%if(catalog.indexOf("105003")>=0){%>
               <li style="width: 120px;"><a href="/products/prolist.jsp?factory=209&catalog=105003">徐工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=133&catalog=105003">三一</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=142&catalog=105003">山河智能</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=134&catalog=105003">中联重科</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=1209&catalog=105003">中国南车</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=683&catalog=105003">德国宝峨</a></li>
		   <%}%>
		   
		  	<%if(catalog.indexOf("106001")>=0){%>
               <li style="width: 120px;"><a href="/products/prolist.jsp?factory=212&catalog=106001">戴纳派克</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=209&catalog=106001">徐工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=133&catalog=106001">三一</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=673&catalog=106001">洛阳路通</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=216&catalog=106001">悍马</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=144&catalog=106001">山推</a></li>
		   <%}%> 
		   
		   	<%if(catalog.indexOf("107")>=0){%>
               <li style="width: 120px;"><a href="/products/prolist.jsp?factory=1742&catalog=107">林德</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=158&catalog=107">合力</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=139&catalog=107">厦工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=135&catalog=107">龙工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=136&catalog=107">柳工</a></li>
			   <li style="width: 120px;"><a href="/products/prolist.jsp?factory=194&catalog=107">现代</a></li>
		   <%}%> 
        </ul>
      </div>
    </div>
