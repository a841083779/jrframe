...
<%
	...
	String pro_sql = "select   id,name,file_name,img2,catalogname,zoomlion_hot_pic from pro_products where factoryid=151 and catalognum like '104004%' and is_show=1  order by order_no asc,id desc" ;
