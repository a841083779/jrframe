...
<%
	...
	String pro_sql = "select   id,name,file_name,img2,catalogname,zoomlion_hot_pic,catalogname from pro_products where factoryid=151 and catalognum like '104002%' and is_show=1  order by order_no asc,id desc" ;
...
<section class="pageMain zhuangzaiji arrow_bg">
	<div class="wrap">
		...
		<div class="product_info_list oh">
			<div class="title tit02 pr">
				<p class="title_info pa tr">销售热线： 0534-2488803	0534-2488811</p>
			</div>
		</div>
		<!-- 冷再生介绍 end -->
...
<script src="js/lengzaisheng.js"></script>
