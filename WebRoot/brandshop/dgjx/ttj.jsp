...
<%
	...
	String pro_sql = "select   id,name,file_name,img2,catalogname,zoomlion_hot_pic from pro_products where factoryid=151 and catalognum like '101003%' and is_show=1  order by order_no asc,id desc" ;
			...
			%>
				<li class="l pr goods_item imgZoom">
					...
					<div class="item_info pa fix">
						<p class="goods_tit l"><%=CommonString.getFormatPara(oneMap.get("name")) %>推土机</p>
