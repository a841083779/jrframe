...
<%
   ...
   if(catalog.equals("104008")){catalogNames="稳定土厂办设备";}
...
<div class="fy_top">
  <div class="contain980 fix">
    ...
    <ul class="fy_nav fix">
     ...
     <li <% if(catalog.equals("104008")){%>class="cur"<%}%>><a href="/brandshop/fangyuan/list.jsp?catalog=104008" title="稳定土厂办设备">稳定土厂办设备</a></li>
