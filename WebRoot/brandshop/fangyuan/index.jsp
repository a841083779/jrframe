...
<%
 ...
 String sql_sg= "select top 2 id,name,factoryname,file_name,img2,zoomlion_hot_pic ,catalogname from pro_products where factoryid=671 and is_show=1  and  catalognum  like'102011%' order by view_count desc" ;
  ...
  //稳定土厂办设备
 String sql_wd= "select top 2 id,name,factoryname,file_name,img2,zoomlion_hot_pic ,catalogname from pro_products where factoryid=671 and is_show=1 and  catalognum  like'104008%' order by view_count desc" ;
...
<div class="fy_top">
	<div class="contain980 fix">
        ...
        <ul class="fy_nav fix">
            ...
            <li><a href="/brandshop/fangyuan/list.jsp?catalog=104008" title="稳定土厂办设备">稳定土厂办设备</a></li>
...
<div class="fymain_bg">
	<div class="contain980 fix">
        ...
        <div class="fy_mval mval_right bg_p4">
            ...
            <div class="ftpro_sum">
            	<a href="/brandshop/fangyuan/list.jsp?catalog=104008" title="稳定土厂办设备">
                	<div class="fy_t1">稳定土厂办设备</div>
