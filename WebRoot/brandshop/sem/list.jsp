...
<%
	...
	//产品列表
	String pro_sql = "select  id,name,file_name,img2,catalogname_spe,catalognum_spe,zoomlion_hot_pic,catalogname,manual from pro_products where factoryid=138 and is_show=1 and catalognum like '"+catalog+"%'  order by order_no desc, id desc" ;
	   ...
	   <%
		...
		%>
				...
				<li>
				 ...
				 <div class="intro">
                    	<h4>山工机械<%=CommonString.getFormatPara(oneMap.get("name")) %><%=CommonString.getFormatPara(oneMap.get("catalogname")) %></h4>
