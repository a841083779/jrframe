...
<a href="http://zhuanti.21-sun.com/sg_ymt/" target="_blank"><div class="sg_banner"></div>
<div class="wrap con clearfix" id="b00">
    	<div class="con1 l">
        	<h3 class="sg_tit"><a href="/brandshop/sem/about.jsp"></a></h3>
            <div class="info">
			  ...
			  if(null!=companyInfo && companyInfo.size()>0){
				...
				for(int i=0;i<companyInfo.size();i++){
					...
					if(intro.length()>400){intro=intro.substring(2,400);}
		     %>
			    <a target="_blank" href="/brandshop/sem/about.jsp"><%=intro%>...</a>
				<%}}%><a target="_blank" href="/brandshop/sem/about.jsp" class="r" style="color:#183864; font-weight:bold; padding-top:20px;"> [查看更多]</a></p>
            </div>
      </div>
	  <!--装载机-->
	  <div class="con2 l" id="b11">
      	<h3 class="sg_tit"><a href="/brandshop/sem/list.jsp?catalog=101002"></a></h3>
        <ul >
		
		
		<li>
            	<div class="img">
            		<a href="http://product.21-sun.com/proDetail/SEM653D.shtm" target="_blank"><img src='images/653.jpg' width="607" height="386"/></a>
            	</div>
           	  <div class="intro">
               	<h4>山工SEM653D轮式装载机</h4>
                  <p>所属系列 ： 5吨装载机<br />
                      所属吨位 ： 5吨<br />
                      最大牵引力 : 167kN<br />
                      最大掘起力 : 177kN<br />
                  卸载高度 : 4162 mm</p>
                  <a class="a1" onclick="javascript:down('/brandshop/sem/images/653.pdf','653')"></a>
              	 <a class="a2" href="javascript:;" onClick="showinquery('30316','');"></a>
                </div>
            </li>

            <li>
            	<div class="img">
           		 <a href="http://product.21-sun.com/proDetail/SEM663D.shtm" target="_blank"><img src='images/663.jpg' width="607" height="386"/></a>
           		</div>
           	  <div class="intro">
               	<h4>山工SEM663D轮式装载机</h4>
                  <p>所属系列：6吨装载机<br />
                    所属吨位：6吨<br />
                    最大牵引力:186kN<br />
                    最大掘起力 :197kN<br />
                  卸载高度 :4196 mm</p>
				    <a class="a1" onclick="javascript:down('/brandshop/sem/images/663.pdf','663')"></a>
              	 <a class="a2" href="javascript:;" onClick="showinquery('30317','');"></a>
                </div>
            </li>
		    ...
		    <li>
            	<div class="img">
           		<a href="http://product.21-sun.com/proDetail/SEM655D.shtm" target="_blank"> <img src='images/655D.jpg' width="607" height="386"/></a>
                 </div>
           	  <div class="intro">
               	<h4>山工机械SEM655D轮式装载机</h4>
                  <p>所属系列 ： 5吨装载机<br />
                    所属吨位 ：5吨<br />
                    最大牵引力 : 167kN<br />
                    最大掘起力 : 173kN<br />
                  卸载高度 : 4162 mm</p>
                  <a class="a1"  onclick="javascript:down('/uploadfiles_sem/SEM655D.pdf','SEM655D')" ></a>
              	 <a class="a2"  href="javascript:;" onClick="showinquery('23998','');"></a>
                </div>
            </li>
      ...
      <div class="con3 l mb20" id="b22">
    	<h3 class="sg_tit"><a href="/brandshop/sem/list.jsp?catalog=101003"></a></h3>
      	<a href="javascript:;" onClick="showinquery('23993','');"><img src='images/pdj822.jpg' /></a>
      </div>
	   <!--平地机-->
  <div class="con4 l mb20" id="b33">
     	<h3 class="sg_tit"><a href="/brandshop/sem/list.jsp?catalog=101005"></a></h3>
      	<a href="javascript:;" onClick="showinquery('10965','');"><img src='images/img6.jpg' /></a>
      </div>
	   <!--压路机-->
         <div class="con5 l mb20" id="b44">
      	<h3 class="sg_tit"><a href="/brandshop/sem/list.jsp?catalog=106001"></a></h3>
      	<a href="javascript:;" onClick="showinquery('23997','');"><img src='images/ylj522.jpg'/></a>
      </div>
    ...
    <div class="w978 border03 l list08">
    	<div class="clearfix yhdedd">
        	<div class="l title_left">山工机械产品订单</div>
...
function down(obj,obj1){
    window.open("/brandshop/sem/down.jsp?filename="+encodeURI(obj)+"&title="+encodeURI(obj1));
}
</script>
    <script type="text/javascript">
(function($){
