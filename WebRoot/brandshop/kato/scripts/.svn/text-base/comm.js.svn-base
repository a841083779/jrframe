...
$nav.mouseenter(function(){
	if(ie6){
		$(this).find('iframe').css('width',$(this).children('ul').width()).css('height',$(this).children('ul').height()).css('top',$(this).children('ul').css('top')).css('left',$(this).children('ul').css('left')).show();
