...
<div class="banner_shop" style="background: url();position:relative;z-index:10px;">
      ...
      <div id="slideBox" class="slideBox" >
					...
					<div class="bd">
						<ul>
						  <li><img src="/brandshop/johndeere/images/1.jpg" /></li>
...
<div class="shop_main" style="position:relative;z-index:20px;">
  <div class="contain980">
    <div class="shop_pro1"><a href="http://product.21-sun.com/proDetail/E300.shtm" target="_blank" title="约翰迪尔E300LC液压挖掘机"><img src="images/pro1.png" width="980" height="396" alt="" class="png"/></a></div>
    <div class="mt10"><a href="http://product.21-sun.com/proDetail/E330.shtm" target="_blank" title="约翰迪尔E330LC液压挖掘机"><img src="images/pro2.jpg" alt="" width="980" height="360"/></a></div>
    <div class="mt10"><a href="http://product.21-sun.com/proDetail/E360-93.shtm " target="_blank" title="约翰迪尔E360LC液压挖掘机"><img src="images/pro3.jpg" alt=""  width="980" height="360"/></a></div>
  </div>
  <div class="wrap1000">
        ...
        <form action="/action/order_save_brandshop.jsp" method="post" name="theform" id="theform" onsubmit="return submitYN(this);">
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="list_border_bg">
            ...
            <tr>
              ...
              <tr>
                <th>&nbsp;</th>
                <td height="30" colspan="2"><input class="btn02" name="Submit" type="submit" value="" /></td>
  ...
  <div class="aboutbg mt20">
    ...
    <div class="bgmain">
      <div class="contain980 shopPart08">
       ...
       %>
              <!-- <div class="title08"><h3><b>询价总数：<%//=pageBean.getTotal() %></b> - 采购询价</h3>
