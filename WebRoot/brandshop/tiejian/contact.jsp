...
//选出所有的类别
String sel_sql2 = " select num,catalogname from dbo.pro_factory_category where factoryid=1758 order by id" ;
...
<title>联系我们_铁建重工_铁建重工品牌专区  - 铁臂商城</title>
  ...
  <div class="contain980 clearfix">
    <div class="shopContain">
      ...
      <div class="shopRightPart">
        <div class="listBanner"><img src="images/listbanner02.jpg" width="690" height="220" /></div>
        <div class="strongTitle">
          <h2><span>联系我们</span></h2>
        </div>
        <div class="intro_text">
        地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：山东临沂经济技术开发区滨河东路66号<br />
        邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;编：276034<br />
        联系电话：0086-0539-8152370<br />
        传&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真：0086-0539-8162158<br />
        服务热线：400-000-1000
         </div>
      </div>
    </div>
