...
<div class="shopNav">
  <div class="contain980">
    <ul>
      <li><a href="#">首页</a></li>
        <li><a href="#">宣工挖掘机</a></li>
        <li><a href="#">宣工推土机</a></li>
        <li><a href="#">原厂配件</a></li>
        <li><a href="#">关于宣工</a></li>
    </ul>
  </div>
    ...
    <div class="shopContain">
      <div class="shopLeftPart">
        ...
        <ul class="shopListMenu">
           <li class=""><a href="?num=101">宣工挖掘机</a></li>
           <li class=""><a href="?num=102">宣工推土机</a></li>
           <li class="select"><a href="?num=103">原厂配件</a></li>
          <li class=""><a href="?num=104">关于宣工</a></li>		
        </ul>
      ...
      <div class="shopRightPart">
        ...
        <div class="listBanner"><a title="江苏华通官方旗舰店" target="_blank" href="/brandshop/huatong/"><img src="images/inbanner.jpg" width="650" height="210" /></a></div>
