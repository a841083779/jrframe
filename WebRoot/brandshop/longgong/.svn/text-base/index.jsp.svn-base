        ...
        <ul class="fix">
		 ...
		 %>
          <li> <a title="<%=CommonString.getFormatPara(oneMap.get("catalogname"))+CommonString.getFormatPara(oneMap.get("name"))%>" href="/proDetail/<%=CommonString.getFormatPara(oneMap.get("file_name")) %>" title="" target="_blank">
            <div class="tuijian_img"><img title="<%=CommonString.getFormatPara(oneMap.get("catalogname"))+CommonString.getFormatPara(oneMap.get("name"))%>" src="http://product.21-sun.com/uploadfiles/<%=imgSrc %>" alt="<%=CommonString.getFormatPara(oneMap.get("catalogname"))+CommonString.getFormatPara(oneMap.get("name"))%>"/></div>
  ...
  <div class="contain980">
    ...
    <div class="lg_pro_list">
      <ul class="fix">
         ...
         %>
        <li>
          <div class="lg_pimg"><a href="/proDetail/<%=CommonString.getFormatPara(oneMap.get("file_name")) %>" title="<%=CommonString.getFormatPara(oneMap.get("catalogname"))+CommonString.getFormatPara(oneMap.get("name"))%>" target="_blank"><img width="224" height="224" src="http://product.21-sun.com/uploadfiles/<%=imgSrc %>" alt="<%=CommonString.getFormatPara(oneMap.get("catalogname"))+CommonString.getFormatPara(oneMap.get("name"))%>"/></a></div>
  ...
  <div class="contain980">
    ...
    <div class="lg_pro_list">
      <ul class="fix">
        ...
        %>
        <li>
          <div class="lg_pimg"><a title="<%=CommonString.getFormatPara(oneMap.get("catalogname"))+CommonString.getFormatPara(oneMap.get("name"))%>" href="/proDetail/<%=CommonString.getFormatPara(oneMap.get("file_name")) %>"  target="_blank"><img width="224" height="224" src="http://product.21-sun.com/uploadfiles/<%=imgSrc %>" alt=""/></a></div>
