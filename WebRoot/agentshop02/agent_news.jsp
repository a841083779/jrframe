...
<!--公司名称结束--> 
<!--店铺导航-->
<jsp:include page="nav_top.jsp"><jsp:param value="3" name="flag"/></jsp:include>
<!--店铺导航结束--> 
<!--主体-->
        ...
        <div class="sContent"> 
        	...
        	if(list != null && list.size() > 0){
				...
				for(int i = 0;list != null && i < list.size();i++){
    				...
    				%>
    				<tr>
    					<td style="height: 30px; line-height: 30px;"><a href="/news/detail.jsp?id=<%=CommonString.getFormatPara(m.get("id")) %>&t_flag=product" target="_blank"><%=CommonString.getFormatPara(m.get("title")) %></a></td>
