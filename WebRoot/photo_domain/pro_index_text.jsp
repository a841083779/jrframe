...
<%
	...
	//国内品牌
		...
		//国外品牌
		List<Map> list1 = dbHelper.getMapList("select name,id,is_inner from pro_agent_factory where id in(select distinct(pro_products.factoryid) from pro_products  where is_show=1 and catalognum_new like '%"+catalog+"%') and is_inner=0  order by view_count desc",connection) ;
