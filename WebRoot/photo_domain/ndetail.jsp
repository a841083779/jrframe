...
<%
	...
	String contents= CommonString.getFormatPara(main_pics.get("contents"));
	...
	String titled="";String keywordsd="";String descriptiond="";
		...
		titled="【产品图片】"+title+"_产品图片 – 铁臂图库";
        keywordsd=""+title+",产品图片,产品图片大全";
        descriptiond="铁臂图库为您提供最新"+title+"的产品图片,想了解"+title+"的产品图片请到铁臂图库来.买工程机械产品就上铁臂商城.";
		}
...
<div class="pho_newderail"> 
 ...
 <div class="contain980">
  ...
  <div class="clear"></div>
  <%if(!contents.equals("")){%>
  <div style="float:left;height:30px;">描述：<%=contents%></div>
  <%}%>
</div>
