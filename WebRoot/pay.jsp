...
<%@page import="com.jerehnet.alipay.config.AlipayConfig" %>
...
if(request.getParameter("WIDout_trade_no")!=null){
    ...
    String out_trade_no = CommonString.getFormatPara(request.getParameter("WIDout_trade_no"));
	// 订单名称，必填
    String subject = CommonString.getFormatPara(request.getParameter("WIDsubject")); 
	System.out.println(subject);
    // 付款金额，必填
    String total_amount= CommonString.getFormatPara(request.getParameter("WIDtotal_amount")); 
    // 商品描述，可空
    String body =  CommonString.getFormatPara(request.getParameter("WIDbody"));
    // 超时时间 可空
