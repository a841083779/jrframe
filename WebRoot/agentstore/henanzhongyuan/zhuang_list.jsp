...
<%
    ...
    String sel_sql2 = "select catalognum,catalogname from pro_products where catalognum not like '107%' and factoryid ='139' and len(catalognum)<9 group by catalognum,catalogname order by catalognum " ;
    List<Map> catalogList = dbHelper.getMapList(sel_sql2); 
    
    
    String whereStr = "and 1=1 and factoryid=139 and catalognum LIKE '"+ catalognum +"%' and is_show=1 AND agentid=1202 "; 
    PageBean pageBean = new PageBean() ; 
    String offset = CommonString.getFormatPara(request.getParameter("offset"));
    pageBean.setTableName("pro_agent_product_vi");
    pageBean.setFields(" name,factoryid,factoryname,catalognum,catalogname,price_start,price_end,place,img2,id") ;
    pageBean.setOrderBy(" factoryid ") ;
    ...
    zhuangProductsList = pageBean.getDatas() ;
...
-->	<div class="g_link">
    ...
    <div class="con3" id="list">
    <div class="g_tit tit3">
      <div class="wrap clearfix">
    	<h2>厦工机械产品</h2>
      </div>
    </div>
    <div class="wrap fix newadd">
      <div class="shopLeftPart">
        ...
        <!--  
          <li><a href="#">摊铺机械</a></li>
          <li><a href="#">养护机械</a></li>
          <li><a href="#">沥青搅拌设备</a></li>
          <li><a href="#">铲运机械</a></li>
          <li class="select"><a href="#">稳定土厂拌设备</a></li>
          <li><a href="#">再生设备</a></li>-->
           <%
          	if(null!=catalogList && catalogList.size()>0){
          		for(int i=0;i<catalogList.size();i++){
          			...
          			%>
          			 <li class="<%=catalognum.equals(CommonString.getFormatPara(oneMap.get("catalognum")))?"select":"" %>"><a href="?num=<%=CommonString.getFormatPara(oneMap.get("catalognum")) %>"><%=CommonString.getFormatPara(oneMap.get("catalogname")) %></a></li>
          			<%
          		}
          	}
          %>
