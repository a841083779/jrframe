...
<%
	...
	String wa_sql = " select * from pro_agent_product_vi where factoryid=183 and catalognum LIKE '101001%' AND agentid=16137 and is_show=1" ; 
...
<div class="g_nav">
    	<ul class="wrap">
          ...
          <li><a href="/agentstore/henanzhongyuan/wa_list.jsp">原装神钢挖掘机</a></li>
...
-->
	<div class="g_link">
    	<div class="wrap clearfix">
    	<ul class=" ">
          <li><a href="/agentstore/henanzhongyuan/wa_list.jsp"><img src="images/a1.jpg" alt=""/></a></li>
