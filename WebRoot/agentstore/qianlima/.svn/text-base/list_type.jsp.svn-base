...
<%
	...
	String sel_sql = "select top 16 * from pro_products where factoryid= "+factoryid ;
	List<Map> products_List = null; 
	Map catalogMap = (HashMap)application.getAttribute("catalogMap") ;
	Map brandMap = (HashMap)application.getAttribute("brandMap") ;
	if("".equals(factoryid)){
		response.sendRedirect("/servlo/") ;
	}
	if(!"".equals(catanum)){
		// catanum = "101001" ;
	}
      ...
      <div class="shopLeftPart">
        ...
        <ul class="shopListMenu" id="leftNav">
          <li><a href="javascript:;" value="192">斗山</a>
            <ul>
              <li><a href="list_type.jsp?factoryid=192&catanum=101001">挖掘机</a></li>
              <li><a href="list_type.jsp?factoryid=192&catanum=101002">装载机</a></li>
              <li><a href="list_type.jsp?factoryid=192&catanum=101008">铰接式自卸卡车</a></li>
              <li><a href="list_type.jsp?factoryid=192&catanum=113001">破碎锤</a></li>
            </ul>
          </li>
          <li><a href="javascript:;" value="137">临工</a>
            <ul>
              <li><a href="list_type.jsp?factoryid=137&catanum=101002">装载机</a></li>
              <li><a href="list_type.jsp?factoryid=137&catanum=101001">液压控掘机</a></li>
              <li><a href="list_type.jsp?factoryid=137&catanum=106001">压路机</a></li>
            </ul>
          </li>
          <li><a href="javascript:;" value="454">山猫</a>
            <ul>
              <li><a href="list_type.jsp?factoryid=454&catanum=101002">装载机</a></li>
              <li><a href="list_type.jsp?factoryid=454&catanum=101001">挖掘机</a></li>
            </ul>
          </li>
          <li><a href="javascript:;" value="1661">千里马</a>
            <ul>
              <li><a href="#">再制造产品</a></li>
              <li><a href="list_type.jsp?factoryid=1661&catanum=113001">破碎锤</a></li>
            </ul>
          </li>
        </ul>
        <div class="shopIntro">
      ...
      <div class="shopRightPart">
        ...
        <div class="listPart">
          <div class="title">
            ...
            <span class="more"><a href="/brandshop/sevalo/list.jsp?factoryid=<%=factoryid %><%=catanum.equals("")?"":"&catanum="+catanum %>" target="_blank">更多&gt;&gt;</a></span>
          </div>
             ...
             <%
              ...
              if(null!=products_List && products_List.size()>0){
               ...
               <li>
                ...
                <h4><a href="/proDetail/<%=CommonString.getFormatPara(oneMap.get("file_name")) %>" target="_blank" title="<%=CommonString.getFormatPara(oneMap.get("factoryname")) +CommonString.getFormatPara(oneMap.get("catalogname"))+CommonString.getFormatPara(oneMap.get("name"))%>"><%=CommonString.getFormatPara(oneMap.get("name"))+CommonString.getFormatPara(oneMap.get("catalogname"))%></a></h4>
