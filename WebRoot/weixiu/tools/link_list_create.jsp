...
<%
	...
	try {
		...
		String fileOutPutSteam = "<link href=\"/style/friendly_link.css\" rel=\"stylesheet\" type=\"text/css\" />"
				+ "\n"
				+"<div style='text-align:center;'  width='100%'>铁臂维修发布的信息确系本人原创，严禁剽窃、转投他人信息，若因此引起任何法律纠纷，与铁臂维修无关。</div>"
		...
		string2File(fileOutPutSteam, base + "/include/index/" + "friendlink_weixiu.htm");
		i = 1;
	} catch (Exception e) {
		e.printStackTrace();
		i = -1;
