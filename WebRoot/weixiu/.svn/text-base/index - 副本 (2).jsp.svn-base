...
<%
	...
	//供求市场的维修信息
	String weixiuQuery = "select top 20 id,title,province,city,pub_date from sell_buy_market where is_show=1 and (title like '%维修%' or title like '%保养%')"+market;
...
<div class="contain980 mb10">
  <h3 class="breadCrumbs">
    ...
    <%}%>
    <%="".equals(factoryid)?"":" &gt;&gt; <a href='/0-0-"+factoryid+".htm'>"+("".equals(factoryid)?"":CommonString.getFormatPara(brandMap.get(factoryid))) +"</a>"%> <%="".equals(catalog)?"":" &gt;&gt; <a href='/"+catalog+"-0-0.htm'>"+("".equals(catalog)?"":CommonString.getFormatPara(catalogMap.get(catalog))) +"</a>"%> <%=("".equals(catalog)||"".equals(factoryid))?"":" &gt;&gt; "+("".equals(factoryid)?"":CommonString.getFormatPara(brandMap.get(factoryid))) +("".equals(catalog)?"":CommonString.getFormatPara(catalogMap.get(catalog)).equals("起重机械")?"起重机":CommonString.getFormatPara(catalogMap.get(catalog)))%> <%=("".equals(catalog)&&"".equals(factoryid))?"":" &gt;&gt; "+("".equals(factoryid)?"":CommonString.getFormatPara(brandMap.get(factoryid))) +("".equals(catalog)?"":CommonString.getFormatPara(catalogMap.get(catalog)).equals("起重机械")?"起重机":CommonString.getFormatPara(catalogMap.get(catalog)))+"维修"%></h3>
</div>
<div class="contain980 clearfix">
  ...
  <div class="nre_right">
    ...
    <form name="theform" id="theform">
	  ...
	  jQuery(document).ready(function() {
          ...
          <li class="cblist">
            ...
            <dd> <a href="/0-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("".equals(catalog)){%> class='select' <%} %>>不限</a> <a href="/101001-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("101001".equals(catalog)){%> class='select' <%} %>>挖掘机维修</a> <a href="/101002-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("101002".equals(catalog)){%> class='select' <%} %>>装载机维修</a> <a href="/102-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("102".equals(catalog)){%> class='select' <%} %>>起重机维修</a> <a href="/101003-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("101003".equals(catalog)){%> class='select' <%} %>>推土机维修</a> <a href="/103-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("103".equals(catalog)){%> class='select' <%} %>>混凝土维修</a> <a href="/106001-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("106001".equals(catalog)){%> class='select' <%} %>>压路机维修</a> <a href="/101005-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("101005".equals(catalog)){%> class='select' <%} %>>平地机维修</a> <a href="/105003-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("105003".equals(catalog)){%> class='select' <%} %>>旋挖钻维修</a> <a href="/113001-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("113001".equals(catalog)){%> class='select' <%} %>>破碎锤维修</a> <a href="/104001-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("104001".equals(catalog)){%> class='select' <%} %>>摊铺机维修</a> <a href="/107-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("107".equals(catalog)){%> class='select' <%} %>>叉车维修</a> <a href="/104-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("104".equals(catalog)){%> class='select' <%} %>>筑养路维修</a> <a href="/105-0-<%=factoryid.equals("")?"0":factoryid%>.htm" <%if("105".equals(catalog)){%> class='select' <%} %>>桩工维修</a>
          ...
          <li class="cblist">
            ...
            <dd>
              <%if (!"".equals(catalog)) {%>
              <a  href="/<%=catalog%>-0-0.htm" <%if("".equals(factoryid)){%>  class="select" <%} %>>不限</a>
              <% List<Map> recommend_brands = dbHelper.getMapList(" select catalognum,catalogname,factoryid,factoryname from pro_catalog_factory where catalognum ='" + catalog+ "' order by order_no desc",connection);
										...
										%>
              <!-- 挖掘机 -->
              <a  href="/<%=catalog%>-0-<%=CommonString.getFormatPara(oneMap.get("factoryid"))%>.htm"
              ...
              <%
										...
										%>
              <a <%if("".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-0.htm">不限</a> <a <%if("133".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-133.htm">三一</a> <a <%if("182".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-182.htm">小松</a> <a <%if("192".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-192.htm">斗山</a> <a <%if("184".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-184.htm">日立</a> <a <%if("183".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-183.htm">神钢</a> <a <%if("175".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-175.htm">沃尔沃</a> <a <%if("174".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-174.htm">卡特彼勒</a> <a <%if("146".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-146.htm">玉柴重工</a> <a <%if("136".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-136.htm">柳工</a> <a <%if("194".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-194.htm">现代京城</a> <a <%if("134".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-134.htm">中联重科</a> <a <%if("209".equals(factoryid)){%>  class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-209.htm">徐工</a> <a <%if("139".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-139.htm">厦工</a> <a <%if("135".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-135.htm">龙工</a> <a <%if("141".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-141.htm">福田雷沃</a> <a <%if("137".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-137.htm">临工</a> <a <%if("144".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-144.htm">山推</a> <a <%if("152".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-152.htm">山重建机</a> <a <%if("189".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-189.htm">加藤</a> <a <%if("455".equals(factoryid)){%> class='select' <%} %> href="/<%=catalog.equals("")?"0":catalog%>-0-455.htm">凯斯</a>
              <%}%>
              <div id="changethis" class="pbtn"></div>
              <div class="plmore" style="padding-left: 0px; width: 660px;">
    ...
    <div class="rp clearfix mb10 nwx_zxlist repairList">
      <div class="title">
        <h3><%="".equals(catalog+factoryid)?"工程机械":""%><%=showtonandmeter%><%="".equals(factoryid) ? "" : CommonString.getFormatPara(brandMap.get(factoryid))%><%="".equals(catalog) ? "" : CommonString.getFormatPara(catalogMap.get(catalog)).equals("起重机械")?"起重机":CommonString.getFormatPara(catalogMap.get(catalog))%>维修</h3>
      ...
      <div class="content rList01">
		...
		%>
          <li>
            <h3><span class="lb">[维修]</span><a target="_blank" href="/weixiu/detail_for_<%="".equals(factoryid)?"0":factoryid%>_<%="".equals(catalog)?"0":catalog%>_<%=CommonString.getFormatPara(m.get("id")) %>.htm" target="_blank" title="<%=CommonString.getFormatPara(m.get("title")) %>"><%=CommonString.getFormatPara(m.get("title")) %></a></h3>
