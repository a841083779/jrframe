   ...
   //拆分吨位
    ...
    try{	
		   ...
		   //徐工代理商
			...
			String catabrand=""; String TDK="";
			String cataName="工程机械";if(!catalog.equals("")){cataName=CommonString.getFormatPara(catalogMap.get(catalog));}
			TDK=show_province+show_city+CommonString.getFormatPara(brandMap.get(factoryid))+cataName;
			if(!factoryid.equals("")||!catalog.equals("")||!(show_province+show_city).equals("")){
			if(!factoryid.equals("")&&!catalog.equals("")){
			catabrand=CommonString.getFormatPara(brandMap.get(factoryid)).replace("卡特彼勒","卡特")+CommonString.getFormatPara(catalogMap.get(catalog));
		    title="【电话】"+TDK.replace("卡特彼勒","卡特")+"维修网点_"+TDK.replace("卡特彼勒","卡特")+"维修中心_"+TDK.replace("卡特彼勒","卡特")+"维修 - 铁臂维修";
			keywords=TDK.replace("卡特彼勒","卡特")+"维修网点,"+TDK.replace("卡特彼勒","卡特")+"维修中心,铁臂维修";
			description="铁臂维修推荐"+TDK.replace("卡特彼勒","卡特")+"，帮您快速解决"+TDK.replace("卡特彼勒","卡特")+"维修问题，买"+TDK.replace("卡特彼勒","卡特")+"就上铁臂商城。";
			}else{
			catabrand=CommonString.getFormatPara(brandMap.get(factoryid))+CommonString.getFormatPara(catalogMap.get(catalog));
	        title="【电话】"+TDK+"维修网点_"+TDK+"维修中心_"+TDK+"维修 - 铁臂维修";
			keywords=TDK+"维修网点,"+TDK+"维修中心,铁臂维修";
			description="铁臂维修推荐"+TDK+"，帮您快速解决"+TDK+"维修问题，买"+TDK+"就上铁臂商城。";
			}
...
<div class="contain980 mb10">
  <h3 class="breadCrumbs"><a href="http://weixiu.21-sun.com/">铁臂维修</a><%if("".equals(catalog)&&"".equals(factoryid)&&"".equals(show_province+show_city)){%> &gt;&gt; 维修网点<%}%>
   ...
   <%=(!"".equals(catalog)&&!"".equals(factoryid)||!"".equals(show_province+show_city)&&!"".equals(factoryid)||!"".equals(catalog)&&!"".equals(show_province+show_city))?" &gt;&gt; "+show_province+show_city+("".equals(factoryid)?"":CommonString.getFormatPara(brandMap.get(factoryid))).replace("卡特彼勒","卡特") +("".equals(catalog)?"":CommonString.getFormatPara(catalogMap.get(catalog)).equals("起重机械")?"起重机":CommonString.getFormatPara(catalogMap.get(catalog))):""%>
   <%=("".equals(catalog)&&"".equals(factoryid)&&"".equals(show_province+show_city))?"":" &gt;&gt; "+show_province+show_city+(  "".equals( ("".equals(factoryid)?"":CommonString.getFormatPara(brandMap.get(factoryid)))+("".equals(catalog)?"":CommonString.getFormatPara(catalogMap.get(catalog))))?"工程机械":(!"".equals(factoryid)&&"".equals(catalog)?CommonString.getFormatPara(brandMap.get(factoryid)):"")+(!"".equals(factoryid)&&!"".equals(catalog)?CommonString.getFormatPara(brandMap.get(factoryid)).replace("卡特彼勒","卡特"):"") +("".equals(catalog)?"":CommonString.getFormatPara(catalogMap.get(catalog)).equals("起重机械")?"起重机":CommonString.getFormatPara(catalogMap.get(catalog)))  )+"维修网点"%></h3>
</div>
      ...
      <div class="border03 l Condition mb10 nwx_net_sea">
        <div class="ConditionTop">
          <div class="l">
            ...
            <a href="/network/"> <span class="reset">重置</span></a>
            <%}%>
