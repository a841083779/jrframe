...
(function () {
    ...
    var tmp = window.location.pathname,
            URL = "/plugin/editor/ueditor/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    UEDITOR_CONFIG = {
	    ...
	    imageManagerPath:"/backend/file/file_list.jsp",       //图片在线浏览的处理地址
        ...
        toolbars:[
            ['FullScreen', 'Source', '|', 'Undo', 'Redo', '|',
                ...
                'Link', 'Unlink', 'Anchor','|', 'InsertImage', 'Emotion', 'InsertVideo', '|',
        ...
        iframeUrlMap:{
            'anchor':'/plugin/editor/ueditor/dialogs/anchor/anchor.html',
            'insertimage':'/plugin/editor/ueditor/dialogs/image/image.html',
            'inserttable':'/plugin/editor/ueditor/dialogs/table/table.html',
            'link':'/plugin/editor/ueditor/dialogs/link/link.html',
            'spechars':'/plugin/editor/ueditor/dialogs/spechars/spechars.html',
            'searchreplace':'/plugin/editor/ueditor/dialogs/searchreplace/searchreplace.html',
            'map':'/plugin/editor/ueditor/dialogs/map/map.html',
            'gmap':'/plugin/editor/ueditor/dialogs/gmap/gmap.html',
            'insertvideo':'/plugin/editor/ueditor/dialogs/video/video.html',
            'help':'/plugin/editor/ueditor/dialogs/help/help.html',
            'highlightcode':'/plugin/editor/ueditor/dialogs/code/code.html',
            'emotion':'/plugin/editor/ueditor/dialogs/emotion/emotion.html',
            'wordimage':'/plugin/editor/ueditor/dialogs/wordimage/wordimage.html',
            'attachment':'/plugin/editor/ueditor/dialogs/attachment/attachment.html',
            'insertframe':'/plugin/editor/ueditor/dialogs/insertframe/insertframe.html',
            'edittd':'/plugin/editor/ueditor/dialogs/table/edittd.html',
            'snapscreen': '/plugin/editor/ueditor/dialogs/snapscreen/snapscreen.html'
        },
        //所有的的下拉框显示的内容
        listMap:{
            //字体
            'fontfamily':['宋体', '楷体', '隶书', '黑体', 'andale mono', 'arial', 'arial black', 'comic sans ms', 'impact', 'times new roman', '微软雅黑'],
            //字号
