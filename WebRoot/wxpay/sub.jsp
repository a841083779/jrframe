...
<%
		...
		String payType = CommonString.getFormatPara(request.getParameter("payType"));
        ...
        String notifyUrl="http://192.168.40.89:10031/wxpay/notify_url.jsp";
        WXPay.initSDKConfiguration(key, appid, mchID);
        String body = proName;
        String deviceInfo = "";
        String tradeType = "JSAPI";//App支付
        String attach = null;
        Double totalReceivableAmount = 200.00;
        int totalFee = (int) (totalReceivableAmount * 100);
        totalFee = 20000;////////////////////////////////
        if(payType.equals("2")){
			totalFee = 180000;
			notifyUrl="http://192.168.40.89:10031/wxpay/notify_url2.jsp";
		}
		if(payType.equals("3")){
			totalFee = 200000;
			notifyUrl="http://192.168.40.89:10031/wxpay/notify_url2.jsp";
