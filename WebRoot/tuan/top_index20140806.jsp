...
<div class="top clearfix">
  <div class="wrap">
    ...
    <div class="city">
    	<span id="allAplace">
		<%
		    String agent_palce = CommonString.getFilterStr(request.getParameter("agent_area")).replace("</?[^<>]*>","");
	if(agent_palce.indexOf("<img")!=-1||agent_palce.indexOf("alert")!=-1||agent_palce.indexOf("onerror")!=-1)
	{
	     agent_palce="";
	}
		if(agent_palce==null){
