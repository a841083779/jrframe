...
<%
    ...
    // if(m1.find()){
	 ...
	 if(catalog.length()>6){
	 catalog_first=catalog.substring(0,6);
	 }else{
	 catalog_first=catalog;
	 }
	...
	if (!"".equals(agent_area)) {  
	       if(agent_area.equals("全国")){
		     whereStr.append("  and agent_area!='' ");
			}else{
			whereStr.append("  and (agent_area like '%"+agent_area+"%' or  agent_area like '%全国%' )");
			}
	}else{
	  whereStr.append("  and (agent_area like '%"+province+"%' or  agent_area like '%全国%' )");
	  agent_area=province;
	}
	...
	//TDK
	String T_title="";String D_descript="";String K_keyword="";
	if(catalog_first.equals("")){
	T_title="优买团 - 找工程机械优惠促销活动就上优买团";
	D_descript="工程机械团购,工程机械优惠促销,工程机械促销活动,工程机械最低价";
	K_keyword="铁臂商城旗下优买团为您提供各种工程机械优惠促销,工程机械团购活动,团购最低价.找工程机械优惠促销活动就上优买团!";
	}else if(catalog_first.equals("part")){
	T_title="工程机械配件优惠,工程机械配件促销活动 – 优买团";
	D_descript="工程机械配件优惠,工程机械配件促销活动";
	K_keyword="铁臂商城旗下优买团为您提供工程机械配件优惠促销, 工程机械配件团购活动, 工程机械配件团购最低价.找工程机械配件优惠促销活动就上优买团!";
	}else if(catalog_first.equals("other")){
	T_title="工程机械设备优惠,工程机械设备促销活动 – 优买团";
	D_descript="工程机械设备优惠,工程机械设备促销活动";
	K_keyword="铁臂商城旗下优买团为您提供工程机械设备优惠促销, 工程机械设备团购活动, 工程机械设备团购最低价.找工程机械设备优惠促销活动就上优买团!";
	}
...
<%if(catalog_first.equals("")||catalog_first.equals("part")||catalog_first.equals("other")){%>
<title><%=T_title%></title>
<meta name="keywords" content="<%=K_keyword%>" />
<meta name="description" content="<%=D_descript%>" />
<%}else{%>
<title><%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>优惠, <%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>促销活动, <%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>团购 - 优买团</title>
<meta name="keywords" content="铁臂商城旗下优买团为您提供<%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>优惠促销,<%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>团购活动, <%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>团购最低价.找<%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>优惠促销活动就上优买团!" />
<meta name="description" content="<%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>优惠, <%=CommonString.getFormatPara(brandMap.get(factory))%><%=CommonString.getFormatPara(catalogMap.get(catalog))%>促销活动" />
<%}%>
...
<div class="homeCon wrap">
	<div class="h_left">
    	<ul class="subNav">
        	<li class="l1"><a href="index.jsp?catalog=101001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><i class="ico ic0"></i>挖掘机<em>Excavator</em></a>
            	<dl class="menu">
                	<dt>品牌：</dt>
					<%
					//左侧品牌
	 List<Map> list = dbHelper.getMapList(" select factoryname,factoryid  from pro_ymt_activity where is_show=1 and pro_catanum like'101001%' and factoryname!='' group by factoryname,factoryid ",connection) ;
                    ...
                    <dd><a href="index.jsp?factory=<%=factoryid%>&catalog=101001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><%=factoryname%></a></dd>
					<%}%>
                </dl>
            </li>
            <li class="l2"><a href="index.jsp?catalog=101002<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><i class="ico ic2"></i>装载机<em>Loaders</em></a>
            	<dl class="menu">
                	<dt>品牌：</dt>
					<%
					//左侧品牌
	 List<Map> list1 = dbHelper.getMapList(" select factoryname,factoryid  from pro_ymt_activity where is_show=1 and pro_catanum like'101002%' and factoryname!='' group by factoryname,factoryid ",connection) ;
					for(int i = 0;list1 != null && i < list1.size();i++){
						...
						String factoryid=(String)CommonString.getFormatPara(m.get("factoryid"));
					%>
                    <dd><a href="index.jsp?factory=<%=factoryid%>&catalog=101002<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><%=factoryname%></a></dd><%}%>

                </dl>
            
            </li>
            <li class="l3"><a href="index.jsp?catalog=106001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><i class="ico ic3"></i>压路机<em>Roller</em></a>
            <dl class="menu">
                	<dt>品牌：</dt>
					<%
					//左侧品牌
	 List<Map> list2 = dbHelper.getMapList(" select factoryname,factoryid  from pro_ymt_activity where is_show=1 and pro_catanum like'106001%' and factoryname!='' group by factoryname,factoryid ",connection) ;
					for(int i = 0;list2 != null && i < list2.size();i++){
						...
						String factoryid=(String)CommonString.getFormatPara(m.get("factoryid"));
					%>
                    <dd><a href="index.jsp?factory=<%=factoryid%>&catalog=106001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><%=factoryname%></a></dd><%}%>
           
                </dl>
            </li>
            <li class="l4"><a href="index.jsp?catalog=103<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><i class="ico ic4"></i>混凝土<em>Concrete</em></a>
            <dl class="menu">
                	<dt>品牌：</dt>
					<%
					//左侧品牌
	 List<Map> list3 = dbHelper.getMapList(" select factoryname,factoryid  from pro_ymt_activity where is_show=1 and pro_catanum like'103%' and factoryname!='' group by factoryname,factoryid ",connection) ;
					for(int i = 0;list3 != null && i < list3.size();i++){
						...
						String factoryid=(String)CommonString.getFormatPara(m.get("factoryid"));
					%>
                    <dd><a href="index.jsp?factory=<%=factoryid%>&catalog=103<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><%=factoryname%></a></dd><%}%>
 
                </dl>
            
            </li>
            <li class="l5"><a href="index.jsp?catalog=part<%=agent_area.equals("")?"":"&agent_area="+agent_area%>" > <i class="ico ic5"></i>配件<em>Parts</em></a>
            	<dl class="menu">
               <dt>品牌：</dt>
					<%
					//左侧品牌
	 List<Map> list7 = dbHelper.getMapList(" select factoryname,factoryid  from pro_ymt_activity where is_show=1 and pro_catanum like'000%' and factoryname!='' group by factoryname,factoryid ",connection) ;
					for(int i = 0;list7 != null && i < list7.size();i++){
						...
						String factoryid=(String)CommonString.getFormatPara(m.get("factoryid"));
					%>
                    <dd><a href="index.jsp?factory=<%=factoryid%>&catalog=000<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><%=factoryname%></a></dd><%}%>
                </dl>
            </li>
            <li class="l6"><a href="index.jsp?catalog=113001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><i class="ico ic6"></i>破碎锤<em>Breaker</em></a>
            <dl class="menu">
                	<dt>品牌：</dt>
					<%
					//左侧品牌
	 List<Map> list4 = dbHelper.getMapList(" select factoryname,factoryid  from pro_ymt_activity where is_show=1 and pro_catanum like'113001%' and factoryname!='' group by factoryname,factoryid ",connection) ;
					for(int i = 0;list4 != null && i < list4.size();i++){
						...
						String factoryid=(String)CommonString.getFormatPara(m.get("factoryid"));
					%>
                    <dd><a href="index.jsp?factory=<%=factoryid%>&catalog=113001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><%=factoryname%></a></dd><%}%>
                </dl>
            </li>
            <li class="l7"><a href="index.jsp?catalog=other<%=agent_area.equals("")?"":"&agent_area="+agent_area%>"><i class="ico ic7"></i>其他设备<em>Other</em></a>
            <dl class="menu">
...
setTimeout(function(){ showNext(n, c); }, o.timeout);
 	...
 	<div class="h_right">
        ...
        <div class="opt mt10">
        	<a href="?orderby=normal<%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(orderby.equals("normal")||orderby.equals("")){%>class="active"<%}%>>默认</a>
            <!--<a href="?orderby=sell<%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(orderby.equals("sell")){%>class="active"<%}%>>销量</a>-->
            <a href="?orderby=price<%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(orderby.equals("price")){%>class="active"<%}%>>价格</a>
            <a href="?orderby=date<%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(orderby.equals("date")){%>class="active"<%}%>>最新</a>
		...
		<div class="order">
        	<div class="l"><span style="width:60px">合作伙伴：</span>
              <div class="label">
                  <a href="index.jsp<%=agent_area.equals("")?"":"?agent_area="+agent_area%><%=catalog.equals("")?"":"&catalog="+catalog%>" <%if(factory.equals("")){%>class="cur"<%}%> >全部</a>
				  <%
					 List<Map> list6 = dbHelper.getMapList(" select factoryname,factoryid  from pro_ymt_activity where is_show=1  and factoryname!='' and (agent_area like '%"+agent_area+"%' or  agent_area like '%全国%' ) group by factoryname,factoryid ",connection) ;
					for(int i = 0;list6 != null && i < list6.size();i++){
						Map m = list6.get(i);
						String factoryname=(String)CommonString.getFormatPara(m.get("factoryname"));
						String factoryid=(String)CommonString.getFormatPara(m.get("factoryid"));
					%>
                  <a href="index.jsp?factory=<%=factoryid%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(factory.equals(factoryid)){%>class="cur"<%}%>><%=factoryname%></a>
                 <%}%>
              </div>
              <div class="pbtn"></div> 
            </div>
            <div class="l"><span style="width:60px">按类型：</span>
             <div class="label">
            <a href="index.jsp<%=agent_area.equals("")?"":"?agent_area="+agent_area%><%=factory.equals("")?"":"?factory="+factory%>" class="cur">全部</a>
            <a href="index.jsp?catalog=101001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>" >挖掘机</a>
            <a href="index.jsp?catalog=101002<%=agent_area.equals("")?"":"&agent_area="+agent_area%>" >装载机</a>
            <a href="index.jsp?catalog=106001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>" >压路机</a>
			<a href="index.jsp?catalog=103<%=agent_area.equals("")?"":"&agent_area="+agent_area%>" >混凝土</a>
            <a href="index.jsp?catalog=113001<%=agent_area.equals("")?"":"&agent_area="+agent_area%>" >破碎锤</a>
		...
		<%}else{%>
		<div class="opt mt10">
        	<a href="?orderby=normal<%=catalog.equals("")?"":"&catalog="+catalog%><%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(orderby.equals("normal")||orderby.equals("")){%>class="active"<%}%>>默认</a>
          <!--  <a href="?orderby=sell<%=catalog.equals("")?"":"&catalog="+catalog%><%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(orderby.equals("sell")){%>class="active"<%}%>>销量</a>-->
            <a href="?orderby=price<%=catalog.equals("")?"":"&catalog="+catalog%><%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(orderby.equals("price")){%>class="active"<%}%>>价格</a>
            <a href="?orderby=date<%=catalog.equals("")?"":"&catalog="+catalog%><%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(orderby.equals("date")){%>class="active"<%}%>>最新</a>
		...
		<%if(!catalog.equals("")){%>
		  <div class="order">
        	<div class="l"><span style="width:60px">合作伙伴：</span>
            <div class="label">
                <a href="index.jsp<%=catalog.equals("")?"":"?catalog="+catalog%>" <%if(factory.equals("")){%>class="cur"<%}%> >不限</a>
				<%
					 List<Map> listAll = dbHelper.getMapList(" select factoryname,factoryid ,pro_catanum from pro_ymt_activity where is_show=1  and pro_catanum  like '"+catalog+"%' and (agent_area like '%"+agent_area+"%' or  agent_area like '%全国%' )  group by factoryname,factoryid,pro_catanum ",connection) ;
					...
					%>
                <a href="index.jsp?factory=<%=factoryid%>&catalog=<%=catalogs%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(factory.equals(factoryid)){%>class="cur"<%}%> ><%=factoryname%></a>
				 <%}%>
            </div>
			 <div class="pbtn"></div> 
            </div>
			<%if(catalog_first.equals("101001")){%>
            <div class="l" style="display:none"><span style="width:60px">按类型：</span>
             <div class="label">
            <a href="index.jsp?catalog=101001<%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(tonandmeter.equals("")){%>class="cur"<%}%>>不限</a>
            <a href="index.jsp?catalog=101001&ton=big<%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(tonandmeter.equals("big")){%>class="cur"<%}%>>大挖</a>
            <a href="index.jsp?catalog=101001&ton=mid<%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(tonandmeter.equals("mid")){%>class="cur"<%}%>>中挖</a>
            <a href="index.jsp?catalog=101001&ton=small<%=factory.equals("")?"":"&factory="+factory%><%=agent_area.equals("")?"":"&agent_area="+agent_area%>" <%if(tonandmeter.equals("small")){%>class="cur"<%}%>>小挖</a>
            </div>
            </div><%}%>
        </div>
