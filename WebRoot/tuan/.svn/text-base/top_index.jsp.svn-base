...
<%
	 ...
	 if(!agent_palce.equals("")){province=agent_palce;}
	   
%>

<div class="top clearfix">
  <div class="wrap">
	<div class="logo"><a href="http://product.21-sun.com/" target="_blank"><img src='/tuan/images/logo.gif'/></a></div>
    <div class="img mr30"> <a href="/tuan/" target="_blank"><img src='/tuan/images/ymt.gif'/></a></div>
    <div class="city">
    	<span id="allAplace">
		<%if(!province.equals("")){%>
		<%=province%>
