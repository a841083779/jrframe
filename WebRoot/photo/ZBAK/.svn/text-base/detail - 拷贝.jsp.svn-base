...
<div class="contain980"> 
  ...
  <div class="photoShow">
    <style type="text/css">
	  ...
	  .photoShow .pdbigImg_new { width:705px; height:530px; margin-left:18px; _display:inline; padding:3px; margin-top:20px; float:left; border:#C9C9C9 1px solid; background-color:#fff;}
	  </style>
    <div class="photoLeft">
          ...
          <div class="ad-nav">
            <div class="ad-thumbs">
              <ul class="ad-thumb-list">
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121205110001_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121205110001_0.jpg" class="image0"	title="山东山工机械有限公司新品发布" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121204103624_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121204103624_0.jpg" class="image1"	title="21-sun团队走进宝马展：意气风发 朝气蓬勃" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121130053810_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121130053810_0.jpg" class="image2"	title="2012上海宝马展花絮之梦想起航" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121130053735_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121130053735_0.jpg" class="image3"	title="2012上海宝马展花絮之谁在偷看别人的梦想" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121130053612_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121130053612_0.jpg" class="image4"	title="2012上海宝马展花絮之十周年梦想之旅嘉年华" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121130053512_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121130053512_0.jpg" class="image5"	title="2012上海宝马展花絮之许下我的心愿" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121129232531_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121129232531_0.jpg" class="image6"	title="中联重科室内宣传厅" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121129232410_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121129232410_0.jpg" class="image7"	title="蓝天白云下的工程机械产品" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121129232327_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121129232327_0.jpg" class="image8"	title="蓝天白云下的工程机械产品" /> </a> </li>
                <li> <a href="http://news.21-sun.com/UserFiles/Image/20121129232244_0.jpg"> <img src="http://news.21-sun.com/UserFiles/x_Image/x_20121129232244_0.jpg" class="image9"	title="2012上海宝马展花絮之这里是中联重科的天空" /> </a> </li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <%
               if(null !=sub_pics && sub_pics.size()>0){
            	   for(Map onesubMap:sub_pics){
            		   %>
            <li><a href="<%=CommonString.getFormatPara(onesubMap.get("img_name")) %>" title="<%=CommonString.getFormatPara(main_pics.get("factoryname"))%><%=CommonString.getFormatPara(main_pics.get("name")) %><%=CommonString.getFormatPara(main_pics.get("catalogname")) %><%=CommonString.getFormatPara(onesubMap.get("name")) %>" rel="/proDetail/<%=CommonString.getFormatPara(main_pics.get("file_name")) %>"> <img src="<%=(CommonString.getFormatPara(onesubMap.get("img_name")).length()>15&& CommonString.getFormatPara(onesubMap.get("img_name")).lastIndexOf("/")>0)?CommonString.getFormatPara(onesubMap.get("img_name")).substring(0,CommonString.getFormatPara(onesubMap.get("img_name")).lastIndexOf("/"))+"/small"+CommonString.getFormatPara(onesubMap.get("img_name")).substring(CommonString.getFormatPara(onesubMap.get("img_name")).lastIndexOf("/")):CommonString.getFormatPara(onesubMap.get("img_name")) %>" width="124" height="91"  onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);" /> </a></li>
            <%
            	   }
               }
              %>
        ...
        <%
          if(null != relate_pics && relate_pics.size()>0){
        	  for(Map oneMap:relate_pics){
        		  %>
        <li>
          <div><a href="detail_for_<%=CommonString.getFormatPara(oneMap.get("id")) %>.htm"> <img src="/uploadfiles/<%=CommonString.getFormatPara(oneMap.get("img2")) %>" alt="<%=CommonString.getFormatPara(oneMap.get("factoryname")) %><%=CommonString.getFormatPara(oneMap.get("name")) %><%=CommonString.getFormatPara(oneMap.get("catalogname")) %>图片" width="120" height="90" title="<%=CommonString.getFormatPara(oneMap.get("factoryname")) %><%=CommonString.getFormatPara(oneMap.get("name")) %><%=CommonString.getFormatPara(oneMap.get("catalogname")) %>" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"/></a></div>
