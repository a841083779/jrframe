...
<div class="contain980 mb10"> 
  ...
  <!--right-->
  <div class="w757 r">
    <form name="theform" id="theform" action="/photo/list.jsp">
	  ...
	  jQuery(document).ready(function() {
          ...
          <li class="cblist">
            ...
            <dd>
              ...
              <div id="changethis" class="pbtn"></div>
              <div class="plmore" style="padding-left: 0px; width: 100%;">
                <iframe id="brand_iframe" src="/include/products/brand.jsp?catalog='<%=catalog%>'&factory_id='<%=factoryid%>'&tonandmeter='<%=tonandmeter%>'&order='<%=order%>'&flag=photo" frameborder="0" scrolling="no" width="100%" height="1220" allowtransparency="true"></iframe>
              </div>
            </dd>
          </li>
    ...
    <div class="photoParts mb20">
      ...
      <div class="content">
        <ul class="pbList">
          <li><a href="/photo/list.jsp?factory=133" title="三一" style="cursor:pointer"><img src="../images/sany.jpg" alt="三一" width="100" height="50" />三一</a></li>
          <li><a href="/photo/list.jsp?factory=209" title="徐工" style="cursor:pointer"><img src="../images/xcmg.jpg" alt="徐工" width="100" height="50" />徐工</a></li>
          <li><a href="/photo/list.jsp?factory=134" title="中联" style="cursor:pointer"><img src="../images/photo_brandimg04.gif" alt="中联" width="100" height="50" />中联</a></li>
          <li><a href="/photo/list.jsp?factory=136" title="柳工" style="cursor:pointer"><img src="../images/photo_brand_lg.gif" alt="柳工" width="100" height="50" />柳工</a></li>
          <li><a href="/photo/list.jsp?factory=144" title="山推" style="cursor:pointer"><img src="../images/photo_brand_st.gif" alt="山推" width="100" height="50" />山推</a></li>
          <li><a href="/photo/list.jsp?factory=137" title="临工" style="cursor:pointer"><img src="../images/photo_brand_lingong.gif" alt="临工" width="100" height="50" />临工</a></li>
        </ul>
      </div>
    </div>
    <div class="photoParts">
      ...
      <div class="content">
		...
		%>
            <div class="mt">
              <h3>挖掘机</h3>
              <span class="more"><a target="_blank" href="/photo/list.jsp?catalog=101001">更多&gt;&gt;</a></span> </div>
            <ul class="list12">
              <%
				Map m = null;
			...
			%>
              <li>
                ...
                <span class="blink"> 【<a href="http://product.21-sun.com/proDetail/<%=CommonString.getFormatPara(m.get("file_name"))%>" target="_blank">参数</a>】【<a href="http://product.21-sun.com/proDetail/<%=CommonString.getFormatPara(m.get("file_name")).substring(0,CommonString.getFormatPara(m.get("file_name")).indexOf("."))%>_message.shtm" target="_blank">评论</a>】【<a href="javascript:;" onclick="showinquery('<%=CommonString.getFormatPara(m.get("id"))%>','')"><font color="#ff6000">询价</font></a>】 </span> </li>
              <%
			  		m = null;
				}
				list1 = null;
		...
		%>
            <div class="mt">
              <h3>装载机</h3>
              <span class="more"><a target="_blank" href="/photo/list.jsp?catalog=101002">更多&gt;&gt;</a></span> </div>
            <ul class="list12">
              <%
				for(int i = 0;list1 != null && i < list1.size();i++){
					m = list1.get(i);
		...
		%>
            <div class="mt">
              <h3>起重机</h3>
              <span class="more"><a target="_blank" href="/photo/list.jsp?catalog=102">更多&gt;&gt;</a></span> </div>
            <ul class="list12">
              <%
				for(int i = 0;list1 != null && i < list1.size();i++){
					m = list1.get(i);
		...
		%>
            <div class="mt">
              <h3>推土机</h3>
              <span class="more"><a target="_blank" href="/photo/list.jsp?catalog=101003">更多&gt;&gt;</a></span> </div>
            <ul class="list12">
              <%
				for(int i = 0;list1 != null && i < list1.size();i++){
					m = list1.get(i);
		...
		%>
            <div class="mt">
              <h3>混凝土</h3>
              <span class="more"><a target="_blank" href="/photo/list.jsp?catalog=103">更多&gt;&gt;</a></span> </div>
            <ul class="list12">
              <%
				for(int i = 0;list1 != null && i < list1.size();i++){
					m = list1.get(i);
		...
		%>
            <div class="mt">
              <h3>压路机</h3>
              <span class="more"><a target="_blank" href="/photo/list.jsp?catalog=106001">更多&gt;&gt;</a></span> </div>
            <ul class="list12">
              <%
				for(int i = 0;list1 != null && i < list1.size();i++){
					m = list1.get(i);
