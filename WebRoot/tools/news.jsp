...
<%
    ...
    String strIds="";
 	try{
		 ...
		 List <Map> list = WEBDBHelper.getMapList("  select top 60   id from news where id=188309 ","Web21NewsDBHelper");
		 for(Map qiuMap : list){
			 out.println("id:"+CommonString.getFormatPara(qiuMap.get("id")));
	     one_proform = WEBDBHelper.getMap("  select  * from news where id=" + CommonString.getFormatPara(qiuMap.get("id")) + "","Web21NewsDBHelper");
		...
		PostMethod postMethod = new UTF8PostMethod("http://192.168.40.97:8600/m/3/content/doPublishs.do"); 
