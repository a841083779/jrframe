...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	...
	try{
		...
		Map root1 = new HashMap();
			...
			//本条产品信息
			list = dbHelper.getMapList("  select top  1000 * from pro_products where is_show=1 and file_name!='' and file_name is not null and id not in( select   top 3000 id from pro_products where is_show=1 and file_name!='' and file_name is not null order by id  asc)    order by id  asc  ");
