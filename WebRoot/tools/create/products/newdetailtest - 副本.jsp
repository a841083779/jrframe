...
<%
	...
	try{
		...
		Map root1 = new HashMap();
			...
			//本条产品信息
			list = dbHelper.getMapList(" select  id,factoryid,factoryname,catalognum,catalogname,img1,img2,introduce,file_name,view_count,param,catalognum_new,instruments,is_show,tonandmeter,name  from pro_products where  is_show=1 and  (catalognum like '%103%') and id <>7018 order by view_count  desc  ");
			...
			FreemarkerUtils freemarkerUtils = new FreemarkerUtils(absPath+"/template/");
				...
				String  createName1 = absPath+"proDetail_new/"+fileName;
				...
				String createName2 = absPath+"proDetail_new/"+fileName2;			
				...
				String createName3 = absPath+"proDetail_new/"+fileName3;			
				...
				String createName4 = absPath+"proDetail_new/"+fileName4;			
				...
				String createName5 = absPath+"proDetail_new/"+fileName5;			
				...
				String createName6 = absPath+"proDetail_new/"+fileName6;			
				...
				String createName7 = absPath+"proDetail_new/"+fileName7;			
				...
				String createName8 = absPath+"proDetail_new/"+fileName8;			
				...
				String createName9 = absPath+"proDetail_new/"+fileName9;			
				...
				String createName10 = absPath+"proDetail_new/"+fileName10;			
				...
				String createName11 = absPath+"proDetail_new/"+fileName11;			
				...
				String createName12 = absPath+"proDetail_new/"+fileName12;			
