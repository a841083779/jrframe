...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	...
	try{
		...
		Map root1 = new HashMap();
			...
			//本条产品信息
			list = dbHelper.getMapList("  select   * from pro_products where is_show=1 and file_name!='' and id not in( select   top 15000 id from pro_products where is_show=1 and file_name!='' order by id  asc)    order by id  asc  ");
