...
<%
	...
	try{
		...
		Map root1 = new HashMap();
			...
			//本条产品信息
			list = dbHelper.getMapList(" select  id,factoryid,factoryname,catalognum,catalogname,img1,img2,introduce,file_name,view_count,param,catalognum_new,instruments,is_show,tonandmeter,name  from pro_products where  is_show=1 and  (catalognum like '%109%' )  order by view_count  desc  ");
			...
			FreemarkerUtils freemarkerUtils = new FreemarkerUtils(absPath+"/template/");
				...
				String  createName1 = absPath+"proDetail_new1/"+fileName;
				...
				String createName2 = absPath+"proDetail_new1/"+fileName2;			
				...
				String createName3 = absPath+"proDetail_new1/"+fileName3;			
				...
				String createName4 = absPath+"proDetail_new1/"+fileName4;			
				...
				String createName5 = absPath+"proDetail_new1/"+fileName5;			
				...
				String createName6 = absPath+"proDetail_new1/"+fileName6;			
				...
				String createName7 = absPath+"proDetail_new1/"+fileName7;			
				...
				String createName8 = absPath+"proDetail_new1/"+fileName8;			
				...
				String createName9 = absPath+"proDetail_new1/"+fileName9;			
				...
				String createName10 = absPath+"proDetail_new1/"+fileName10;			
				...
				String createName11 = absPath+"proDetail_new1/"+fileName11;			
				...
				String createName12 = absPath+"proDetail_new1/"+fileName12;			
				root.put("cName12","/proDetail/"+fileName12);			
				root.put("pageFlag",pageFlag1);
				freemarkerUtils.generate("/proDetail_temp2/detail_zongshu.shtm", root, createName1 ,request);
							
				//root.put("pageFlag",pageFlag2);
				//freemarkerUtils.generate("/proDetail_temp2/detail_xingneng.shtm", root, createName2 ,request);
				
				root.put("pageFlag",pageFlag3);
				freemarkerUtils.generate("/proDetail_temp2/detail_pic.shtm", root, createName3 ,request);
				
				root.put("pageFlag",pageFlag4);
				freemarkerUtils.generate("/proDetail_temp2/detail_dailishang.shtm", root, createName4 ,request);
				
				root.put("pageFlag",pageFlag5);
				freemarkerUtils.generate("/proDetail_temp2/detail_koubei.shtm", root, createName5 ,request);
				
				//root.put("pageFlag",pageFlag7);
				//freemarkerUtils.generate("/proDetail_temp2/detail_canshu.shtm", root, createName7 ,request);
