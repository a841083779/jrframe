   ...
   String event = CommonString.getFormatPara(request.getParameter("eventAfter"));
	...
	try{
		connection = dbHelper.getConnection();
			...
			String tonand="";
			//本条产品信息
			model = dbHelper.getMap(" select *  from pro_products where id = ? ",new Object [] {id},connection);
		...
		List <Map>list2 = null;
			...
			List<Map> proList=dbHelper.getMapList(" select * from pro_products where 1=1 and id!="+CommonString.getFormatPara(model.get("id"))+" and  factoryid="+CommonString.getFormatPara(model.get("factoryid"))+"  and catalognum like '%"+CommonString.getFormatPara(model.get("catalognum"))+"%' order by view_count desc");  
            if(proList==null){
				proList= new ArrayList<Map>();
			}
			List<Map> topList=dbHelper.getMapList(" select top 6 * from pro_products where 1=1 and id!="+CommonString.getFormatPara(model.get("id"))+" and     catalognum like '%"+CommonString.getFormatPara(model.get("catalognum"))+"%' order by view_count desc");  
            if(topList==null){
			...
			List<Map> proSameList=dbHelper.getMapList(" select top 6  * from pro_products where 1=1 "+tonStr+" and id!="+CommonString.getFormatPara(model.get("id"))+" and  factoryid!="+CommonString.getFormatPara(model.get("factoryid"))+"  and catalognum like '%"+CommonString.getFormatPara(model.get("catalognum"))+"%'  "+otherStr+" order by newid() desc");  
            ...
            if(proSameList==null||(proSameList!=null&&proSameList.size()<3)){
				proSameList=dbHelper.getMapList(" select top 6  * from pro_products where 1=1 "+tonStr+" and id!="+CommonString.getFormatPara(model.get("id"))+" and  factoryid!="+CommonString.getFormatPara(model.get("factoryid"))+"  and catalognum like '%"+CommonString.getFormatPara(model.get("catalognum"))+"%'  order by newid() desc");  
			}
		    if(proSameList==null||(proSameList!=null&&proSameList.size()<3)){
				proSameList=dbHelper.getMapList(" select top 6  * from pro_products where 1=1  and id!="+CommonString.getFormatPara(model.get("id"))+" and  factoryid!="+CommonString.getFormatPara(model.get("factoryid"))+"  and catalognum like '%"+CommonString.getFormatPara(model.get("catalognum"))+"%'  order by newid() desc");  
			}
			if(proSameList==null||(proSameList!=null&&proSameList.size()<3)){
				proSameList=dbHelper.getMapList(" select top 6  * from pro_products where 1=1  and id!="+CommonString.getFormatPara(model.get("id"))+"  and catalognum like '%"+CommonString.getFormatPara(model.get("catalognum"))+"%'  order by newid() desc");  
			}
		   if(proSameList==null){
