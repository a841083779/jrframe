    ...
    <td style="vertical-align:top; border-bottom:#e5e5e5 1px solid; border-left:#e5e5e5 1px solid; border-right:#e5e5e5 1px solid; padding:20px; line-height:180%;">
        ...
        <table width="610" border="0" cellspacing="0" cellpadding="0" style="font-size:12px; text-align:left;">
          <tr>
            ...
            <td style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#ffffff; color:#969696; padding:8px 0px;" width="80%"><%=CommonString.getFormatPara(oneOrderInfo.get("name")) %></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="right" style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#ffffff; padding:8px 20px 8px 0px;">产品类别：</td>
            <td style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#ffffff; color:#969696; padding:8px 0px;"><%=CommonString.getFormatPara(oneOrderInfo.get("cataname")).equals("")?"&nbsp;":CommonString.getFormatPara(oneOrderInfo.get("cataname")) %></td>
          </tr>
          <tr>
            ...
            <td style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#f3f3f3; color:#969696; padding:8px 0px;"><%=CommonString.getFormatPara(oneOrderInfo.get("factoryname")).equals("")?"&nbsp;":CommonString.getFormatPara(oneOrderInfo.get("factoryname")) %></td>
          </tr>
          <tr>
            ...
            <td style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#ffffff; color:#969696; padding:8px 0px;"><%=CommonString.getFormatPara(oneOrderInfo.get("agentname")).equals("")?"&nbsp;":CommonString.getFormatPara(oneOrderInfo.get("agentname")) %></td>
          </tr>
          <tr>
            ...
            <td style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#f3f3f3; color:#969696; padding:8px 0px;"><%=CommonString.getFormatPara(oneOrderInfo.get("mobile_phone")).equals("")?"&nbsp;":CommonString.getFormatPara(oneOrderInfo.get("mobile_phone")) %></td>
          </tr>
          <tr>
            <td align="right" style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#ffffff; padding:8px 20px 8px 0px;">固定电话：</td>
            <td style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#ffffff; color:#969696; padding:8px 0px;"><%=CommonString.getFormatPara(oneOrderInfo.get("contact_tel")).equals("")?"&nbsp;":CommonString.getFormatPara(oneOrderInfo.get("contact_tel")) %></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="border-bottom:#b8b8b8 1px dotted; line-height:12px; background-color:#ffffff; color:#969696; padding:8px 0px;"><%=CommonString.getFormatPara(oneOrderInfo.get("company")).equals("公司名字")?"个人":CommonString.getFormatPara(oneOrderInfo.get("company")) %></td>
          </tr>
          <tr>
