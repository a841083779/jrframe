	...
	String logo="";
 	try{
		...
		sql="select logo from web_columns where web_no='"+web_no+"' and language_version='"+language_version+"' and catalog_no='index00'";
	     ...
	     if(isB!=null){
			logo=CommonString.getFormatPara(isB.get("logo"));
		}else{
			logo="";
		}
%>
<script type="text/javascript" src="scripts/js.js"></script>
<table border="0" cellpadding="0" cellspacing="0" width="950" height="91" align="center" style="background:url(images/topbj.jpg) no-repeat 0 0;">
  <tr>
    <td style="padding:0 0 0 20px;"><a href="<%=web_site %>" title="<%=web_name %>"><img border="0" src="<%=logo%>" alt="<%=web_name %>"/></a></td>
    <td width="715"  >
...
<table border="0" cellpadding="0" cellspacing="0" width="950" height="35" align="center" class="menu">
  <tr>
    <td width="49"></td>
    <td width="142" align="center"><a href="../">首页</a></td>
    <td width="142" align="center"><a href="../about/">公司简介</a></td>
    <td width="142" align="center"><a href="../products/">产品展示</a></td>
    <td width="142" align="center"><a  href="../parts/">配件仓库</a></td>
    <td width="142" align="center"><a  href="../order/">在线订购</a></td>
    <td width="143" align="center"><a  href="../contact/">联系我们</a></td>
    <td width="48"></td>
  </tr>
</table>
<%
	...
	finally{DBHelper.freeConnection(connection);}	
%>
