...
<%
	...
	short channelFlag=1;
	sql="select catalog_name,channel_img,channel_flag,channel_flash,keywords,description,title from web_columns where web_no='"+web_no+"' and language_version='"+language_version+"' and catalog_no='aboutus00'";
...
<table border="0" cellpadding="0" cellspacing="0" width="950" height="436" align="center" class="bodbox">
  <tr>
    <td width="251" align="left" valign="top" style="padding:10px 0 0 10px;">
     <jsp:include page="../include/left1.jsp" flush="true"/>
      <jsp:include page="../include/lxwm1.jsp" flush="true"/>
      </td>
      
  <td width="697" valign="top" style="padding:10px 0 0 0;"><table border="0" cellpadding="0" cellspacing="0" width="700">
            <tr>
              <td>
              <%if(channelFlag==2){ %>
	...
	<%} %>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="690" class="mtb20">
            <tr>
              <td>
              <%
			  	sql="select catalog_name,content,image from web_infomation where web_no='"+web_no+"' and language_version='"+language_version+"' and catalog_no='aboutus00'";
				Map model = dbHelper.getMap(sql);
				if(model!=null){
			  %><%=CommonString.getFormatPara(model.get("content"))%><%} %>
			  </td>
            </tr>
    </table></td>
      </tr>
