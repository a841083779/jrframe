...
Connection connection = null;
	...
	short channelFlag=1;
	sql="select catalog_name,channel_img,channel_flag,channel_flash,keywords,description,title from web_columns where web_no='"+web_no+"' and language_version='"+language_version+"' and catalog_no='contactus00'";
...
<table border="0" cellpadding="0" cellspacing="0" width="950" height="436" align="center" class="bodbox">
  <tr>
    <td width="260" valign="top" style=" padding:10px 0 0 10px;"><jsp:include page="../include/left1.jsp" flush="true"/>    
    </td>
      
      <td width="690" valign="top" style="padding:10px 0 0 0;"><table border="0" cellpadding="0" cellspacing="0" width="645">
            <tr>
              <td>
				 <%if(channelFlag==2){ %>
		        <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" name="main" width="690" height="200" align="middle" id="main">
		          ...
		          <param name="movie" value="<%=channelFlash%>" />
...
<%}else{ %>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="690" class="mtb20">
            <tr>
              <td class="ziti03">
			<%
			  	sql="select catalog_name,content,image from web_infomation where web_no='"+web_no+"' and language_version='"+language_version+"' and catalog_no='contactus00'";
				Map mm=dbHelper.getMap(sql);
				while(mm!=null){
			  %><%=CommonString.getFormatPara(mm.get("content"))%><%} %>
			</td>
            </tr>
    </table></td>
      </tr>
