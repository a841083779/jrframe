<%@ page language="java" import="java.util.*,com.jerehnet.util.common.*,com.jerehnet.util.dbutil.*,java.sql.*" pageEncoding="UTF-8"%><%
	...
	try{
		...
		String title = "联系我们_"+CommonString.getFormatPara(map.get("full_name"))+"-中国工程机械商贸网" ;
		String keyword = "联系我们,"+CommonString.getFormatPara(map.get("full_name"))+",工程机械" ;
		String description = "中国工程机械商贸网提供"+CommonString.getFormatPara(map.get("full_name"))+"联系我们栏目，让您对"+CommonString.getFormatPara(map.get("full_name"))+"更加了解，欢迎光临"+CommonString.getFormatPara(map.get("full_name"))+"品牌旗舰店。"; 
		// 自定义 seo
		...
		if(!"".equals(CommonString.getFormatPara(map.get("seo_keyword")))){
			keyword = CommonString.getFormatPara(map.get("seo_keyword")) ;
		}
  ...
  <div class="w100 l shopLeftbg"> 
    ...
    <div class="shopRight"> 
      ...
      <div class="sRightPart">
        <div class="sTitle">
          <h2>联系我们</h2> </div>
        <div class="sContent companyInfo" style=" margin-left:10px">
           ...
           %>
            <%=CommonString.getFormatPara(map.get("fax")).equals("")?"":"传真："+CommonString.getFormatPara(map.get("fax"))+"<br /><br />"%>
             <%=CommonString.getFormatPara(map.get("saleqq")).equals("")?"":"销售QQ："+CommonString.getFormatPara(map.get("saleqq"))+"<br /><br />"%>
          <%=CommonString.getFormatPara(map.get("serviceqq")).equals("")?"":"服务QQ："+CommonString.getFormatPara(map.get("serviceqq"))+"<br /><br />"%>
               <!--   邮政编码：<%=CommonString.getFormatPara(map.get("postcode"))%><br />  -->
