...
<title>江苏华通官方旗舰店_中国工程机械商贸网21-sun.com</title>
  ...
  <div class="contain980 pt20 clearfix">
    <div class="shopContain">
      ...
      <div class="shopRightPart">
        ...
        <div class="l" style="width:720px; padding:10px 0px;">
        ...
        <div class="w755 border03 l mb10 list08">
          <div class="title12">
       <%
       	String order_sql = "select factoryid,id,factoryname,product_name,contact_address,cataname,name,mobile_phone,province,city,add_date from pro_product_form where factoryid=1220 and product_name is not null and product_name != '' " ;
