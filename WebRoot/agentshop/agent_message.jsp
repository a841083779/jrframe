<%@ page language="java" import="java.util.*,com.jerehnet.util.common.*,com.jerehnet.util.dbutil.*,java.sql.*" pageEncoding="UTF-8"%><%@page import="com.jerehnet.util.dbutil.PageBean"%><%@ taglib tagdir="/WEB-INF/tags" prefix="tags" %><%
	...
	try{
		...
		String title = "在线询价_"+CommonString.getFormatPara(map.get("full_name"))+"-中国工程机械商贸网";
		String keywords = "在线询价,"+CommonString.getFormatPara(map.get("full_name"))+",工程机械" ;
		String description = "中国工程机械商贸网提供"+ CommonString.getFormatPara(map.get("full_name"))+"在线询价栏目，让您对"+CommonString.getFormatPara(map.get("full_name"))+"更加了解，欢迎光临"+CommonString.getFormatPara(map.get("full_name"))+"品牌旗舰店。";
		// 自定义 seo
        ...
        jQuery(function(){
          ...
          <form action="/action/order_save.jsp" method="post" name="theform" id="theform" onsubmit="return submitYN(this);">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="inquiry">
              ...
              <tr>
                <th>地区：</th>
                <td><select name="zd_province" id="zd_province" onChange="set_my_city(this);" style="width:79px;"  dataType="Require"  msg="请选择省份">
                    <%
            ...
            <tr>
              ...
              <td  width="87%">
              <input name="zd_ifgroup" type="radio" checked value="个人" />
