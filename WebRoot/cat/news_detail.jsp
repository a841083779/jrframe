...
<% 
	...
	if(newsId!=null && !newsId.equals("")){
		...
		newsMap =WEBDBHelper.getMap("select  title,content,add_date from article  where id="+newsId,"Web21NewsDBHelper");
		contentMap =WEBDBHelper.getMap("select  content from News_content  where groud_id="+newsId,"Web21NewsDBHelper");
		if(newsMap == null){
		...
		if(contentMap!=null){
			mainContent= CommonString.getFormatPara(contentMap.get("content"));
		}
	}else{
