...
<div class="contain980 n_pp_promain">
	<div class="npp_protitle"><span>三一集团动态</span></div>
    <div class="npp_prolist">
    	<div class="npp_pl_top">
        	<ul class="np_fix">
            	<li><a href="#">三一混凝土搅拌站</a></li>
                <li><a href="#">三一混凝土搅拌站</a></li>
                <li><a href="#">三一混凝土搅拌站</a></li>
                <li><a href="#">三一混凝土搅拌站</a></li>
                <li><a href="#">三一混凝土搅拌站</a></li>
        ...
        <div class="np_fix npp_chan_t">
            	<div class="l npp_chan_t_left">三一集团图片动态</div>
                <div class="r npp_chan_t_right">更多 &gt;&gt;</div>
         </div>
        <div class="npp_video_list">
        	<ul class="np_fix">
            	<li>
                	<a href="#">
                    	<p class="pp_videoimg"><img src="../images/new_pro/temp02_03.jpg" alt=""/></p>
                        <p class="pp_videoname">上海三一重机副总经理向儒安上海三一重机副总经理向儒安</p>
                    </a>
                </li>
                <li>
                	<a href="#">
                    	<p class="pp_videoimg"><img src="../images/new_pro/temp02_03.jpg" alt=""/></p>
                        <p class="pp_videoname">上海三一重机副总经理向儒安</p>
                    </a>
                </li>
                <li>
                	<a href="#">
        ...
        <div class="np_fix npp_chan_t">
            	<div class="l npp_chan_t_left">三一集团动态</div>
                <div class="r npp_chan_t_right">更多 &gt;&gt;</div>
         </div>
         <div class=" npp_newslist">
         	<ul class="np_fix">
            	<li><a href="#">&bull;&nbsp;&nbsp;新疆自治区经信委考察组调研山推喀什产业园</a><span>2014-02-10</span></li>
                <li><a href="#">&bull;&nbsp;&nbsp;新疆自治区经信委考察组调研山推喀什产业园</a><span>2014-02-10</span></li>
                <li><a href="#">&bull;&nbsp;&nbsp;新疆自治区经信委考察组调研山推喀什产业园</a><span>2014-02-10</span></li>
                <li><a href="#">&bull;&nbsp;&nbsp;新疆自治区经信委考察组调研山推喀什产业园</a><span>2014-02-10</span></li>
                <li><a href="#">&bull;&nbsp;&nbsp;新疆自治区经信委考察组调研山推喀什产业园</a><span>2014-02-10</span></li>
