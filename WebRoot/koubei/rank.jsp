...
<style>
.brand_right_box_left p{width:414px;}
.newRank .rcl{width:451px;margin-left:20px}
.brand_right_box_left .brand_02{width:260px}
.brand_right_box_left .brand_03{width:115px}
</style>
</head>
<body>
<!--top-->
...
<div class="contain1190 fix mb10 np_fix">
  <!--left-->
  <div class="w210 l">
    <div id="leftId">
      <div class="leftTab">
