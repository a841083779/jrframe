...
<meta name="keywords" content="<%=CommonString.getFormatPara(brandMap.get(factory)).replace("卡特彼勒","卡特")+showName %>怎么样,<%=CommonString.getFormatPara(brandMap.get(factory)).replace("卡特彼勒","卡特")+showName %>,<%=CommonString.getFormatPara(brandMap.get(factory)).replace("卡特彼勒","卡特")+showName %>口碑,<%=CommonString.getFormatPara(brandMap.get(factory)).replace("卡特彼勒","卡特")+showName %>好不好" />
