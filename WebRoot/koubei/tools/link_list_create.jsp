...
<%
	...
	try {
		...
		String fileOutPutSteam ="<div align='center'>铁臂口碑要求发布的评论确系本人原创，严禁剽窃、转投他人评论，若因此引起任何法律纠纷，与铁臂口碑无关。</div>";

		 fileOutPutSteam += "<link href=\"/style/friendly_link.css\" rel=\"stylesheet\" type=\"text/css\" />"
				+ "\n"
		...
		string2File(fileOutPutSteam, base + "/include/index/" + "friendlink_koubei.htm");
		i = 1;
	} catch (Exception e) {
		e.printStackTrace();
		i = -1;
