...
<%	
   ...
   String introduce=CommonHtml.filterHTML(CommonString.getFormatPara(map.get("introduce"))).replace("　","");
   if(introduce.length()>100){introduce=introduce.substring(0,100)+"...";}
%>
<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><%=CommonString.getFormatPara(map.get("full_name"))%>企业介绍 – 铁臂商城代理商平台</title>
<meta name="keywords" content="<%=CommonString.getFormatPara(map.get("full_name"))%>,<%=CommonString.getFormatPara(map.get("full_name"))%>企业介绍" />
...
<div class="shop_con">
  ...
  <h3 class="breadCrumbs l"><a href="/">铁臂商城代理商平台</a> &gt;&gt; <%=CommonString.getFormatPara(map.get("full_name"))%> &gt;&gt; 公司介绍</h3>
</div>
  <div class="contain980 fix">
    <!--left-->
    <div class="shopLeft">
    ...
    <div class="shopRight">
      ...
      <div class="comBox04 mb10 companyIntro">
        ...
        <div class="bd fix">
          <a href="/<%=usern%>/introduce.shtm"  title="<%=CommonString.getFormatPara(map.get("full_name"))%>">
