...
<title><%=CommonString.getFormatPara(map.get("full_name"))%>_<%=CommonString.getFormatPara(map.get("city"))%><%=dali_brand%>代理商_<%=dali_brand%>代理商 – 铁臂商城代理商平台</title>
<meta name="keywords" content="<%=CommonString.getFormatPara(map.get("city"))%><%=dali_brand%>代理商,<%=CommonString.getFormatPara(map.get("full_name"))%>" />
...
<div class="contain980 mb10 clearfix">
  <h3 class="breadCrumbs l"><a href="/">铁臂商城代理商平台</a> &gt;&gt; <%=CommonString.getFormatPara(map.get("full_name"))%></h3>
</div>
  ...
  <div class="contain980 fix">
    ...
    <div class="shopRight">
      ...
      <div class="comBox04 mb10">
        <div class="hd fix">
          <h3>推荐产品</h3>
          <span class="more"><a href="/<%=usern%>/agent_products.shtm" title="更多推荐产品">更多&gt;&gt;</a></span>
        </div>
        <div class="bd shopProList">
          <ul class="comList02">
            <jsp:include page="/include/agent_new/agent_products.jsp" flush="true">
               <jsp:param name="agentid" value='<%=CommonString.getFormatPara(map.get("id"))%>'></jsp:param>
               <jsp:param name="usern" value='<%=usern%>'></jsp:param>
			   <jsp:param name="flag" value='top'></jsp:param>
            </jsp:include>
          </ul>
        </div>
      </div>
      ...
      <div class="comBox04 mb10 companyIntro">
        ...
        <div class="bd fix">
          <a title="<%=CommonString.getFormatPara(map.get("full_name"))%>" href="/<%=usern%>/introduce.shtm">
            ...
            <div class="text">　　<%=(CommonHtml.filterHTML(CommonString.getFormatPara(map.get("introduce"))).length()>=220)?CommonHtml.filterHTML(CommonString.getFormatPara(map.get("introduce"))).substring(0,220)+"...":CommonHtml.filterHTML(CommonString.getFormatPara(map.get("introduce")))%>
              <span class="more"><a href="/<%=usern%>/introduce.shtm" title="更多详情">更多详情&gt;&gt;</a></span>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="comBox04 mb10">
        <div class="hd fix">
          <h3>供应产品</h3>
          <span class="more"><a href="/<%=usern%>/agent_products.shtm" title="更多供应产品">更多&gt;&gt;</a></span>
        </div>
        <div class="bd shopProList">
          <ul class="comList02">
            <jsp:include page="/include/agent_new/agent_products.jsp" flush="true">
               <jsp:param name="agentid" value='<%=CommonString.getFormatPara(map.get("id"))%>'></jsp:param>
               <jsp:param name="usern" value='<%=usern%>'></jsp:param>
			   <jsp:param name="flag" value='foot'></jsp:param>
            </jsp:include>
          </ul>
        </div>
      </div>
