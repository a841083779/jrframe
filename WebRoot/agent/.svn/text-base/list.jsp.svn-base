...
<div class="w757 r mb10" style="margin-bottom: 0px;">
  ...
  <div class="agent_part">
   ...
   <div class="ConditionTop" style="display: block;">
       <div class="l" id="conditionTip" style="color:#4f7fd4; width:auto; float:left; line-height:22px; white-space:nowrap;">已设置筛选条件</div>
		<div class="l" id="conditionList" style="width:450px; float:left;">
  ...
  <script type="text/javascript">
	...
	if(jQuery.trim(jQuery("#conditionList").text())==''){
		jQuery("#conditionTip").hide();
	}
		...
		jQuery.ajax({
			...
			success : function(data){
				...
				for(var i=0;i<agentList.length;i++){
					...
					}else if(agentList[i].is_qijiandian==3&&agentList[i].is_made!=1){
					htm += '<li class="g1"><a title="'+agentList[i].full_name+'" href="/agentshop03/'+agentList[i].usern+'/" target="_blank">'+agentList[i].full_name+'</a></li>';
					}else{  //  普通跳转
