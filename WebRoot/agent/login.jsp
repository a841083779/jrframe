...
<title>订单宝-中国工程机械铁臂商城</title>
<meta name="keywords" content="订单宝登录,订单宝注册,订单宝,信息管理,营销推广,订单管理,数据分析" />
<meta name="description" content="欢迎注册登录订单宝，订单宝用户专享特权包括，信息管理、营销推广、订单管理、数据分析" />
...
<!--main-->
<div class="login_banner" style="margin-top:2px">
  ...
  <div class="login">
    ...
    <div class="login-con">
      <div class="btn03"><a href="javascript:void(0);" onclick="joinUs();" title="申请加入订单宝"><img src="../images/login_form_btn01.gif" alt="申请加入订单宝" width="244" height="45" /></a></div>
...
<div class="login_content">
  <div class="contain980">
    ...
    <div class="login_right">
      ...
      <div class="content">
        <span class="w100 l mb10"><a href="http://product.21-sun.com/tuan/ " target="_blank"><img src="../images/ymt.jpg" width="299" height="70"  alt="“优买团”优惠购机  "/></a></span>
         <div class="w100 l mb10"><a href="http://ad.21-sun.com/link_to.jsp?paras=1,0,100016&url=http://product.21-sun.com/tuan/april/ " target="_blank"><img src="../images/ymtgg03.jpg" width="299" height="70" alt="优买团4月工程机械订货季！" /></a></div>
...
function addCookie(){　 // 加入收藏夹
    if (document.all){
        window.external.addFavorite('http://product.21-sun.com', '21-sun铁臂商城');
    }else if (window.sidebar){
        window.sidebar.addPanel('21-sun铁臂商城', 'http://www.product.21-sun.com', "");
    }
}
	...
	jQuery("#loginform").ajaxSubmit({
		...
		success:function(msg){
			...
			if(jQuery.trim(msg)=='1'){
				setTimeout(function(){
					  window.location.href="http://localhost:1007/home/login_action.jsp?usern="+agent_name ;
			...
			if(jQuery.trim(msg)=='5'){
			jQuery(".loginTip").hide() ;
			  setTimeout(function(){
			  	  jQuery("#loginTip_name").html("免费版账号已到期").show() ;
			  },10) ;
			  return false ;
			}
		}
