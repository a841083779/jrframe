...
<div id="slider" class="new_rec">
  ...
  <div class="bd"> 
    <ul class="bgs">
      <li><a href="#" target="_blank"><img src="images/new_bigbanner1.jpg" width="977" height="490" /></a></li>
      <li><a href="#" target="_blank"><img src="images/new_bigbanner2.jpg" width="977" height="490" /></a></li>
      <li><a href="#" target="_blank"><img src="images/new_bigbanner3.jpg" width="977" height="490" /></a></li>
    </ul>
  </div>
</div>
  ...
  <div class="brands">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><a href="#bs04"><img src="images/big_brand04.png" width="225" height="170" /></a></td>
      </tr>
    </table> 
  </div>
    ...
    <%
    	if(null!=hotList && hotList.size()>0){
    		for(Map oneMap:hotList){
    			%>
      <li>
        <div class="img"><a href="/proDetail/<%=CommonString.getFormatPara(oneMap.get("file_name")) %>" target="_blank"><img onerror='this.src="/images/nopic.gif"' src="/uploadfiles/<%=CommonString.getFormatPara(oneMap.get("img2")) %>" width="215" height="190" /></a></div>
        <div class="info">
...
<div class="clear"></div>
  ...
  <div class="proBrandList">
    <ul class="pbl-con">
      <li class="pbl">
        ...
        if(null!=proList && proList.size()>0){
        	for(Map oneMap:proList){
        		%>
                <li>
                <a href="/proDetail/<%=CommonString.getFormatPara(oneMap.get("file_name")) %>" target="_blank" class="img" title="<%=CommonString.getFormatPara(oneMap.get("factoryname")) +CommonString.getFormatPara(oneMap.get("name"))+CommonString.getFormatPara(oneMap.get("catalogname"))%>"><img src="/uploadfiles/<%=CommonString.getFormatPara(oneMap.get("img2"))%>" onerror='this.src="/images/nopic.gif"' width="235" height="225" /></a>
                <h4><a href='/proDetail/<%=CommonString.getFormatPara(oneMap.get("file_name")) %>' target="_blank" title="<%=CommonString.getFormatPara(oneMap.get("factoryname")) +CommonString.getFormatPara(oneMap.get("name"))+CommonString.getFormatPara(oneMap.get("catalogname"))%>"><%=CommonString.getFormatPara(oneMap.get("name"))+CommonString.getFormatPara(oneMap.get("catalogname"))%></a></h4>
      ...
      <li class="pbl">
        <div class="cate">
          <div class="img"><a href="list.jsp?factoryid=192&catanum=101002" target="_blank"><img src="images/doosan2_07-10.jpg" alt="斗山挖掘机系列" width="395" height="210" /></a></div>
          <div class="title">
        ...
        <ul>
              <%
        whereStr = "where factoryid=192 and catalognum like'101002%'" ;
        proList = (ArrayList)dbHelper.getMapList(sel_sql+whereStr) ;
        if(null!=proList && proList.size()>0){
        	for(Map oneMap:proList){
        		%>
      ...
      <li class="pbl">
        <div class="cate">
          <div class="img"><a href="list.jsp?factoryid=192&catanum=101008" target="_blank"><img src="images/doosan2_07-12.jpg" alt="斗山挖掘机系列" width="395" height="210" /></a></div>
          <div class="title">
      ...
      <li class="pbl">
        <div class="cate">
          <div class="img"><a href="list.jsp?factoryid=192&catanum=113001" target="_blank"><img src="images/pblimg04.jpg" alt="斗山挖掘机系列" width="395" height="210" /></a></div>
          <div class="title">
...
<div class="clear"></div>  
  <div class="bigTitle01">
    ...
    <span class="links"><a href="list.jsp?factoryid=1661&catanum=113001" target="_blank">破碎锤</a><em>|</em><a href="list.jsp?factoryid=1661&catanum=33333">再制造产品</a></span>
    <span class="ico"></span>
  </div>
  <div class="proBrandList">
    <ul class="pbl-con">
      <li class="pbl">
        ...
        <div class="cate">
          <div class="img"><a href="#"><img src="images/sevalo2_08.jpg" alt="千里马再生设备系列" width="395" height="210" /></a></div>
          <div class="title">
            <h3><a href="#">千里马再生设备系列</a></h3>
...
<div class="proBrandShow clearfix">
  ...
  <div class="content">
    <div class="w978 border03 l list08">
      <div class="title08">
       <%
       	String order_sql = "select factory_id factoryid ,id,factory_name factoryname,product_name,contact_address,cata_name cataname,user_name name,contact_tel mobile_phone,province,city,add_date  from dbo.pro_agent_products_form where agent_id=1661 order by add_date desc" ;
