...
<%  
    ...
    //TDK
	if(tonnage.equals("")){
	tdk_title="【"+(String)(year.equals("")?"":year+"年")+(String)(month.equals("")?"":month+"月")+(String)(show_season.equals("")?"":show_season+"季度")+(factory.equals("")?"":CommonString.getFormatPara(brandMap.get(factory)))+(catalog.equals("")?"":CommonString.getFormatPara(catalogMap.get(catalog)))+"排行榜】"+(factory.equals("")?"":CommonString.getFormatPara(brandMap.get(factory)))+(catalog.equals("")?"":CommonString.getFormatPara(catalogMap.get(catalog)))+"产品排名 - 铁臂排行榜";
	...
	tdk_title="【"+(String)(year.equals("")?"":year+"年")+(String)(month.equals("")?"":month+"月")+(String)(show_season.equals("")?"":show_season+"季度")+(factory.equals("")?"":CommonString.getFormatPara(brandMap.get(factory)))+tonnageName+"排行榜】"+(factory.equals("")?"":CommonString.getFormatPara(brandMap.get(factory)))+tonnageName+"产品排名 - 铁臂排行榜";
