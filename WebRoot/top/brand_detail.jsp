...
<%  
	...
	//TDK
	String tdk_title="【"+(String)(year.equals("")?"":year+"年")+(String)(month.equals("")?"":month+"月")+(String)(show_season.equals("")?"":show_season+"季度")+(catalog.equals("")?"":CommonString.getFormatPara(catalogMap.get(catalog)))+(area.equals("1")?"国外":"")+(area.equals("2")?"国内":"")+"品牌排行榜】"+(catalog.equals("")?"":CommonString.getFormatPara(catalogMap.get(catalog)))+(area.equals("1")?"国外":"")+(area.equals("2")?"国内":"")+"品牌排名 - 铁臂排行榜";
