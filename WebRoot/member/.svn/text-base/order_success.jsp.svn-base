...
<%@page import="com.jerehnet.alipay.util.AlipayNotify"%>
...
<%  
	...
	String order_num =  CommonString.getFormatPara(request.getParameter("out_trade_no"));
  ...
  <div id="cart"> 	
  	<div class="cart_left">
        ...
        <div class="confirm_pay" style="margin:0px; background:none; padding-bottom:15px;">
        	<input type="hidden" id="pay_mode" name="pay_mode" value="168002">
        	<input type="hidden" id="pay_gateway_no" name="pay_gateway_no" value="Alipay">
...
<script>
		...
		function pay(){
			window.open("/tools/pay/alipayapi.jsp?order_num=<%=order_num %>&pay_mode=168002&pay_gateway_no=Alipay ");
		}
</script>
</html>
