...
<div class="wrapper m_contain mb20 fix">
  ...
  <div class="m_leftPart">
    ...
    <ul class="m_leftMenu">
      ...
      <li><a class="selected" href="/member/weixiu.jsp"><span class="n"><img src="images/menu_ico03.png">我的维修知识</span></a></li>
  ...
  <div class="m_rightPart">
    <div class="mr_menu">
      <ul class="fix">
        <li><a href="#" class="selected"><span style="color:white">我的维修知识</span></a></li>
      </ul>
      <span class="btn"><a target="_blank" href="http://weixiu.21-sun.com/knowledge_edit.jsp"><span style="color:white">发表维修知识</span></a></span>
    </div>
      ...
      <ul class="fix">
	   ...
	   %>
          ...
          <div class="intro">
            ...
            <div class="text">
			<a href="http://weixiu.21-sun.com/info_<%=CommonString.getFormatPara(oneMap.get("id"))%> .htm" target="_blank"><%=CommonString.getFormatPara(oneMap.get("title"))%> </a>
            </div>    
