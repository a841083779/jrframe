...
<%@page import="java.net.URLEncoder"%><%
	...
	if(telephone.indexOf("test")>=0){return;}
	//获取询价的session信息
	int inquriyCount=0;
	...
	if("fourorders".equals(if_tag)&&inquriyCount==7){
	   //特殊情况
	     ...
	     if(inquriyCount>=6){
			...
			out.println("<script>alert('请输入正确的验证码!');history.back();</script>") ;
		       return ;
	           }
	    }
	}
...
<script type="text/javascript">
    //_jrTracker.trackFmFinish("弹出框询价单"); 
    ...
    //_jrTracker.track(); 
	_jrTracker.trackFmFinish("弹出框询价单","<%=zd_product_id%>"); 
    }
