...
<%@page import="java.net.URLEncoder"%><%
	...
	String zd_province="";String zd_city="";
		...
		HttpMethod method =new GetMethod("http://life.tenpay.com/cgi-bin/mobile/MobileQueryAttribution.cgi?chgmobile="+telephone);
        client.executeMethod(method); 
        //String responses= method.getResponseBodyAsString().getBytes("8859_1"); 
        //method.getResponseBodyAsString().getBytes("iso-8859-1")
        String responses =   new String(method.getResponseBodyAsString().getBytes("8859_1"));   
...
if(CommonString.getFormatPara(request.getParameter("zd_factoryid")).equals("135")||CommonString.getFormatPara(request.getParameter("zd_factoryid")).equals("136")||CommonString.getFormatPara(request.getParameter("zd_factoryid")).equals("137")||CommonString.getFormatPara(request.getParameter("zd_factoryid")).equals("192")){
