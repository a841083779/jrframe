...
<%	if("".equals(factory)&&"101001".equals(catalog)){%>
   <div style="display:none"><img src="http://g.cn.miaozhen.com/x.gif?k=2000402&p=6qIbK&rt=2&ns=[M_ADIP]&ni=[M_IESID]&na=[M_MAC]&v=[M_LOC]&o=" width="1" height="1" border="0" /></div>
  <div style="text-align:center"><a href="http://e.cn.miaozhen.com/r.gif?k=2000402&p=6qIbK&rt=2&ns=[M_ADIP]&ni=[M_IESID]&na=[M_MAC]&v=[M_LOC]&o=www.catwaji.com/e10/mobile/?utm_source=21sun&utm_medium=paid&utm_content=11sep2014_05&utm_campaign=BCP2014_Mobile" target="_blank"><img src="Static/img/cat_sj.jpg" alt=""></a></div>
<%}%>
<header>
...
<ul class="proList">
  <!--卡特广告-->
  <%	if("".equals(factory)&&"101001".equals(catalog)&&"0".equals(offset)){%>
  <li>
    <a href="/proDetail/320D320DL.shtm" title="卡特彼勒320DGC/320D/320DL液压挖掘机" class="int">
      <img onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);" src="/uploadfiles///2013/06/20130614102112_144.jpg">
      ...
      <div class="num"><span>询价：2024次</span><span>浏览：57374次</span></div>
    </a>
    <dl class="btn">
  ...
  <li>
    <a href="/proDetail/307E.shtm" title="卡特彼勒307E挖掘机" class="int">
      <img onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"  src="/uploadfiles///2013/08/20130806113612_935.jpg">
      <div class="n">卡特彼勒307E挖掘机</div>
      <div class="p">
	  参考价格：  
	    <font>面议</font>	  
	  </div>	  
      <div class="num"><span>询价：15080次</span><span>浏览：52535次</span></div>
    </a>
    <dl class="btn">
      <dd class="b1"><a href="tel:4006-521-526"><img src="Static/img/btn_tel.png">询问底价</a></dd>
      <dd class="b2"><a href="/form.jsp?pid=20163"><img src="Static/img/btn_buy.png">立即订购</a></dd>
    </dl>
  </li>
   <%}%>
   <%	 
