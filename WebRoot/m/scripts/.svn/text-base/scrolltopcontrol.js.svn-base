var scrolltotop={
	...
	controlHTML: '<img src="http://product.21-sun.com/images/backtop.gif" style="width:36px; height:36px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
