...
<%
    ...
    String pro_id = CommonString.getFormatPara(request.getParameter("id"));
        ...
        List<Map> list = dbHelper.getMapList(" select   * from pro_products where id="+pro_id+" and  file_name is not null  ") ;			
		...
		if(null != list && list.size()>0){
			for(Map model:list){
				...
				freemarkerUtils.generate("proDetail.htm",root,realPath+"/proDetail/"+fileName) ;  				
