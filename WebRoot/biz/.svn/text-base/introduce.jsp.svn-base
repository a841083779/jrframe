...
<title>企业介绍 – <%=CommonString.getFormatPara(map.get("full_name"))%></title>
...
<div class="shop_con">
  ...
  <div class="shop_top02">
    <div class="contain980 fix">
      <ul class="shopNav fix">
        ...
        <li class="cur"><a href="http://<%=usern%>.biz.21-sun.com/introduct.htm">公司介绍</a></li>
  ...
  <h3 class="breadCrumbs l"><a href="/">企业首页</a> &gt;&gt; 公司介绍</h3>
</div>
  <div class="contain980 fix">
    ...
    <div class="comBox04 mb10 shop_contacts">
      <div class="hd fix">
        <h3>联系方式<i></i></h3>
      </div>
      <div class="bd fix">
