define('jbox',function(require, exports, module) {
	var $ = require('jquery');
	seajs.importStyle(":focus{outline:0}.jbox-fade{background-color:#000}.jbox-drag{border:1px dashed #0097d4}div.jbox{padding:0;border:none;font-size:12px}div.jbox .jbox-title-panel{background:#0097d4;background:-webkit-gradient(linear,left top,left bottom,from(#1aa2d8),to(#0079aa));background:-moz-linear-gradient(top,#1aa2d8,#0079aa);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#1aa2d8', endColorstr='#0079aa');border-bottom:1px solid #999}div.jbox .jbox-title{font-weight:700;color:#fff}div.jbox .jbox-title-icon{background:url(/Static/modules/jBox/Skins2/Blue/images/jbox-title-icon.gif) no-repeat scroll 3px 5px transparent}div.jbox .jbox-close,div.jbox .jbox-close-hover{background:url(/Static/modules/jBox/Skins2/Blue/images/close_03.png) no-repeat scroll 0 0 transparent}div.jbox .jbox-content{min-height:24px;line-height:18px;color:#444;background-color:#fff}div.jbox .jbox-content-loading{background-color:#E6E6E6}div.jbox .jbox-content-loading-image{background:url(/Static/modules/jBox/Skins2/Blue/images/jbox-content-loading.gif) no-repeat bottom center}div.jbox .jbox-button-panel{border-top:1px solid #CCC;background-color:#EEE}div.jbox .jbox-bottom-text{text-indent:10px;color:#444}div.jbox .jbox-button{background:#0097d4;background:-webkit-gradient(linear,left top,left bottom,from(#1aa2d8),to(#0079aa));background:-moz-linear-gradient(top,#1aa2d8,#0079aa);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#1aa2d8', endColorstr='#0079aa');border:#004b6a 1px solid;color:#fff;border-radius:3px 3px 3px 3px;margin:1px 7px 0 0;height:22px;cursor:default}div.jbox .jbox-button-hover{background:#0097d4;background:-webkit-gradient(linear,left top,left bottom,from(#0097d4),to(#005b7f));background:-moz-linear-gradient(top,#0097d4,#005b7f);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#0097d4', endColorstr='#005b7f')}div.jbox .jbox-button-active{background:-webkit-gradient(linear,left top,left bottom,from(#005b7f),to(#0097d4));background:-moz-linear-gradient(top,#005b7f,#0097d4);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#005b7f', endColorstr='#0097d4')}div.jbox-warning .jbox .jbox-button-panel{background-color:#FFF}div.jbox .jbox-tip-color{background:#0097d4;background:-webkit-gradient(linear,left top,left bottom,from(#0097d4),to(#005b7f));background:-moz-linear-gradient(top,#0097d4,#005b7f);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#0097d4', endColorstr='#005b7f');border-color:#004b6a;border-radius:3px 3px 3px 3px;color:#fff}div.jbox span.jbox-icon{background:url(/Static/modules/jBox/Skins2/Blue/images/jbox-icons.png) no-repeat scroll 0 0 transparent}div.jbox span.jbox-icon-info{background-position:0 0}div.jbox span.jbox-icon-question{background-position:-36px 0}div.jbox span.jbox-icon-success{background-position:-72px 0}div.jbox span.jbox-icon-warning{background-position:-108px 0}div.jbox span.jbox-icon-error{background-position:-144px 0}div.jbox span.jbox-icon-none{display:none;overflow:hidden}div.jbox span.jbox-icon-loading{background:url(/Static/modules/jBox/Skins2/Blue/images/jbox-loading1.gif) no-repeat scroll 0 0 transparent}.ui_b,.ui_close,.ui_lb,.ui_lt,.ui_rb,.ui_rt,.ui_t{background-image:url(/Static/modules/jBox/Skins2/Blue/images/idialog_s.png);background-repeat:no-repeat}.ui_lt{width:15px;height:15px;background-position:0 0}.ui_rt{width:15px;height:15px;background-position:-15px 0}.ui_lb{width:15px;height:15px;background-position:0 -15px}.ui_rb{width:15px;height:15px;background-position:-15px -15px}.ui_b,.ui_t{background-repeat:repeat-x}.ui_t{background-position:0 -30px}.ui_b{background-position:0 -45px}.ui_l,.ui_r{background-image:url(/Static/modules/jBox/Skins2/Blue/images/idialog_s2.png);background-repeat:repeat-y}.ui_l{background-position:left top}.ui_r{background-position:right bottom}@media screen and (min-width:0){.ui_lb,.ui_lt,.ui_rb,.ui_rt{width:5px;height:5px}.ui_b,.ui_l,.ui_lb,.ui_lt,.ui_r,.ui_rb,.ui_rt,.ui_t{background:0 0}.ui_lb{border-radius:0 0 0 5px}.ui_rb{border-radius:0 0 5px 0}.ui_border{border-radius:5px;background:#FFF;border:1px solid #929292;border-radius:5px;box-shadow:0 1px 6px rgba(0,0,0,.3);-moz-transition:-moz-box-shadow linear .2s;-webkit-transition:-webkit-box-shadow linear .2s;transition:-webkit-box-shadow linear .2s}}", module.uri);
(function(a) {
	a.jBox = function(b, c) {
		...
		j.push('<table border="0" cellpadding="0" cellspacing="0" style="margin:0px;padding:0px;border:none;" class="ui_border">');
		if (c.border > 0x0) {
			j.push('<tr>');
			j.push('<td class="jbox-border ui_lt"></td>');
			j.push('<td class="jbox-border ui_t"></td>');
			j.push('<td class="jbox-border ui_rt"></td>');
			j.push('</tr>')
		};
		j.push('<tr>');
		j.push('<td class="jbox-border ui_l" style="margin:0px;padding:0px;border:none;"></td>');
		...
		j.push('<a id="jclose" class="jbox-close" title="' + a.jBox.languageDefaults.close + '" onmouseover="$(this).addClass(\'jbox-close-hover\');" onmouseout="$(this).removeClass(\'jbox-close-hover\');" style="position:absolute; display:block; cursor:pointer; top:' + (0x6 + c.border) + 'px; right:' + (0x6 + c.border) + 'px; width:15px; height:15px;' + (c.showClose ? '' : 'display:none;') + '"></a>');
		if (g) {
		...
		j.push('</div>');
		j.push('</td>');
		j.push('<td class="jbox-border ui_r" style="margin:0px;padding:0px;border:none;"></td>');
		j.push('</tr>');
		if (c.border > 0x0) {
			j.push('<tr>');
			j.push('<td class="jbox-border ui_lb"></td>');
			j.push('<td class="jbox-border ui_b"></td>');
			j.push('<td class="jbox-border ui_rb"></td>');
			j.push('</tr>')
		};
		j.push('</table>');
		j.push('</div>');
