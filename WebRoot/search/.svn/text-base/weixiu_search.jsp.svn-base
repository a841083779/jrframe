...
<body>
<!--top-->
<jsp:include page="top_search.jsp" flush="true"/>
<!--top end-->
<!--面包屑-->
...
<div class="contain980 fix">
  ...
  <div class="w210 l">
    <div class="nph_val mb10">
      <ul class="nph_list">
        <li> <a href="/<%=keywordCheck%>_info_0_0_0_0_0.htm">维修知识</a></li>
        <li> <a href="/<%=keywordCheck%>_pro_0_0_0_0_0.htm">产品维修</a></li>
        <li> <a href="/<%=keywordCheck%>_agent_0_0_0_0_0.htm">维修网点</a></li>
      </ul>
    </div>
    ...
    <div class="rp clearfix mb10 area Similar nse_left_viewpro Sborder mt10">
      <div class="stitle">
       ...
       <div class="content rList01">
        <ul class="list">
          <li><a title="北京维修" href="/<%=keywordCheck%>_agent_105500_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">北京</a></li>
          <li><a title="上海维修" href="/<%=keywordCheck%>_agent_105300_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">上海</a></li>
          <li><a title="天津维修" href="/<%=keywordCheck%>_agent_105690_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">天津</a></li>
          <li><a title="重庆维修" href="/<%=keywordCheck%>_agent_105880_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">重庆</a></li>
          <li><a title="石家庄维修" href="/<%=keywordCheck%>_agent_106410_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">石家庄</a></li>
          <li><a title="太原维修" href="/<%=keywordCheck%>_agent_108310_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">太原</a></li>
          <li><a title="呼和浩特维修" href="/<%=keywordCheck%>_agent_109710_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">呼和浩特</a></li>
          <li><a title="沈阳维修" href="/<%=keywordCheck%>_agent_120010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">沈阳</a></li>
          <li><a title="长春维修" href="/<%=keywordCheck%>_agent_119010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">长春</a></li>
          <li><a title="哈尔滨维修" href="/<%=keywordCheck%>_agent_122010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">哈尔滨</a></li>
          <li><a title="南京维修" href="/<%=keywordCheck%>_agent_110910_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">南京</a></li>
          <li><a title="杭州维修" href="/<%=keywordCheck%>_agent_104210_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">杭州</a></li>
          <li><a title="合肥维修" href="/<%=keywordCheck%>_agent_102320_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">合肥</a></li>
          <li><a title="福州维修" href="/<%=keywordCheck%>_agent_142010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">福州</a></li>
          <li><a title="南昌维修" href="/<%=keywordCheck%>_agent_103110_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">南昌</a></li>
          <li><a title="济南维修" href="/<%=keywordCheck%>_agent_101260_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">济南</a></li>
          <li><a title="郑州维修" href="/<%=keywordCheck%>_agent_130010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">郑州</a></li>
          <li><a title="武汉维修" href="/<%=keywordCheck%>_agent_124010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">武汉</a></li>
          <li><a title="长沙维修" href="/<%=keywordCheck%>_agent_126010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">长沙</a></li>
          <li><a title="广州维修" href="/<%=keywordCheck%>_agent_128010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">广州</a></li>
          <li><a title="南宁维修" href="/<%=keywordCheck%>_agent_113010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">南宁</a></li>
          <li><a title="海口维修" href="/<%=keywordCheck%>_agent_141510_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">海口</a></li>
          <li><a title="成都维修" href="/<%=keywordCheck%>_agent_139010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">成都</a></li>
          <li><a title="贵阳维修" href="/<%=keywordCheck%>_agent_132010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">贵阳</a></li>
          <li><a title="昆明维修" href="/<%=keywordCheck%>_agent_137010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">昆明</a></li>
          <li><a title="拉萨维修" href="/<%=keywordCheck%>_agent_115010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">拉萨</a></li>
          <li><a title="西安维修" href="/<%=keywordCheck%>_agent_135510_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">西安</a></li>
          <li><a title="兰州维修" href="/<%=keywordCheck%>_agent_134010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">兰州</a></li>
          <li><a title="西宁维修" href="/<%=keywordCheck%>_agent_133010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">西宁</a></li>
          <li><a title="银川维修" href="/<%=keywordCheck%>_agent_116010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">银川</a></li>
          <li><a title="乌鲁木齐维修" href="/<%=keywordCheck%>_agent_117010_<%=city%>_<%=factory%>_<%=catalog%>_0.htm">乌鲁木齐</a></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="nseresult_pro pic_searchval">
      ...
      <div class="rp clearfix mb10 nwx_zxlist repairList border0 mt10">
        <div class="title border04">
          <h3>维修知识</h3>
          <a style=" float:right; padding-right:25px;" href="#"></a> </div>
		...
		for(SolrDocument m : infoList){	
            ...
            String pub_date=CommonDate.getFormatDate("yyyy-MM-dd",m.getFieldValue("pub_date"));
