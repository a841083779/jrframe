...
<div class="loginLayer">
  <div class="loginLayerLeft">
    <form action="/tools/ajax_action.jsp" name="loginform" id="loginform" method="post">
      <ul class="b_whitebg">
        <li class="name">
          <input type="text" name="showLoginName" id="showLoginName" title="注册时的手机号" onFocus="onfocusTochangeTxt(this,2);" datatype="Require" msg="请输入注册时的手机号！">
        ...
        <li class="code">
          ...
          <input style="display: none;" name="login_password" type="password" class="b_wi02" id="login_password" value="密码" onKeyDown="if(event.keyCode==13){doLogin2();}" onBlur="onblurTochangeTxt(this,2)">
        </li>
        <li class="remeber">
        ...
        <li class="b_loginWays" style="line-height: 40px;">
          <div class="b_btn">
            <input style="font:0px a;color: #FFF;border: none;float: left; letter-spacing:-7px;" type="button" name="button" id="button" onClick="doLogin2();" value="立即登录" class="b_lb1">
  ...
  <div class="loginLayerRight">
    <div class="mb5"> 还没有注册账号？<br>
      <a href="javascript:void(0);" onClick="toRegist_for_return();" class="b_lb2 mt5">立即注册</a> </div>
     </div>
</div>
...
var backUrl = '';
	jQuery(function(){
		...
		jQuery("#showLoginName").val("手机号/邮箱/昵称") ;
