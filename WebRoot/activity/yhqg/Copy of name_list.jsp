...
<div class="wrapper mainContain pageDetail" style="*padding-bottom:20px; _padding-bottom:0px;">
  <div class="mainLeft">
    <div class="shopPart">
      <div class="content" style="border:none; background:url(images/namelistbg.jpg) 15px 15px no-repeat; height:446px; padding-top:80px;">
        <div class="namelist" style="height:252px; margin-bottom:0px; padding-top: 40px;">
          <ul>
            <li>
              <span class="n">田**</span>
        ...
        <div class="namelist" id="namelist" style="height:140px; overflow:hidden; color:#fff; cursor:all-scroll;">
          <ul>
          <%
		...
		new Marquee("namelist",0,1,580,140,30,0,0)//向上连续滚动及鼠标拖动实例实例
		</script>
      </div>
    </div>
  </div>
