...
<div class="contain980 fix">
	<div class=" sem_val_new">
      <h3>获奖名单</h3>
        <ul class="fix">
            <li class="ll1"><div class="prize"><span class="sp">13971228691</span><b>82分</b><i>一等奖</i></div><div class="prize"><span>li123321</span><b>70分</b><i>一等奖</i></div></li>
            <li><div class="prize "><span class="sp">chenggongxiaoqibing</span><b>52分</b><i> 二等奖</i></div><div class="prize"><span>chenjindong</span><b>30分</b><i>二等奖</i></div><div class="prize"><span>fmt123</span><b>29分</b><i>二等奖</i></div> </li>
        </ul>
    </div>
</div>
	...
	<div class="sem_prolist">
    	...
    	if(proList!=null){
    		for(Map m:proList){
				...
				String tonandmeter = CommonString.getFormatPara(m.get("tonandmeter"));

      %>
		
        	<li>
            	<div class="sem_img"><img src="http://product.21-sun.com/uploadfiles/<%=img2%>" alt="<%=name%>" title="<%=name%>" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"/></div>
                <div class="sem_right">
                    <div class="sem_pname"><%=name%></div>
                    <ul class="sem_para">		
                      <li>所属系列：<%=catalogname%></li>
                      <li>所属工况：轻工况</li>
                      <li>所属吨位：<%=tonandmeter.equals("0.0")?"暂无":tonandmeter+"吨"%></li>
                    </ul>
                    <a href="http://koubei.21-sun.com/list/<%=id%>.htm#sentComment" class="sem_btn" target="_blank">立即发表评论</a>
                </div>
            </li>
		<%}}%>
        </ul>
      ...
      <form action="/action/crud.jsp" method="post" name="theform" id="theform">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td valign="top"><div class="xing" id="price_1" style="cursor: pointer; width: 100px;"><img src="/koubei/img/star-off.png" alt="1" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="2" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="3" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="4" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="5" title=""><input type="hidden" name="score"></div>
          ...
          <tr>
            ...
            <td><div class="xing" id="xingneng_1" style="cursor: pointer; width: 100px;"><img src="/koubei/img/star-off.png" alt="1" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="2" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="3" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="4" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="5" title=""><input type="hidden" name="score"></div>
              <span class="xing_tip">点击星星为该机型性能打分</span></td>
          </tr>
          <tr>
            <td align="right"><b>*</b>售后：</td>
            <td><div class="xing" id="shouhou_1" style="cursor: pointer; width: 100px;"><img src="/koubei/img/star-off.png" alt="1" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="2" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="3" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="4" title="">&nbsp;<img src="/koubei/img/star-off.png" alt="5" title=""><input type="hidden" name="score"></div>
          ...
          <tr>
            ...
            <tr><td height="39" class="td_bot"></td>
...
铁臂口碑要求发布的评论确系本人原创，严禁剽窃、转投他人评论，若因此引起任何法律纠纷，与铁臂口碑无关。					 
                  </p>
                </blockquote>              
              </div></td>
          </tr>
...
<!--foot end-->
<script type="text/javascript">
	$('.sem_para li:even').addClass('evenbg');
	$('.sem_para li:last').css('border-bottom','none');
