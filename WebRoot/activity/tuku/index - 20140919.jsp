...
<div class="kb_jxsz" id="cc">
	<div class="wrap1000 fix">
        ...
        <div class="prize_t">本期活跃奖</div>
        <div class="prize_hy">
        	<p class="kp1">本周活跃奖由<span>山推股份赞助</span></p>
            <p class="kp2">山推装载机模型SL50W（1:35）</p>
        </div>
  ...
  try{
	...
	function setImgs(data){
		...
		for(var i=0;i<imgs.length;i++){
			...
			htm += '<li style="float:left"><img class="img" src="'+f+imgs[i]+'" width="90" height="60" /><input type="hidden" id="images" name="images"  value="'+f+imgs[i]+'" /><a href="javascript:void(0);" onclick="removeThis(this);" attrId="0" class="img_delete" style="position:absolute;top:-7px;left:80px;"><img src="http://member.21-sun.com/home/used/images/delete.png" /></a></li>';
		}
