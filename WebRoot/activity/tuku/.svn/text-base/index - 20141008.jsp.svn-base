<%@ page language="java" import="com.jerehnet.util.dbutil.PageBean,com.jerehnet.util.common.CommonString,com.jerehnet.util.dbutil.DBHelper,java.util.*,com.jerehnet.util.common.*" pageEncoding="UTF-8"%>
<%
	...
	//行业图片
	String  hangye_sql = "select top 7 id,title,add_user,image,vote_count,add_date,contents   from  pro_photo_group  where sort_num like '%107001%' and is_show=1 order by add_date desc" ;
	List<Map> hangyeList = null ;
	hangyeList = dbHelper.getMapList(hangye_sql) ;
	//施工图片
	String shigong_sql = "select top 7 id,title,add_user,image,vote_count,add_date,contents  from  pro_photo_group  where sort_num like '%107003%' and is_show=1 order by  add_date desc" ;
	List<Map> shigongList = null ;
	shigongList = dbHelper.getMapList(shigong_sql) ;
	//维修图片
	String weixiu_sql = "select top 7 id,title,add_user,image,vote_count,add_date,contents  from  pro_photo_group  where sort_num like '%107004%' and is_show=1 order by  add_date desc" ;
	List<Map> weixiuList = null ;
	weixiuList = dbHelper.getMapList(weixiu_sql) ;
	//展会图片
	String zhanhui_sql = "select top 7 id,title,add_user,image,vote_count,add_date,contents  from  pro_photo_group  where sort_num like '%107005%' and is_show=1 order by  add_date desc" ;
	List<Map> zhanhuiList = null ;
	zhanhuiList = dbHelper.getMapList(zhanhui_sql) ;
	//趣味图片
	String quwei_sql = "select top 7 id,title,add_user,image,vote_count,add_date,contents   from  pro_photo_group  where sort_num like '%107006%' and is_show=1 order by  add_date desc" ;
	List<Map> quweiList = null ;
	quweiList = dbHelper.getMapList(quwei_sql) ;
	//产品图片
	String pro_sql = "select top 7 id,title,add_user,image,vote_count,add_date,contents   from  pro_photo_group  where sort_num like '%107002%' and is_show=1 order by  add_date desc" ;
...
<body class="koubei_act" onLoad="tiaozhan()">
<script>
function tiaozhan(){
var url = window.location.href;
if(url.indexOf("index.jsp")<=0){
window.location.href="http://product.21-sun.com/activity/tuku/index.jsp";
}
...
<div class="kb_topNav fix">
	<div class="wrap1000 fix">
    	<ul class="fix nav_list" >
        	<li class="nav_scroll"><a href="#aa">大赛介绍</a></li>
            <li class="nav_scroll"><a href="#bb">大赛流程</a></li>
            <li class="nav_scroll"><a href="#cc">奖项设置</a></li>
            <li class="nav_scroll"><a href="#dd">参赛规则</a></li>
            <li class="nav_scroll"><a href="#ee">全部作品</a></li>
        </ul>
...
<!--大赛介绍-->
<div id="aa" class="kb_dsjs">
	<div class="wrap1000 fix">
    	<div class="fix kb_intro_top">
        	<div class="l intro_left">
            	<p class="kt1">大赛介绍</p>
                <p class="kt2">Introduction</p>
            </div>
            <div class="r intro_right">
            你有清晰原创的产品图片吗？你有捕捉到施工的精彩瞬间吗？铁臂图库上线，特举办“9要随手拍，就要出风头”摄影大赛活动。晒出你的照片，分享你的美图，就有机会抱得大奖。还犹豫什么，拿起手机或相机，咔嚓起来吧！<br/>
<span class="red">拍摄主题：以工程机械为拍摄对象进行拍摄</span><br/>
一、整机美图（整机外观图、街拍、设备摆拍、人机合影）<br/>
二、整机部件（驾驶室拍摄、底盘拍摄、发动机液压系统等部件拍摄）<br/>
三、第一现场（交机现场、不同工况施工现场、维修现场、服务现场、新机发布现场、展会现场、厂家活动现场）
            </div>
        </div>
        <div class="kb_pic_cat fix">
        	<ul class="fix piccat_left l">
            	<li><a href="/activity/tuku/list.jsp?sort=107002#ee">产品图片</a></li>
                <li><a href="/activity/tuku/list.jsp?sort=107001#ee">行业图片</a></li>
                <li><a href="/activity/tuku/list.jsp?sort=107003#ee">施工图片</a></li>
                <li><a href="/activity/tuku/list.jsp?sort=107004#ee">维修图片</a></li>
                <li><a href="/activity/tuku/list.jsp?sort=107005#ee">展会图片</a></li>
                <li><a href="/activity/tuku/list.jsp?sort=107006#ee">趣味图片</a></li>
            </ul>
            <div class="piccat_right r">
            	<img src="images/temp_01.jpg"/>
                <div class="piccat_wz">
                <p class="kt1">图片分类</p>
                <p class="kt2">Classification</p>
                </div>
            </div>
        </div>
    </div>
...
<!--大赛介绍结束-->
<!--大赛流程-->
<div class="kb_dslc" id="bb">
	<div class="wrap1000 fix">
    <img src="images/lcbg.jpg"/>
    </div>
    <i class="kb_ico kb_ico_1"><img src="images/ico_1.jpg"/></i>
</div>
<!--大赛流程结束-->
<!--奖项设置-->
<div class="kb_jxsz" id="cc">
	<div class="wrap1000 fix">
    	<div class="jxsz_tbg">奖项设置</div>
        <div class="jxsz_wznr">
        1.每周产生“活跃奖”1名，由每周上传合格图片最多者获得（每周二公布）；<br/>
        2.活动结束将在所有参赛作品中选取20幅作品入围，入围机会每人仅限一次，入围作品必须为作者拥有原版权的作品，由网友投票产生
        一等奖1名，二等奖2名，三等奖3名（得票数高+标题及描述完善+迎合主题）；<br/>
        3.其他入围参赛选手均可获得鼓励奖。
        </div>
        <div class="prize_t">每周活跃奖</div>
        <div class="prize_hy">
        	<p class="kp1">本周活跃奖由<span>福田雷沃赞助</span></p>
            <p class="kp2">福田雷沃工具箱</p>
        </div>
        <div class="tuku_hjmd" style="padding-top:15px;">本周活跃奖获得者：<span>13027169968</span>  共上传<span>302</span>张</div><br>
        <div class="tuku_hjmd">友情提示：<span>第三周活跃奖公布中奖调整至10月8日</span> </div>
        <div class="prize_t">活动奖品</div>
        <div class="prize_rwlist">
        	<ul class="fix">
            	<li>
                	<img src="images/temp_11.jpg" alt=""/>
                    <div class="prize_name">
                        <p class="pn1">一等奖（1名）</p>
                        <p class="pn2">雷沃遥控挖机+便签夹+车贴</p>
                    </div>
                </li>
                <li>
                	<img src="images/temp_12.jpg" alt=""/>
                    <div class="prize_name">
                        <p class="pn1">二等奖（2名）</p>
                        <p class="pn2">小松推土机模型+便签夹+车贴</p>
                    </div>
                </li>
                <li>
                	<img src="images/temp_13.jpg" alt=""/>
                    <div class="prize_name">
                        <p class="pn1">三等奖（3名）</p>
                        <p class="pn2">山推保温杯+便签夹+车贴</p>
                    </div>
                </li>
                <li>
                	<img src="images/temp_14.jpg" alt=""/>
                    <div class="prize_name">
                        <p class="pn1">入围奖（14名）</p>
                        <p class="pn2">毛巾+便签夹+车贴</p>
                    </div>
                </li>
            </ul>
        </div>
...
<!--奖项设置结束-->
<!--参赛规则-->
<div class="kb_csgz" id="dd">
	<div class="wrap1000 fix">
    	<div class="csgz_tbg">参赛规则</div>
        <div class="csgz_val fix">
        	<div class="csgz_nr">
            	<p class="gzt1">会员登录</p>
                <p class="gzt2">登录活动页面，注册成为铁臂商城会员</p>
            </div>
            <div class="csgz_title">
			<a href="javascript:void(0)" <%if(username.equals("")){%> onClick="login();"<%}else{%>onclick="tishi();"<%}%>>登录</a>
			<a href="http://koubei.21-sun.com/activity/koubei/register.jsp" target="_blank">注册</a></div>
			<script>
			  function tishi(){
			  		$.jBox.tip('您已登录'); 
			  }
        ...
        <div class="csgz_val fix">
        	<div class="csgz_nr">
            	<p class="gzt1">参与方式</p>
                <p class="gzt2">
                标题拟格式：产品品牌+产品型号+其他描述（例如：卡特320D挖鱼塘或 柳工CLG856<br/>1000小时）<br/>
				上传成功，返回继续上传。
                </p>
            </div>
            <div class="csgz_title"><a href="javascript:void(0)" <%if(username.equals("")){%> onClick="login();"<%}else{%>onclick="showUpdate();"<%}%>>上传照片</a></div>
        </div>
        <div class="hdgz_nrjs">
        	<p class="gzt">活动规则：</p>
            ...
            4.数码电子作品单个文件大小在2M—10M之间， 会员参赛作品数量不限。<br/>
            5. 每位参赛者作品投稿后，即被视为已同意大赛主办者及其被许可人拥有参赛者作品的使用权（著作权仍由作者拥有），不另付稿酬。<br/>
            6. 参赛者同意铁臂商城拥有本活动规则的最终解释权。凡投稿的作者，均视为同意并遵守以上各条规定，凡不符合征稿要求的作品一经发现一律取消参评资格。
        </div>
    </div>
    <i class="kb_ico kb_ico_2"><img src="images/ico_2.gif"/></i>
</div>
<!--参赛规则结束-->
<!--全部作品-->
	...
	<div class="wrap1000 fix">
        ...
        <div class="kbpic_tab">
            <ul class="fix kbtab_list">
                <li class="tab_key">产品图片</li>
                <li class="tab_key">行业图片</li>
                <li class="tab_key">施工图片</li>
                <li class="tab_key">维修图片</li>
                <li class="tab_key">展会图片</li>
                <li class="tab_key">趣味图片</li>
            </ul>
            <div class="tab_val">
               ...
               <%}}%>    
                    <li class="last">
                    	<a href="/activity/tuku/list.jsp?sort=107002#ee" target="_blank"><img src="images/pic_more_35.gif"/></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab_val">
               ...
               <%}}%>  
                    <li class="last">
                    	<a href="/activity/tuku/list.jsp?sort=107001#ee" target="_blank"><img src="images/pic_more_35.gif"/></a>
                    </li>
                </ul>
            </div>
            <div class="tab_val">
            	<ul class="fix kbpic_plist">
                	<%	
				    if(shigongList!=null && shigongList.size()>0){
				    for(Map m:shigongList){
              		String image = CommonString.getFormatPara(m.get("image"));
					if(image.indexOf("resource.21-sun.com")==-1){
					  image="http://product.21-sun.com/uploadfiles/"+image;
					}
               ...
               <%}}%>  
                    <li class="last">
                    	<a href="/activity/tuku/list.jsp?sort=107003#ee" target="_blank"><img src="images/pic_more_35.gif"/></a>
                    </li>
                </ul>
            </div>
            <div class="tab_val">
               ...
               <%}}%>  
                    <li class="last">
                    	<a href="/activity/tuku/list.jsp?sort=107004#ee" target="_blank"><img src="images/pic_more_35.gif"/></a>
                    </li>
                </ul>
            </div>
            <div class="tab_val">
            	<ul class="fix kbpic_plist">
                 <%	
				    if(zhanhuiList!=null && zhanhuiList.size()>0){
				    for(Map m:zhanhuiList){
              		String image = CommonString.getFormatPara(m.get("image"));
					if(image.indexOf("resource.21-sun.com")==-1){
					  image="http://product.21-sun.com/uploadfiles/"+image;
					}
               ...
               <%}}%> 
                    <li class="last">
                    	<a href="/activity/tuku/list.jsp?sort=107005#ee" target="_blank"><img src="images/pic_more_35.gif"/></a>
                    </li>
                </ul>
            </div>
            <div class="tab_val">
            	<ul class="fix kbpic_plist">
                <%	
				    if(quweiList!=null && quweiList.size()>0){
				    for(Map m:quweiList){
              		String image = CommonString.getFormatPara(m.get("image"));
					if(image.indexOf("resource.21-sun.com")==-1){
					  image="http://product.21-sun.com/uploadfiles/"+image;
               ...
               <%}}%>            	
                    <li class="last">
                    	<a href="/activity/tuku/list.jsp?sort=107006#ee" target="_blank"><img src="images/pic_more_35.gif"/></a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="kb_upbtn kbf_show">
		<a href="javascript:void(0)" <%if(username.equals("")){%> onClick="login();"<%}else{%>onclick="showUpdate();"<%}%>><img src="images/up_btn2.gif"/></a>
		<a style="padding-left:30px" <%if(username.equals("")){%> href="javascript:void(0)"  onclick="login();"<%}else{%> href="/member/photo.jsp" target="_blank"<%}%>><img src="images/up_ck.gif"/></a>
        <div style="float:right;margin-left:-170px;width:210px;" class="list_btm"> 了解更多获奖明细及活动公告请加 <br><b style="color:#ea4609">产品咨询群： 250469589<br> 活动公告群： 215179483</b></div>
		</div>
    </div>
</div>
<!--全部作品结束-->
