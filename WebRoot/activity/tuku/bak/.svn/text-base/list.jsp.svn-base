<%@ page language="java" import="java.sql.Connection,com.jerehnet.util.dbutil.PageBean,com.jerehnet.util.common.CommonString,com.jerehnet.util.dbutil.DBHelper,java.util.*" pageEncoding="UTF-8"%>
...
<%
	...
	pageBean.setFields("id,title,add_user,image,vote_count");
