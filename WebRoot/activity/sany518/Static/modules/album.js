...
define('album', function(require, exports, module) {
	...
	seajs.importStyle('.album_ordinary,.album_wrap{width:100%;height:100%}\
		...
		.album_wrap_case4 .album_case4 .slide_c p{bottom:0;width:100%;background:rgba(0,0,0,.60); filter:progid:DXImageTransform.Microsoft.gradient(startcolorstr=#99000000,endcolorstr=#99000000);padding:12px 10px;text-align:left;}\
