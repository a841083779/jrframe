			...
			$.ajax({
					...
					success:function(rs){
						...
						if(order_num != ""&&order_num!="fail"){
							if(source=='zfb'){
								window.location.href="action/alipay/alipayapi.jsp?WIDout_trade_no=" + order_num +"&WIDsubject=三一"+$("#productName").val()+"微型液压挖掘机定金&WIDtotal_amount=2000.0&WIDbody=三一"+$("#productName").val()+"微型液压挖掘机定金2000元";
							}else if(source=='vx'){
