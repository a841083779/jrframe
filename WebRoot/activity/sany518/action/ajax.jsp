...
<%
	...
	try{
		...
		if("createOrder".equals(flag)){
			...
			int result=dbHelper.execute("insert into activity_sany_pay (add_date,source,head_url,nick_name,name,tel,price,product_id,product_name,order_no2,order_state,open_id) "+
