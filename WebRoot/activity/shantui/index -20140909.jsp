...
<% 
	...
	String sql="select  catalognum,catalogname from pro_catalog_factory where factoryid=144";
...
<div class="contain980 fix sem_val_2">
  <div class="sem_prolist">
    <ul class="fix sprolist">
      <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SL30WN-58.shtm" target="_blank"><img src="images/st_img01.jpg" alt="山推SL30WN装载机" title="山推SL30WN装载机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SL30WN-58.shtm" target="_blank">山推SL30WN<br />
          装载机</a></div>
          <ul class="sem_para">
            <li class="evenbg">额定容量：1.7m<sup>3</sup></li>
            <li>额定载重量：3t</li>
            <li class="evenbg">额定功率：10300kg</li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SL30WN-58_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SD32BZX.shtm" target="_blank"><img src="images/st_img02.jpg" alt="山推SD32plus推土机" title="山推SD32plus推土机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SD32BZX.shtm" target="_blank">山推SD32plus<br />
          推土机</a></div>
          <ul class="sem_para">
            <li class="evenbg">整机重量：37200kg</li>
            <li>发动机功率：257kW</li>
            <li class="evenbg">铲刀容量：10m<sup>3</sup></li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SD32BZX_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/HJC5410THB.shtm" target="_blank"><img src="images/st_img03.jpg" alt="山推56m臂架泵车" title="山推56m臂架泵车" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/HJC5410THB.shtm" target="_blank">山推56m<br />
          臂架泵车</a></div>
          <ul class="sem_para">
            <li class="evenbg">底盘型号：奔驰/五十铃</li>
            <li>轴数：4桥</li>
            <li class="evenbg">臂架高度：56m</li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/HJC5410THB_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SR22M.shtm" target="_blank"><img src="images/st_img04.jpg" alt="山推SR22M(A)机械振动压路机" title="山推SR22M(A)机械振动压路机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SR22M.shtm" target="_blank">山推SR22M(A)<br />
          机械振动压路机</a></div>
          <ul class="sem_para">
            <li class="evenbg">操作重量：2000kg</li>
            <li>静线压力：453N/cm</li>
            <li class="evenbg">振动频率：28/32</li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SR22M_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
       <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SG18-3.shtm" target="_blank"><img src="images/st_img05.jpg" alt="山推SG18(D)-3平地机" title="山推SG18(D)-3平地机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SG18-3.shtm" target="_blank">山推SG18(D)-3<br />
          平地机</a></div>
          <ul class="sem_para">
            <li class="evenbg">最大作业高度：14m</li>
            <li>最大幅度时的高度：7.9m</li>
            <li class="evenbg">最大作业幅度：6.5m</li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SG18-3_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SB23%E6%8E%A8%E8%80%99%E6%9C%BA.shtm" target="_blank"><img src="images/st_img06.jpg" alt="山推SB23推耙机" title="山推SB23推耙机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SB23推耙机.shtm" target="_blank">山推SB23<br />
          推耙机</a></div>
          <ul class="sem_para">
            <li class="evenbg">整机使用重量：26200 kg</li>
            <li>发动机：NT855-C280S10</li>
            <li class="evenbg">额定功率：169kw</li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SB23%E6%8E%A8%E8%80%99%E6%9C%BA_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
