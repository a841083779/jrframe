...
<div class="contain980 fix sem_val_2">
  <div class="sem_prolist">
    <ul class="fix sprolist">
      ...
      <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SL50W-SL50W-2.shtm" target="_blank"><img src="images/SL50W.jpg" alt="山推SL50W装载机" title="山推SL50W装载机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SL50W-SL50W-2.shtm" target="_blank">山推SL50W<br />
          装载机</a></div>
          <ul class="sem_para">
            <li class="evenbg">额定斗容量：3m<sup>3</sup></li>
            <li>最大牵引力：162KN</li>
            <li class="evenbg">额定载重量：5t</li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SL50W-SL50W-2_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SR22M.shtm" target="_blank"><img src="images/SR22M.jpg" alt="山推SR22M机械振动压路机" title="山推SR22M机械振动压路机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SR22M.shtm" target="_blank">山推SR22M<br />
          机械振动压路机</a></div>
          <ul class="sem_para">
            <li class="evenbg">操作质量：22000kg</li>
            <li>静线压力：490N/cm</li>
            <li class="evenbg">振动频率：28/32HZ</li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SR22M_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
       <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SG16-3.shtm" target="_blank"><img src="images/SG16-3.jpg" alt="山推SG16-3平地机" title="山推SG16-3平地机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SG16-3.shtm" target="_blank">山推SG16-3<br />
          平地机</a></div>
          <ul class="sem_para">
            <li class="evenbg">发动机型号：康明斯6BTAA5.9-C160</li>
            <li>额定功率：118kW</li>
            <li class="evenbg">整机重量：15400kg</li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SG16-3_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><a href="http://product.21-sun.com/proDetail/SB13.shtm" target="_blank"><img src="images/SB13.jpg" alt="山推SB13推耙机" title="山推SB13推耙机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></a></div>
        <div class="sem_right">
          <div class="sem_pname"><a href="http://product.21-sun.com/proDetail/SB13.shtm" target="_blank">山推SB13<br />
          推耙机</a></div>
          <ul class="sem_para">
            <li class="evenbg">发动机功率：95.5kw/1900rpm</li>
            <li>整机使用重量：14700kg</li>
            <li class="evenbg">铲刀容量：2.99m<sup>3</sup></li>
          </ul>
          <a href="http://product.21-sun.com/proDetail/SB13_message.shtm#sentComment" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
