...
<% 
	...
	try{
		...
		String pro = "select top 6 * from pro_products where factoryid=138 order by view_count desc ,id desc ";
		proList = dbHelper.getMapList(pro);
...
<title>铁臂口碑活动——分享真实用机感受山工专区 - 铁臂口碑</title>
...
<div class="contain980 fix sem_val_2">
  <div class="sem_prolist">
    <ul class="fix sprolist">
      <li>
        <div class="sem_img"><img src="images/lg_09.jpg" alt="CLG888III8t轮式装载机" title="CLG888III8t轮式装载机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></div>
        <div class="sem_right">
          <div class="sem_pname">CLG888III<BR>8t轮式装载机</div>
          <ul class="sem_para">
            <li class="evenbg">额定容量：4.5m3</li>
            <li>额定载重量：8000kg</li>
            <li class="evenbg">工作质量：29000±300kg</li>
          </ul>
          <a href="#" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><img src="images/lg_11.jpg" alt="CLG9045D小型机" title="CLG9045D小型机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></div>
        <div class="sem_right">
          <div class="sem_pname">CLG9045D<br>小型机</div>
          <ul class="sem_para">
            <li class="evenbg">斗容范围：0.058～0.30m3</li>
            <li>整机重量：4000kg</li>
            <li class="evenbg">额定功率：27.1kW</li>
          </ul>
          <a href="#" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><img src="images/lg_13.jpg" alt="QY8A汽车起重机" title="QY8A汽车起重机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></div>
        <div class="sem_right">
          <div class="sem_pname">QY8A<br>汽车起重机</div>
          <ul class="sem_para">
            <li class="evenbg">最大额定起重量：500kg</li>
            <li>基本臂最大起重力矩：264KN•m</li>
            <li class="evenbg">最长主臂最大起重力矩：85KN•m</li>
          </ul>
          <a href="#" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><img src="images/lg_16.jpg" alt="QUY55履带起重机" title="QUY55履带起重机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></div>
        <div class="sem_right">
          <div class="sem_pname">QUY55<br>履带起重机</div>
          <ul class="sem_para">
            <li class="evenbg">最大额定起重量：55t</li>
            <li>最大额定起重力矩：1963kN.m</li>
            <li class="evenbg">主臂长度：9-54m</li>
          </ul>
          <a href="#" class="sem_btn" target="_blank">立即发表评论</a> </div>
      </li>
      <li>
        <div class="sem_img"><img src="images/lg_16-05.jpg" alt="CLG622C机械式振动压路机" title="CLG622C机械式振动压路机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></div>
        <div class="sem_right">
          <div class="sem_pname">CLG622C<br>机械式振动压路机</div>
          <ul class="sem_para">
      ...
      <li>
        <div class="sem_img"><img src="images/lg_25.jpg" alt="B160推土机" title="B160推土机" onerror="showImgDelay(this,'/uploadfiles/no_small.gif',2);"></div>
        <div class="sem_right">
          <div class="sem_pname">B160<br>推土机</div>
          <ul class="sem_para">
...
<div class="contain980 fix sem_val_4">
  <div class="p4_con">
    <form action="/action/crud.jsp" method="post" name="theform" id="theform">
      ...
      <input type="hidden" name="zd_username" id="zd_username" value="">
...
//分享
function share() {
window.open("http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=http://product.21-sun.com/activity/sem/&title=铁臂口碑活动——分享真实用机感受山工专区 - 铁臂口碑<");
}
