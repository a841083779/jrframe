(function(a) {
	a.jBox = function(b, c) {
		...
		j.push('<a id="jclose" class="jbox-close" title="' + a.jBox.languageDefaults.close + '" onmouseover="$(this).addClass(\'jbox-close-hover\');" onmouseout="$(this).removeClass(\'jbox-close-hover\');" style="position:absolute; display:block; cursor:pointer; top:-20px; right:-20px;*top:-5px;*right:-5px; top:-5px\9; right:-5px\9; width:15px; z-index: 9;height:15px;' + (c.showClose ? '' : 'display:none;') + '"></a>');
		if (g) {
