...
<nav>
  <ul>
    <li><a href="/list.jsp?catalog=101001" <%if(catalog.equals("101001")){%>class="cur"<%}%>>挖掘机</a></li>
    <li><a href="/list.jsp?catalog=101002" <%if(catalog.equals("101002")){%>class="cur"<%}%>>装载机</a></li>
    <li><a href="/list.jsp?catalog=101005" <%if(catalog.equals("101005")){%>class="cur"<%}%>>平地机</a></li>
    <li class="more"><span class="n">更多</span>
      <div class="box">
        <a href="/list.jsp?catalog=101003">推土机</a>
        <a href="/list.jsp?catalog=104001">摊铺机</a>
        <a href="/list.jsp?catalog=107">叉车</a>
        <a href="/list.jsp?catalog=102">起重机</a>
        <a href="/list.jsp?catalog=106001">压路机</a>
      </div>
    </li>
  </ul>
</nav>
