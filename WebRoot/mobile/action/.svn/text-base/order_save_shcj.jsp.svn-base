				...
				if(null!=keyId&&keyId>0){
					...
					%>
                    	<script type="text/javascript"> 
						    ...
						    parent.jQuery.jBox.tip("<span style='font-size:20px;font-family:Microsoft YaHei'>询价成功!<br><br>您可拨打号码<span style='color:yellow'>13524904228</span>进行电话咨询！</span>",'info',{ timeout:10000,height:80}) ;
