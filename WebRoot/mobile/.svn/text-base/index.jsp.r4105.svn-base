...
<nav>
  <ul>
    <li><a href="/index.jsp?catalog=101001<%=factory.equals("")?"":"&factory="+factory%>" <%if(catalog.equals("101001")){%>class="cur"<%}%>>挖掘机</a></li>
    <li><a href="/index.jsp?catalog=101002<%=factory.equals("")?"":"&factory="+factory%>" <%if(catalog.equals("101002")){%>class="cur"<%}%>>装载机</a></li>
    <li><a href="/index.jsp?catalog=101005<%=factory.equals("")?"":"&factory="+factory%>" <%if(catalog.equals("101005")){%>class="cur"<%}%>>平地机</a></li>
    <li class="more"><span class="n">更多</span>
      <div class="box">
        <a href="/index.jsp?catalog=101003<%=factory.equals("")?"":"&factory="+factory%>">推土机</a>
        <a href="/index.jsp?catalog=104001<%=factory.equals("")?"":"&factory="+factory%>">摊铺机</a>
        <a href="/index.jsp?catalog=107<%=factory.equals("")?"":"&factory="+factory%>">叉车</a>
        <a href="/index.jsp?catalog=102<%=factory.equals("")?"":"&factory="+factory%>">起重机</a>
        <a href="/index.jsp?catalog=106001<%=factory.equals("")?"":"&factory="+factory%>">压路机</a>
      </div>
    </li>
  </ul>
</nav>
