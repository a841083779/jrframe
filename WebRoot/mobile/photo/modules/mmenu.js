define(function(require, exports, module) {
	...
	$[_PLUGIN_].prototype = {
		...
		_openSetup: function() {
			...
			glbl.$page.data(_d.style, glbl.$page.attr('style') || '').data(_d.scrollTop, _scrollTop).data(_d.offetLeft, glbl.$page.offset().left);
			var _w = 0;
			glbl.$wndw.off(_e.resize).on(_e.resize, function(e, force) {
		...
		_openFinish: function() {
			var that = this;
			transitionend(glbl.$page, function() {
		...
		close: function() {
			...
			transitionend(glbl.$page, function() {
				...
				glbl.$html.removeClass(_c.opened).removeClass(_c.modal).removeClass(_c.background).removeClass(_c.mm(that.opts.position)).removeClass(_c.mm(that.opts.zposition));
		...
		_initMenu: function() {
			...
			this.$menu.prependTo('body').addClass(_c.menu);
