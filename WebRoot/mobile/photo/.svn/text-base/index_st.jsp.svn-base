...
<% 
	...
	try{
		...
		//热门产品
		String query="select  top 4 id,count(id) as countd from pro_products where factoryid=144 and img2!='' and is_show=1 group by id  order by countd desc";
...
<div class="kba_nav">
	<ul class="fix">
        ...
        <li ><a href="guize_st.jsp">活动规则</a></li>
...
<div class="kba_hotp mt10">
	...
	<%
		...
		String querys="select top 4 id,factoryname,catalogname,name,img2 from pro_products where factoryid=144 and img2!='' and  id!='' and is_show=1";
...
<div class="kba_fbpl">
	<div class="kba_prono_lg kba_sele" id="optbg_1">
	<%
		if(username.equals("")){
		%>
		<a href="javascript:;" onclick="comd();">  <div class="_val"><span><i class="red">*</i> 请选择机型</span></div></a>
		<%}else{%>
   ...
   <!-- <div class="kba_probrd kba_sele" id="optbg_2">
	 ...
	 <input type="hidden" name="factory" id="factory" value="144" /><!--型号-->
    ...
    <div class="kba_text">
		...
		<%}else{%>
		<p  id="upload" ><input type="file"   name="equi_img" id="equi_img"></p><%}%></div>
...
<script>
	var jrChannel='0#0';
	seajs.use('../huodong/web/app/index_lg.js')
</script>
