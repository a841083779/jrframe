...
<div class="kba_hotp mt10">
	...
	<%
		...
		String querys="select id,factoryname,catalogname,name,img2 from pro_products where  id in(9906,21652,19600,9912) and is_show=1";
...
<script>
	var jrChannel='0#0';
	seajs.use('./mobile/koubei/huodong/web/app/index_lg.js')
</script>
