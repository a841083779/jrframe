...
<div class="lr_form_val fix">
 <form class="logForm" name="registerForm" id="registerForm" method="post" action="/action/ajax_mobile_activity.jsp?message=regist">
	<div class="lrftom">
        ...
        <div class="lin_nr fix lin_nr2">
            ...
            <span class="lr_inp"><input type="password" name="zd_password"name="zd_password" dataType="Require"  maxlength="20"  min="6" max="20" msg="密码长度为6-20个字符" placeholder="密 码"/></span>
        </div>
