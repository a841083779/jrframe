...
<div class="kba_content">
	<ul class="fix kba_price_list">
    	<li>
            <img src="http://product.21-sun.com/mobile/koubei/huodong/web/img/temp/st_01.jpg" alt=""/>
            <div class="price_title"><strong class="imp">一等奖：</strong>山推装载机模型2个</div>
        </li>
        <li>
            <img src="http://product.21-sun.com/mobile/koubei/huodong/web/img/temp/st_02.jpg" alt=""/>
            <div class="price_title"><strong class="imp">二等奖：</strong>山推保温杯3个</div>
        </li>
    </ul>
</div>

<div class="kba_fbwz mt10" style="display:none;" >获奖名单</div>
<div class="kba_content" style="display:none;" >
	<ul class="fix kba_hjmd">
        ...
        <li class="fix">
        	<span class="t1">lixing123</span>
            <span class="t2">262分</span>
            <span class="t3">第1名 </span>
            <span class="t4">一等奖</span>
        </li>
        <li class="fix">
        	<span class="t1">chenggongxiaoqibing</span>
            <span class="t2">111分</span>
            <span class="t3">第2名 </span>
            <span class="t4">二等奖</span>
        </li>
        <li class="fix">
        	<span class="t1">123123123999</span>
            <span class="t2">110分</span>
