<%@ page language="java" import="java.io.File,java.util.*,com.jerei.website.utils.db.*,com.jerehnet.util.common.*,com.jerei.website.utils.*,org.apache.commons.fileupload.servlet.*" pageEncoding="UTF-8"%><%@page import="org.apache.commons.fileupload.FileItemFactory"%><%@page import="org.apache.commons.fileupload.disk.DiskFileItemFactory"%><%@page import="java.io.BufferedInputStream"%><%@page import="org.apache.commons.fileupload.FileItem"%>
<%@page import="com.alibaba.fastjson.JSONObject"%><%
	String method = CommonString.getFormatPara(request.getParameter("method"));
	String path = request.getContextPath();
	if("single_upload".equals(method)){
	System.out.println("sdfdddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd");
