...
define(function(require, exports, module) {
	...
	$.fn.scroll = function(config) {
		var opt = {
			...
			cells = $this.find(opt.wrap).addClass('slide_wrap').find(opt.cell).addClass('slide_c'),
		...
		if(cells.length < showNumber + opt.step){ 
			...
			console.log('scroll.js: "'+$this.attr('class')+'" cannot scroll.')	
			return $this;
		};
