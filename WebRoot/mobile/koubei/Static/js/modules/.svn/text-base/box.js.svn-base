...
define(function(require, exports, module) {
   var $ = require('$');
	...
	var WRAP = '<div id="boxBlank" onselectstart="return false;"></div>' + '<div class="wrap_out" id="wrapOut">' + '<div class="wrap_in" id="wrapIn">' + '<div id="wrapBar" class="wrap_bar" onselectstart="return false;">' + '<h4 id="wrapTitle" class="wrap_title"></h4>' + '<div class="wrap_close"><a href="javasctipt:" id="wrapClose" title="关闭"></a></div>' + '</div>' + '<div class="wrap_body" id="wrapBody"></div>' + '</div>' + '</div>';
	...
	$.extend($.box, {
		...
		hide: function() {
			if ($.o.ele && $.o.out.size() && $.o.out.css("display") !== "none") {
				$.o.out.fadeOut(function(){$(this).remove()});
		...
		confirm: function(message, sureCall, cancelCall, options) {
			var element = $('<div class="wrap_remind">' + message + '<p><button id="SureBtn" class="submit_btn">确认</button>&nbsp;&nbsp;<button id="CancelBtn" class="cancel_btn">取消</button></p></div>');
			$.box(element, options);
			//回调方法
		...
		alert: function(message, callback, options) {
			var element = $('<div class="wrap_remind">' + message + '<p><button id="SubmitBtn" class="submit_btn">确认</button</p></div>');
			$.box(element, options);
