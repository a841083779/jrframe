...
<div class="dl_area_list dl_sele fix">
  ...
  <div class="dl_sele_r_ls" id="area00">
    ...
    <div class="dl_sele_r_ls" id="area1">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=101-101"><span></span>全省</a></li>
      </ul>
    </div>
    <div class="dl_sele_r_ls" id="area2">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=102-102"><span></span>全省</a></li>
      </ul>
    </div>
    <div class="dl_sele_r_ls" id="area3">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=103-103"><span></span>全省</a></li>
      </ul>
    </div>
    <div class="dl_sele_r_ls" id="area4">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=104-104"><span></span>全省</a></li>
      </ul>
    </div>
    <div class="dl_sele_r_ls" id="area5">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=105-105"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area6">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=106-106"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area7">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=107-107"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area8">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=108-108"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area9">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=109-109"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area10">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=110-110"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area11">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=111-111"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area12">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=112-112"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area13">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=113-113"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area14">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=114-114"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area15">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=115-115"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area16">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=116-116"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area17">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=117-117"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area18">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=118-118"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area19">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=119-119"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area20">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=120-120"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area21">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=121-121"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area22">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=122-122"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area23">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=123-123"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area24">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=124-124"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area25">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=125-125"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area26">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=126-126"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area27">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=127-127"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area28">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=128-128"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area29">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=129-129"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area30">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=130-130"><span></span>全省</a></li>
    ...
    <div class="dl_sele_r_ls" id="area31">
      <ul>
	   <li><a href="agent_list.jsp?<%=url%>&city=131-131"><span></span>全省</a></li>
