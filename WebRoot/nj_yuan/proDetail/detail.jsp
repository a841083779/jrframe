...
<title>【三一SY60C-9挖掘机(钩机)】三一SY60C-9挖掘机(钩机)价格表_参数_图片_口碑 - 铁臂商城</title>
<meta name="keywords" content="三一SY60C-9挖掘机,三一SY60C-9挖掘机价格表,三一SY60C-9挖掘机参数,三一SY60C-9挖掘机图片,三一SY60C-9挖掘机口碑" />
<meta name="description" content="铁臂商城为您提供三一SY60C-9挖掘机价格,参数,性能,图片,口碑等信息,帮助您通过网络订购三一SY60C-9挖掘机,买三一SY60C-9挖掘机就上铁臂商城。" />
<meta name="author" content="design by www.21-sun.com">
<meta name="mobile-agent" content="format=html5;url=http://m.21-sun.com/product/proDetail/SY60C-9(2013K).htm">
<script type="text/javascript" src="../Static/app/mobile.js"></script>
<script type="text/javascript">uaredirect("http://m.21-sun.com/product/proDetail/SY60C-9(2013K).htm");</script>
...
<div class="wrap fix n_top">
  <h1 class="new_logo">
    <a href="/" title="铁臂商城">
      <img src="../Static/images/logo.png" alt="铁臂商城">
      <span class="columnName">农机</span>
    </a>
  </h1>
  <div class="n_topSearch">
    ...
    <button onClick="tj()" type="button" class="topBtn">搜索</button>
    <div class="n_hotwords">
      <span>热门搜索：</span>
      <a href="" target="_blank">拖拉机</a>
      <a href="" target="_blank">耕整地机械</a>
      <a href="" target="_blank">种植施肥机械</a>
      <a href="" target="_blank">收割/收获机</a>
      <a href="" target="_blank">农产品加工机械</a>
      <a href="" target="_blank">运输</a>
    </div>
  </div>
  <script>
  	  function tj3(){ 
  ...
  <div class="navBar">
    <div class="wrap fix">
      <ul class="menu">
        <li><a href="">首页</a></li>
        <li><a href="">拖拉机</a></li>
        <li><a href="">耕整地机械</a></li>
        <li><a href="">种植施肥机械</a></li>
        <li><a href="">收割/收获机</a></li>
        <li><a href="">农产品加工机械</a></li>
        <li><a href="">运输机械</a></li>
      </ul>
      <div class="allCates">
...
<div class="breadCrumbs">
  <div class="wrap fix">我的位置： 
    <a href="/">农机首页</a><em>&gt;&gt;</em>
    <a href="/products/">拖拉机</a><em>&gt;&gt;</em>
    <a href="/products/prolist.jsp?catalog=101001"> 轮式拖拉机 </a><em>&gt;&gt;</em>
    雷沃M1204-C7A轮式拖拉机
  </div>
 </div>
<!--面包屑 end-->
...
<div class="wrap">
  <div class="pro_dt">
    <div class="pro_dt_p1 fix">
      <div class="_img">
        <img onerror="this.src='/uploadfiles/no_big.gif'"  src="../images/detailProPic/1.jpg" alt="三一SY60C-9挖掘机" >
      </div>
      <div class="_info">
        <div class="tdlp_trnr">
          <h2 class="tdlp_dtitle">三一SY60C-9挖掘机</h2>
          <div class="s_shuzhi">
           <p>雷沃M1204-C7A轮式拖拉机：配套雷沃动力增压发动机，性能先进，动力强劲；可选装玉柴增压发动机，增加配套动力多样性，满足不同用户需求；动力排放升级、性能升级雷沃M1204-C7A轮式拖拉机：配套雷沃动力增压发动机，性能先进，动力强劲；可选装玉柴增压发动机，增加配套动力多样性，满足不同用户需求；动力排放升级、性能升级</p>
          </div>
          <div class="tdlp_score">网友平均评分 <span id="totalScoreId">87.5</span> 分&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a style="font-weight:normal"  href="/proDetail/SY60C-9(2013K)_message.shtm#position" class="_more"  >查看评论(<span id="koubei_top">15</span>条)</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a style="font-weight:normal;color:#fe6000"  href="javascript:void(0)"  onclick="writeKoubei('三一','SY60C-9','挖掘机','18534')" class="_btn">我要评论</a> </div>
          <div class="fix">
          <a  style="float:left" href="javascript:void(0)"  id="xjbox_display"><img src="../Static/images/xunjia.gif" /></a>
          <a style="float:left; margin-left:6px;" target="_blank" href="javascript:void(0)"><img class="bds_more" data-cmd="more" src="../Static/images/femxiang.gif"></a>
          </div>
          <div class="tdlp_dtip">因不同地区代理商及价格差异，请您点击<span><a href="javascript:void(0)" onClick="showinquery('18534','')">咨询最低价</a></span>。</div>
          <div class="tdlp_doht fix"> <span class="tdo_t1">品牌：<i><a title="三一" href='/products/prolist.jsp?factory=133' target='_blank'>三一</a></i></span> <span class="tdo_t2">类别：<i><a title="三一挖掘机/属具" href="/products/prolist.jsp?factory=133&catalog=101001">三一挖掘机/属具</a></i></span> </div>
        </div>
      </div>
    </div>
    <div class="pro_dt_left_box">
      <div class="_bt">更多型号</div>
      <div class="xh_sel fix" >
        <ul class="_list">
          <li><a href="">SY16C</a></li>
          <li><a href="">SY35U</a></li>
          <li><a href="">SY55C-9</a></li>
          <li><a href="">SY65C-9</a></li>
          <li><a href="">SY75C-9</a></li>
          <li><a href="">SY85C-9</a></li>
          <li><a href="">SY95C-9</a></li>
          <li><a href="">SY115C-9</a></li>
          <li><a href="">SY135C-9</a></li>
          <li><a href="">SY155C-9</a></li>
          <li><a href="">SY195C-9</a></li>
          <li><a href="">SY205C-9</a></li>
          <li><a href="">SY215C-9</a></li>
          <li><a href="">SY225C-9</a></li>
          <li><a href="">SY235C-9</a></li>
          <li><a href="">SY245C9</a></li>
          <li><a href="">SY265C-9</a></li>
          <li><a href="">SY285C9</a></li>
          <li><a href="">SY305C-9H</a></li>
          <li><a href="">SY335C-9H</a></li>
          <li><a href="">SY365H-9</a></li>
          <li><a href="">SY385H-9</a></li>
          <li><a href="">SY465H-9</a></li>
          <li><a href="">SY485H-9</a></li>
          <li><a href="">SY700H-8</a></li>
          <li><a href="">SY850H-8</a></li>
        </ul>
      </div>
    </div>
    <!--性能-->
    <div class="pro_dt_left_box target_section"> <span id="xingn" class="maod"></span>
      <div class="_bt">三一SY60C-9性能</div>
      <div class="xn_text"> <p style="margin-bottom:21px;"><strong>·&nbsp;节能环保：</strong>欧Ⅱ标准环保发动机，采用全新控制器实时精确控制燃油喷射，燃油燃烧更充分，在效率相当的情况下较上一代降低油耗更低；</p><p style="margin-bottom:21px;"><strong>·&nbsp;高效持久：</strong>采用独创的DOMCS动态寻优智能匹配控制系统，实现了发动机与主泵的完美匹配，最大程度的利用发动机的输出功率，动作更迅速，工作更持久；</p><p style="margin-bottom:21px;"><strong>·&nbsp;稳定可靠：</strong>配置符合中国国情的挖掘机专用大功率发动机，适应力更强，整机性能更稳定；</p><p style="margin-bottom:21px;"><strong>·&nbsp;人性化设计：</strong>全新设计的减震系统，超大视野驾驶室，多重降噪设计，极大提高操作舒适性。</p> <br>
      </div>
    </div>
    <!--性能 end-->
    <!--询价-->
    <div class="txd_plant fix"> <span id="xunjia" class="maod"></span>
      <div class="tpl_title">三一SY60C-9询价</div>
    </div>
    <div class="txd_xunjia mt15" id="prodetailOrder">
      <div class="txj_lant">非常欢迎您选择三一SY60C-9挖掘机，我们诚恳的希望您详细填写如下信息，以便我们的服务专员与您联系。</div>
      <div class="txj_main fix">
      ...
      <div class="_form">
          <form action="../action/detail_order_save.jsp" method="post" name="theform" id="theform"  >
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
                ...
                <td><input class="txj_inp" name="zd_name" type="text" id="zd_name" size="30" maxlength="20" />
                  <input class="input01" id="zds_ifgroup" name="zds_ifgroup" type="radio" checked="checked" value="个人" />
                  <font color="#434343">个人</font>
                  <input class="input01" id="zds_ifgroup" name="zds_ifgroup" type="radio"  value="公司" />
                  <font color="#434343">公司</font></td>
              </tr>
              <tr>
            ...
            <input name="zd_factoryid" type="hidden" id="zd_factoryid" value="133" />
            <input name="zd_product_id" type="hidden" id="zd_product_id" value="18534"/>
            <input name="zd_factoryname" type="hidden" id="zd_factoryname" value="三一"/>
            <input name="zd_product_name" type="hidden" id="zd_product_name" value="SY60C-9"/>
            <input name="zd_message" type="hidden" id="zd_message" value="您好，我对三一SY60C-9挖掘机感兴趣，想要咨询，请您给我回复，谢谢。" />
        ...
        <div class="_xjlist">
          <div class="_hd">Hi,最近有<span id="inquiry_bottom"></span>个用户已经询价了，<br>
            三一SY60C-9挖掘机</div>
          <div class="_bd">
            <ul id="inquiry_list">


<li><a href="http://product.21-sun.com/inquiry/detail_for_677275.htm" target="_blank">2016-04-21云南红河州的 刘*** 询：SY60C-9</a></li><li><a href="http://product.21-sun.com/inquiry/detail_for_677131.htm" target="_blank">2016-04-21湖南郴州市的 龙*** 询：SY60C-9</a></li><li><a href="http://product.21-sun.com/inquiry/detail_for_677117.htm" target="_blank">2016-04-21湖南郴州市的 龙*** 询：SY60C-9</a></li><li><a href="http://product.21-sun.com/inquiry/detail_for_677030.htm" target="_blank">2016-04-21陕西渭南市的 张*** 询：SY60C-9</a></li><li><a href="http://product.21-sun.com/inquiry/detail_for_676928.htm" target="_blank">2016-04-21河南濮阳市的 齐*** 询：SY60C-9</a></li></ul>
          </div>
        </div>
      </div>
    </div>
...
<div class="z_pf">
  <ul>
    <li><a href="#"><img src="../Static/images/gotop.jpg"></a></li>
  </ul>
</div>
<!--foot zeng-->
<!--foot-->
...
<div class="j_bottom">
  <div class="wrap fix">
    <div class="j_bottom_left l">
	  ...
	  <span class="New_links" onclick="window.open('http://www.21-sun.com/contact/');">联系客服</span>
    </div>
...
<!--询价对比开始-->
<!--xjbox-->
<div class="xjbox" id="xjbox">
  <h2>在线询价</h2>
  <span class="close" id="closebox">【关闭】</span>
  <label>想了解<span>SY60C-9</span>最低价？<br>
    请填写如下信息：</label>
  <form action="../action/save.jsp" method="post" name="theform_right" id="theform_right" >
    <ul>
      <li>
        <div class="left"><span>您怎么称呼：</span></div>
        <div class="right">
          <input class="name" type="text"  id="jr_name" name="jr_name"/>
        </div>
      </li>
      <li>
        <div class="left"><span>您的电话号：</span></div>
        <div class="right">
          <input class="name" type="tel"  id="jr_mobile_phone" name="jr_mobile_phone" />
        </div>
      </li>
      <li>
        <div class="left"><span>您在的省份：</span></div>
        <div class="right">
          <select class="xj_select" id="tr_province" name="tr_province" >
            <option value="" area_id="">--请选择--</option>
            <option value="101800" area_id="101800">安徽</option>
            <option value="105499" area_id="105499">北京</option>
            <option value="142000" area_id="142000">福建</option>
            <option value="128000" area_id="128000">广东</option>
            <option value="113000" area_id="113000">广西</option>
            <option value="134000" area_id="134000">甘肃</option>
            <option value="132000" area_id="132000">贵州</option>
            <option value="106400" area_id="106400">河北</option>
            <option value="122000" area_id="122000">黑龙江</option>
            <option value="124000" area_id="124000">湖北</option>
            <option value="126000" area_id="126000">湖南</option>
            <option value="130000" area_id="130000">河南</option>
            <option value="141500" area_id="141500">海南</option>
            <option value="103100" area_id="103100">江西</option>
            <option value="110900" area_id="110900">江苏</option>
            <option value="119000" area_id="119000">吉林</option>
            <option value="120000" area_id="120000">辽宁</option>
            <option value="109700" area_id="109700">内蒙古</option>
            <option value="116000" area_id="116000">宁夏</option>
            <option value="133000" area_id="133000">青海</option>
            <option value="105290" area_id="105290">上海</option>
            <option value="100110" area_id="100110">山东</option>
            <option value="108300" area_id="108300">山西</option>
            <option value="139000" area_id="139000">四川</option>
            <option value="135500" area_id="135500">陕西</option>
            <option value="105689" area_id="105689">天津</option>
            <option value="117000" area_id="117000">新疆</option>
            <option value="115000" area_id="115000">西藏</option>
            <option value="137000" area_id="137000">云南</option>
            <option value="104200" area_id="104200">浙江</option>
            <option value="105879" area_id="105879">重庆</option>
          </select>
        </div>
      </li>
      <li>
        <div class="left"><span>您在的城市：</span></div>
        <div class="right">
          <select class="xj_select" id="jr_city" name="jr_city">
    ...
    <input name="jr_province" type="hidden" id="jr_province" value="" />
    <input name="tag" type="hidden" id="tag" value="3" />
    <input name="jr_factoryid" type="hidden" id="jr_factoryid" value="133" />
    <input name="jr_product_id" type="hidden" id="jr_product_id" value="18534"/>
    <input name="jr_factoryname" type="hidden" id="jr_factoryname" value="三一"/>
    <input name="jr_product_name" type="hidden" id="jr_product_name" value="SY60C-9"/>
    <input name="jr_message" type="hidden" id="jr_message" value="您好，我对三一SY60C-9挖掘机感兴趣，想要咨询，请您给我回复，谢谢。" />
    <input type="hidden" name="jr_contact_address" id="jr_contact_address" value="" />
    <input type="hidden" name="jr_cataname" id="jr_cataname" value="挖掘机" />
    <input type="hidden" name="jr_catanum" id="jr_catanum" value="101001001"/>
    <input type="hidden" name="tableName" id="tableName" value="pro_product_form"/>
    <input type="hidden" name="jr_ifgroup" id="jr_ifgroup" value="个人"/>
    <input type="hidden" name="jr_is_first" id="jr_is_first" value="1"/>
    <input type="hidden" name="jr_other_message" id="jr_other_message" value=""/>
    <input type="hidden" name="jr_referer" id="jr_referer" value="http://product.21-sun.com/proDetail/SY60C-9(2013K).shtm"/>
    <button type="button" onClick="submitYNS();">获取最低价</button>
  </form>
</div>
<script src="../Static/app/move.js"></script>
<script> 
	//询价下拉菜单
	define("select_down",function(require,exports,module) {
		var $ = require('jquery');
  ...
  $('#tr_province').select({
		...
		jQuery("#jr_province").val(txt) ;
      	$.ajax({
			url : '/tools/ajax.jsp',
			async : false,
			type : 'post',
			data : {
				flag : 'detail_get_city',
				p : val
			},
			success : function(data){
			   $("#jr_city").html(data);
   ...
   seajs.use("select_down");
   //询价浮动
   var h=$('.j_topBar').height();
   $(window).scroll(function(){
	   var scrolls=$(window).scrollTop();
	   if(scrolls>h){
		   $('#xjbox').addClass('xjbox_');
		   }else{
			   $('#xjbox').removeClass('xjbox_');
			   }
	});
</script>
<script>
//询价插件
  ...
  $('#xjbox').css('width',function(){
	  return (viewWidth-1200)/2+285;
	  });
  $('#cmpContainer').css('width',function(){
	  return (viewWidth-1200)/2+285;
	  });
  $('.empty').css('margin-left',function(){
	  return $('#cmpContainer').width()/2+85;
	  });
  $('#xjbox').find('button').css('margin-left',function(){
	  return ($('#xjbox').width()-200)/2;
	  });
	 
  $('#xjbox_display').click(function(){
	  $('.xjbox').css('display','block');
	  $('.xjbox').animate({'right':0},300);
	  });
  $('#closebox').click(function(){
	  $('.xjbox').animate({'right':-500},300,function(){
...
<script src="../scripts/echarts/dist/echarts-all.js"></script>
<script type="text/javascript" src="../scripts/prodetail.js"></script>
<script type="text/javascript">
	//获取产品得分和星星 
	function getAllComment(){
		jQuery.getJSON("../action/ajax.jsp?flag=get_all_comment&callback=?&pid=18534",function(data){
	...
	jQuery.ajax({
		url:"../action/ajax.jsp",
		type:"post",
		data:{"id":"18534","flag":"viewCount","tableName":"pro_products"},
		success:function(data){
		}
	});
	//获取评论数
	jQuery.ajax({
		url:"../action/ajax.jsp",
		type:"post",
		data:{"id":"18534","flag":"commentCount"},
		success:function(data){
	...
	jQuery.ajax({
		url:"../action/ajax.jsp",
		type:"post",
		data:{"id":"18534","flag":"inquiryCount"},
		success:function(data){
			jQuery("#inquiry_bottom").html($.trim(data));
		}
	});
	...
	jQuery.ajax({
		url:"../action/ajax.jsp",
		type:"post",
		data:{"id":"18534","flag":"inquiry_list"},
		success:function(data){
