   ...
   DBHelper dbHelper = DBHelper.getInstance() ;
	...
	try{
			...
			if(koubeilist != null && koubeilist.size() > 0){
				...
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_wwj_koubei.htm");
			}
			 //装载机口碑
			...
			if(koubeilist != null && koubeilist.size() > 0){
				root.put("list",koubeilist);
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_zzj_koubei.htm");
			}
			 //起重机口碑
			...
			if(koubeilist != null && koubeilist.size() > 0){
				root.put("list",koubeilist);
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_qzj_koubei.htm");
			}
			 //混凝土口碑
			...
			if(koubeilist != null && koubeilist.size() > 0){
				root.put("list",koubeilist);
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_hnt_koubei.htm");
			}
			...
			if(koubeilist != null && koubeilist.size() > 0){
				root.put("list",koubeilist);
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_ttj_koubei.htm");
			}
			//叉车口碑
			...
			if(koubeilist != null && koubeilist.size() > 0){
				root.put("list",koubeilist);
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_cc_koubei.htm");
			}
			//压路机口碑
			...
			if(koubeilist != null && koubeilist.size() > 0){
				root.put("list",koubeilist);
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_ylj_koubei.htm");
			}
			//筑路机械口碑
			...
			if(koubeilist != null && koubeilist.size() > 0){
				root.put("list",koubeilist);
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_zljx_koubei.htm");
			}
			//地下矿山机械口碑
			...
			if(koubeilist != null && koubeilist.size() > 0){
				root.put("list",koubeilist);
				freemarkerUtils.generate("index_page/index_koubei.htm",root,realPath+"index_new/index_page/index_ksjx_koubei.htm");
			}
