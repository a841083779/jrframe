	...
	try{
		...
		Map root1 = new HashMap();
			...
			if(list != null && list.size() > 0){
				root.put("list",list);
				freemarkerUtils.generate("agent_page/products_agent_catalog.htm",root,realPath+"include/agent/products_agent_catalog.htm");
				resule="true";
			}
			...
			String catalogNum="";
			   catalogNum=CommonString.getFormatPara(brand.get("num"));
				...
				if(list != null && list.size() > 0&&list1 != null && list1.size() > 0&&list2 != null && list2.size() > 0){
					...
					freemarkerUtils.generate("agent_page/products_agent_brand.htm",root,realPath+"include/agent/products_agent_brand_"+catalogNum+".htm");
					resule="true";
				}
		    }
				...
				if(list != null && list.size() > 0&&list1 != null && list1.size() > 0&&list2 != null && list2.size() > 0){
					...
					root.put("list2",list2);
					freemarkerUtils.generate("agent_page/products_agent_brand.htm",root,realPath+"include/agent/products_agent_brand_0.htm");
					resule="true";
				}
	}catch(Exception e){
		e.printStackTrace();
