...
// 生成所有的品牌详显页
	...
	String agentSql="select  id,usern,name,full_name,city,address,intro,logo,img1,agent_fac,agent_fac_name,parent_id,lng,lat,is_made,is_qijiandian from  pro_agent_factory where is_show=1 and agent_fac!=''  and  flag = 2   and id='"+zd_id+"' order by id asc";
