...
<%
	...
	Map root = null;
	 ...
	 //List<Map> list = dbHelper.getMapList(" select * from pro_products where is_show = 1 and file_name is not null and id>=20992 and id<21042") ; 
           ...
           List<Map> list = dbHelper.getMapList(" select * from pro_products where  file_name!=''  and  add_date>='2014-09-25' and add_date<='2014-09-29'  and add_user='wangxin'  and file_name is not null order by id asc") ;			
