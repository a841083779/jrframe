...
<%
	...
	try{
		...
		Map root1 = new HashMap();
			...
			//本条产品信息
			list = dbHelper.getMapList(" select  top 200 id,factoryid,factoryname,catalognum,catalogname,img1,img2,introduce,file_name,view_count,param,catalognum_new,instruments,is_show,tonandmeter,name  from pro_products where  is_show =1  and factoryid= 14261    order by id  asc  ");
