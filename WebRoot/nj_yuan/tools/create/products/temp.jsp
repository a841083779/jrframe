...
<%
	...
	try{
		...
		Map root1 = new HashMap();
			...
			//本条产品信息
			list = dbHelper.getMapList(" select  * from pro_products where   id=8140 or id=103 or id=21009    order by id  asc  ");
			...
			FreemarkerUtils freemarkerUtils = new FreemarkerUtils(absPath+"/template/");
				...
				//freemarkerUtils.generate("/proDetail_temp/detail_xunjia.shtm", root, createName6 ,request);
				...
				//freemarkerUtils.generate("/proDetail_temp/detail_video.shtm", root, createName8 ,request);
				
				root.put("pageFlag",pageFlag9);
				//freemarkerUtils.generate("/proDetail_temp/detail_story.shtm", root, createName9 ,request);
				
				root.put("pageFlag",pageFlag10);
				//freemarkerUtils.generate("/proDetail_temp/detail_manual.shtm", root, createName10 ,request);
				
				root.put("pageFlag",pageFlag11);
				//freemarkerUtils.generate("/proDetail_temp/detail_weixiu.shtm", root, createName11 ,request);
				
				root.put("pageFlag",pageFlag12);
				//freemarkerUtils.generate("/proDetail_temp/detail_shouhou.shtm", root, createName12 ,request);
