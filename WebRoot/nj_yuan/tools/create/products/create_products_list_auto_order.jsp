...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	...
	String resule="false";
	String sql="";String sql1="";String sql2="";String sql3="";String sql4="";String sql5="";
	try{
		List <Map>list = null;
		List <Map>list1 = null;
		List <Map>list2 = null;
		...
		roots.put("title","产品列表页订单生成") ;
		roots.put("content","产品列表页订单生成");
		String srt=Common.doPost("http://service.21-sun.com/http/utils/sendmail.jsp", roots) ;
	   } catch (Exception e) {}
			  
				sql = "select  catanum as num  from pro_product_form where CONVERT(varchar(100), add_date, 23)=CONVERT(varchar(100), GETDATE(), 23)  and catanum!='' group by catanum  order by catanum   desc";//类别
				...
				sql3 = "select factoryid as id  from pro_product_form where CONVERT(varchar(100), add_date, 23)=CONVERT(varchar(100), GETDATE(), 23) and factoryid !='' group by factoryid  order by factoryid   desc";//品牌
