...
<%
	...
	List list = dbHelper.getMapList("  select * from pro_product_form where product_id not in (20440,20472,20735) and catanum!='101001004'  and (is_success != 1 or is_success is null) and add_date > '"+yesTime+"' and add_date < '"+thisTime+"'  ");
