...
DBHelper dbHelper = null;
	String sql = "", message = "", result = "",requestIp="",flag="";
	...
	connection = dbHelper.getConnection();
		...
		if ("login".equals(message)) {
			...
			if (memberInfo != null) {
				...
				%>
						<script>
					  	alert("成功登录！");
						//window.location.href='http://m.koubei.21-sun.com/index_activity.jsp';
						window.location.href='http://product.21-sun.com//mobile/photo/index.jsp';
						</script>
						<%}else{
						//关闭连接池
				        DBHelper.freeConnection(connection);
						...
						<script>
					  	...
					  	alert("成功登录！");
						window.location.href='http://m.koubei.21-sun.com/';
						</script>
						<%}%>
						<%} else {
						//关闭连接池
		...
		if ("regist".equals(message)) {
				...
				if(r>0){
						...
						<script>
						alert("注册成功！");
						window.location.href="http://product.21-sun.com/mobile/photo/";
						</script>
						<%
