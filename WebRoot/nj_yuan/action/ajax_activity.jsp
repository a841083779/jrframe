...
<%
	 ...
	 try{
		...
		if("107001".equals(sort_num)){
              ...
              html+="<li class='last'><a href='/mobile/photo/index_list.jsp?catalog=107001'   class='img'><img src='./web/img/more.png'></a></li></ul>";
		...
		//产品图片
              ...
              html+="<li class='last'><a href='/mobile/photo/index_list.jsp?catalog=107002'   class='img'><img src='./web/img/more.png'></a></li></ul>";
			  out.print(html.toString());
		//施工图片
              ...
              html+="<li class='last'><a href='/mobile/photo/index_list.jsp?catalog=107003'   class='img'><img src='./web/img/more.png'></a></li></ul>";
			  out.print(html.toString());
		//维修图片
              ...
              html+="<li class='last'><a href='/mobile/photo/index_list.jsp?catalog=107004'   class='img'><img src='./web/img/more.png'></a></li></ul>";
			  out.print(html.toString());
		//展会图片
              ...
              html+="<li class='last'><a href='/mobile/photo/index_list.jsp?catalog=107005'   class='img'><img src='./web/img/more.png'></a></li></ul>";
			  out.print(html.toString());
		...
		//趣味图片
              ...
              html+="<li class='last'><a href='/mobile/photo/index_list.jsp?catalog=107006'   class='img'><img src='./web/img/more.png'></a></li></ul>";
			  out.print(html.toString());
		}else{
		  //所有类别
