...
<%@page import="java.net.URLEncoder"%><%
	...
	try{
		...
		for(String pid : productIds){
			...
			Object[] paras = { uuid, Common.getIp(request), "cat_pt", CommonDate.getToday("yyyy-MM-dd HH:mm:ss"), zd_name, zd_mobile_phone, zd_factoryid, zd_factoryname, zd_province, zd_city, zd_contact_address, zd_ifgroup, zd_is_first, zd_message, pid, zd_product_name, zd_catanum, zd_cataname };
