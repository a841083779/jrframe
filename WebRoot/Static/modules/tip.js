...
define('tip',function(require, exports, module) {
	...
	$.fn.tip = function(tip, config) {
		...
		!$("#boxBlank").size() && $('<div id="boxBlank" onselectstart="return false" />').appendTo('body');
		$('#boxBlank').css('opacity',opt.opacity);
		...
		$(this).each(function(i, e) {
			...
			show = function() {
				...
				opt.modal && $('#boxBlank').height($(window).height());
