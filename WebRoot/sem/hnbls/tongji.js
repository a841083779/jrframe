...
{
	var unit_id     = "2245714";
	var client_ip   = "119.188.50.8";
	var server_time = "1375406446";
	var verify_code = "28ce253a";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="http://js.tongji.linezing.com/2245714/tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2245714/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
