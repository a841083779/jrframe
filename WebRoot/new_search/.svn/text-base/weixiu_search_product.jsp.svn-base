  ...
  <div class="w757 r">
    ...
    <div class="nseresult_pro pic_searchval">
      ...
      <div class="rp clearfix mb10 nwx_zxlist repairList border0">
        ...
        <div class="_img" style=" width:160px; margin-right:20px;">
        	<img src="http://product.21-sun.com/uploadfiles//image/2013/12/20131230133024_910.jpg" title="卡特彼勒318DL重型应用液压挖掘机" alt="卡特彼勒318DL重型应用液压挖掘机">
        </div>
        <div class="_detail pro_weixiu">
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
            	<tbody>
                <tr>
                <td colspan="2" class="n">卡特彼勒318DL重型应用液压挖掘机</td>
                </tr>
                <tr>
                	<th style="text-align:left"><strong>配置：</strong></th>
                    <td>
                    	<a onclick="vote('waiguandafang');" style="cursor:pointer;"><span class="_cell">外观大方(<span id="num_waiguandafang">2</span>)</span></a>
                    	<a onclick="vote('caozuoshushi');" style="cursor:pointer;"><span class="_cell">操作舒适(<span id="num_caozuoshushi">0</span>)</span></a>
                    	<a onclick="vote('youhaodi');" style="cursor:pointer;"><span class="_cell">油耗低(<span id="num_youhaodi">1</span>)</span></a>
						<a onclick="vote('dongliqiangjin');" style="cursor:pointer;"><span class="_cell">动力强劲(<span id="num_dongliqiangjin">1</span>)</span></a>
                    </td>
                </tr>
            	<tr>
                	<th style="text-align:left"><strong>优势：</strong></th>
                    <td>
                    	<a onclick="vote('caozuojianbian');" style="cursor:pointer;"><span class="_cell">操作简便(<span id="num_caozuojianbian">0</span>)</span></a>
                    	<a onclick="vote('xingnengzhuoyue');" style="cursor:pointer;"><span class="_cell">性能卓越(<span id="num_xingnengzhuoyue">1</span>)</span></a>
                    	<a onclick="vote('jienenghuanbao');" style="cursor:pointer;"><span class="_cell">节能环保(<span id="num_jienenghuanbao">1</span>)</span></a>
                    	<a onclick="vote('guzhangludi');" style="cursor:pointer;"><span class="_cell">故障率低(<span id="num_guzhangludi">1</span>)</span></a>
						<a onclick="vote('shouhoufuwu');" style="cursor:pointer;"><span class="_cell">售后服务体系保障(<span id="num_shouhoufuwu">1</span>)</span></a>
                    </td>
                </tr>
            	<tr>
                	<th style="text-align:left"><strong>其它：</strong></th>
                    <td>
                    	<a onclick="vote('jishouzuiai');" style="cursor:pointer;"><span class="_cell">机手最爱(<span id="num_jishouzuiai">1</span>)</span></a>
						<a onclick="vote('baoyangbianjie');" style="cursor:pointer;"><span class="_cell">保养便捷(<span id="num_baoyangbianjie">0</span>)</span></a>
                    	<a onclick="vote('kuanchangshushi');" style="cursor:pointer;"><span class="_cell">宽敞舒适(<span id="num_kuanchangshushi">1</span>)</span></a>
                    	<a onclick="vote('zaoyindi');" style="cursor:pointer;"><span class="_cell">噪音低(<span id="num_zaoyindi">1</span>)</span></a>
                    </td>
                </tr>
            </tbody></table>            
        </div>
