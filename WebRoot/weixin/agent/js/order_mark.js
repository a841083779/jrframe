	...
	function pullupRefresh() {
		...
		success: function(json){
			...
			$.each(order, function(idx) {
				...
				html += '<div class="info fix"><a href="order_detail.jsp?id='+id+'&source='+source+'&ywId='+$('#uid').val()+'&province='+$('#province_items').find('input:checked').data('value')+'&orderState='+$('#status_items').find('input:checked').data('value')+'"><div class="info_main l">';
				...
				html += '<a href="order_detail.jsp?id='+id+'&source='+source+'&ywId='+$('#uid').val()+'&province='+$('#province_items').find('input:checked').data('value')+'&orderState='+$('#status_items').find('input:checked').data('value')+'" class="r confirm_btn">'+orderStatename+'</a></div>';
				html += '</li>';
