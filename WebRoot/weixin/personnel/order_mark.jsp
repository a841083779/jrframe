...
<html>
	...
	<body class="order_tracking">
		...
		<div class="status_choose hide">
			...
			<div id="status_items" class="cho_items">
				...
				<div class="item">
					<input type="radio" name="status" data-value='102008' <%if("102008".equals(orderState)){ out.print("checked"); }%>/><label>成交</label>
				</div>
				<div class="item">
					<input type="radio" name="status" data-value='102009' <%if("102009".equals(orderState)){ out.print("checked"); }%>/><label>流失</label>
				</div>
			</div>
		...
		<div class="recieve pa hide">
			<p class="msg">订单已标记星标，请在星标列表中查看详情！</p>
	...
	<!--页面单独js-->
	<script src="js/order_mark.js" type="text/javascript" charset="utf-8"></script>
