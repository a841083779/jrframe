...
%>
    <%if(catalog.equals("0")&&factory.equals("0")){%>
          ...
          <li class="top3"> <em>3</em>
            <h4><a title="<%=name%>代理商" href="http://dealer.21-sun.com/" target="_blank"><%=name%>代理商</a></h4>
          </li>
          <li> <em>4</em>
    ...
    <%} if(!catalog.equals("0")&&factory.equals("0")){%>
          ...
          <li class="top3"> <em>3</em>
            <h4><a title="<%=name%>代理商" href="http://dealer.21-sun.com/0_0_0_<%=catalog%>_0.shtm" target="_blank"><%=name%>代理商</a></h4>
          </li>
          <li> <em>4</em>
             
        
			<h4><a title="<%=name%>口碑" href="http://koubei.21-sun.com/<%=catalog%>-0-0.htm" target="_blank"><%=name%>口碑</a></h4>
          </li>
          <li> <em>5</em>
    ...
    <%} if(!factory.equals("0")&&catalog.equals("0")){%>
          ...
          <li class="top3"> <em>3</em>
            <h4><a title="<%=name%>代理商" href="http://dealer.21-sun.com/0_0_<%=factory%>_0_0.shtm" target="_blank"><%=name%>代理商</a></h4>
          </li>
          <li> <em>4</em>
            <h4><a title="<%=name%>口碑" href="http://koubei.21-sun.com/0-0-<%=factory%>.htm" target="_blank"><%=name%>口碑</a></h4>
          </li>
          <li> <em>5</em>
	...
	<%}if(!factory.equals("0")&&!catalog.equals("0")){%>
	      <li class="top3"> <em>1</em>
            <h4><a title="<%=name.replace("卡特彼勒","卡特")%>型号大全" href="http://product.21-sun.com/products/prolist.jsp?factory=<%=factory%>&catalog=<%=catalog%>" target="_blank"><%=name.replace("卡特彼勒","卡特")%>型号大全</a></h4>
          </li>
          <li class="top3"> <em>2</em>
            <h4><a title="<%=name.replace("卡特彼勒","卡特")%>图片" href="http://photo.21-sun.com/list.jsp?factory=<%=factory%>&catalog=<%=catalog%>" target="_blank"><%=name.replace("卡特彼勒","卡特")%>图片</a></h4>
          </li>
          <li class="top3"> <em>3</em>
            <h4><a title="<%=name.replace("卡特彼勒","卡特")%>代理商" href="http://dealer.21-sun.com/0_0_<%=factory%>_<%=catalog%>_0.shtm" target="_blank"><%=name.replace("卡特彼勒","卡特")%>代理商</a></h4>
          </li>
          <li> <em>4</em>
            <h4><a title="<%=name.replace("卡特彼勒","卡特")%>口碑" href="http://koubei.21-sun.com/<%=catalog%>-0-<%=factory%>.htm" target="_blank"><%=name.replace("卡特彼勒","卡特")%>口碑</a></h4>
          </li>
          <li> <em>5</em>
            <h4><a title="<%=name.replace("卡特彼勒","卡特")%>实拍大全" href="http://video.21-sun.com/video_873_<%=factory%>_<%=catalog%>_1.htm" target="_blank"><%=name.replace("卡特彼勒","卡特")%>实拍大全</a></h4>
          </li>
          <li> <em>6</em>
		  
            <h4><a title="<%=name.replace("卡特彼勒","卡特")%>专栏" href="http://spec.21-sun.com/list-<%=catalog.substring(0,3)%>-<%=catalog.length()>=6?catalog.substring(0,6):"0"%>-<%=catalog.length()>6?catalog:"0"%>-0-<%=factory%>-0.htm" target="_blank"><%=name.replace("卡特彼勒","卡特")%>专栏</a></h4>
			
          </li>
          <li> <em>7</em>
            <h4><a title="<%=name.replace("卡特彼勒","卡特")%>动态" href="http://news.21-sun.com/list/spec_<%=factory%>-<%=catalog%>-1.htm" target="_blank"><%=name.replace("卡特彼勒","卡特")%>动态</a></h4>
          </li>
          <li> <em>8</em>
            <h4><a title="<%=name.replace("卡特彼勒","卡特")%>排行榜" href="http://top.21-sun.com/pro_0_0_0_<%=factory%>_<%=catalog%>_0.htm" target="_blank"><%=name.replace("卡特彼勒","卡特")%>排行榜</a></h4>
          </li>
	<%}%>
</cache:cache>