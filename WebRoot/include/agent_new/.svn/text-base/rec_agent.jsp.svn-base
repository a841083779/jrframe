...
<%
	...
	agentsList = dbHelper.getMapList(" select top 8 usern,is_qijiandian,is_made,full_name from pro_agent_factory where flag = 2 and is_show=1 order by view_count desc") ;
%>
    <%
