...
%>
   <div class="w757 r np_right mb10">
    ...
    <div class="np_plist_gslist">
        ...
        <li>
            	<h2><a href="/case/detail_for_<%=CommonString.getFormatPara(m.get("id")) %>.htm""><%=CommonString.getFormatPara(m.get("title")) %></a></h2>
                ...
                <div class="gs_list_more"><a href="/case/detail_for_<%=CommonString.getFormatPara(m.get("id")) %>.htm">阅读全文</a></div>
       </li>
