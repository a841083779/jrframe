...
<%
	if(!"".equals(factoryid)){
		whereStr = "where is_deleted=0 and factoryid = "+factoryid+" and product_name is not null and product_name != ''" ;
		...
		ordersList = dbHelper.getMapList(" select top 10 id,factoryname,cataname,name,mobile_phone,contact_tel,contact_address,product_name,add_date from pro_product_form  "+whereStr+" order by id desc ") ;
...
<div class="w755 border03 l mb10 list08">
  <div class="title12">
    <h3><%=factoryname %>产品订单</h3>
    <span><a href="/inquiry/0_0_<%=factoryid %>_0_0.shtm" target="_blank">更多&gt;&gt;</a></span> </div>
  <div class="title08">
    <h3><b>询价总数：<%=total %></b> - 采购询价</h3>
    <span>共有<font><%=total %></font>个符合条件</span> </div>
  <ul class="ti">
    <li class="i1">编号</li>
    <li class="i2">询价产品</li>
    <li class="i3">联系人</li>
