...
<%
	...
	String sql = " select top 10 id,province,city,name,factoryname,cataname,product_name from pro_product_form where "+whereStr+" order by add_date desc ";
