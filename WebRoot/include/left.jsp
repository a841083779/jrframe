...
<div class="leftTab">
  <ul>
    <li <%if(url.equals("/products/prolist.jsp")){%>class="ltcur"<%}%>><a href="http://product.21-sun.com/products/prolist.jsp">产品</a></li>
    <li <%if(url.equals("/list.jsp")){%>class="ltcur"<%}%>><a href="http://photo.21-sun.com/">图片</a></li>
    <li <%if(url.equals("/inquiry/")){%>class="ltcur"<%}%>><a href="http://product.21-sun.com/inquiry/">订单</a></li>
  </ul>
</div>
