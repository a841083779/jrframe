...
<div class="topbg mb10">
  <div class="top contain980">
      ...
      <ul class="news_topSearch">
        <form id="top_search" name="top_search" method="get" action="http://sowa.21-sun.com/" onsubmit="if(jQuery('#keyword').val()==''){alert('请输入您要搜索的关键词');jQuery('#keyword').focus();return false;}" target="_blank">
          ...
          <%
          	...
          	%><input type="hidden" name="f" value="supply" /><%
          	}else{
    ...
    <div class="topHot" id="topHot" style="display: none;">
      <ul class="thl">
        <li><img src="/images/tu1.png" width="260" height="80" alt="产品中心优买团" onclick="window.open('/tuan/');" style="cursor:pointer" /></li>
        <li><img src="/images/tu3.png" width="260" height="80" alt="产品中心数据分析" onclick="window.open('http://data.21-sun.com/');" style="cursor:pointer" /></li>
  ...
  <div class="nav contain980">
	...
	jQuery("#topHot").hover(function(){clearInterval(t)}, function(){t = setInterval("showAuto()", 11000);});
    ...
    <ul class="navlist">
      ...
      <li style="position:relative;" id="top_8"><a href="/news/">行情▪导购</a><img src="/images/new_ico.gif" width="23" height="11" style="position:absolute; right:5px; top:-5px;" /></li>
