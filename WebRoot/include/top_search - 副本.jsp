 ...
 <div style="width: 205px; float: left; padding-top: 15px; padding-left: 9px;">
    ...
    <div class="new_topMid">
      <ul class="news_topSearch">
          ...
          <li class="ntsi">
            <input type="text" name="keyword" id="keyword" maxlength="30" value="<%=keyword%>" onKeyDown="tj2();"/>
          </li>
          <li class="ntsb">
	  ...
	  <a href="/search/挖掘机_0_0_0.htm"><b>挖掘机</b></a> 
	  <a href="/search/装载机_0_0_0.htm">装载机</a> 
	  <a href="/search/起重机_0_0_0.htm">起重机</a> 
	  <a class="link09"  href="/search/卡特彼勒挖机_0_0_0.htm"> 卡特彼勒挖机</a> </div>
    </div>
    <div class="topHot">
  ...
  <div class="nav contain980">
    ...
    <ul class="navlist">
      ...
      <li id="top_6"><a href="http://product.21-sun.com/top_list/">排行榜</a></li>
