...
<div class="topbg mb10">
  ...
  <div class="mingren_nav">
  	<ul class="np_fix contain980">
        ...
        <li id="top_2"><a href="/list/">企业名人</a></li>
        <li id="top_3"><a href="/fclist/">名人风采</a></li>
        <li id="top_4"><a href="/ftlist/">名人访谈</a></li>
    </ul>
  </div>
</div>
<%
...
<script language="javascript" type="text/javascript">
	...
	if(thisUrl.indexOf("/list/") >= 0){
		jQuery("#top_2").addClass("cur");	
	}else if(thisUrl.indexOf("fclist") >= 0){
		jQuery("#top_3").addClass("cur");	
	}else if(thisUrl.indexOf("ftlist") >= 0){
