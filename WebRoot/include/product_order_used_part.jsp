<%@page contentType="text/html;charset=utf-8" import="java.sql.Connection,com.jerehnet.util.common.*,com.jerehnet.util.dbutil.*,java.util.*" %><% 
	...
	String proname="";
	if(pro.equals("used01")){proname="临工LG685二手挖掘机";}
	if(pro.equals("used02")){proname="沃尔沃EC290BLC二手挖掘机";}
	if(pro.equals("used03")){proname="小松PC240LC-8二手挖掘机";}
	if(pro.equals("used04")){proname="小松PC200-3二手挖掘机";}
	
	if(pro.equals("part01")){proname="卡特312D GC-RXZ";}
	if(pro.equals("part02")){proname="卡特3.5寸斗齿";}
	if(pro.equals("part03")){proname="广州骏之隆EX200-3";}
	if(pro.equals("part04")){proname="斗山柱塞和泵胆";}
	if(pro.equals("part05")){proname="卡特铲斗";}
	if(pro.equals("part06")){proname="卡特液压油先导过滤器";}
	if(pro.equals("part07")){proname="卡特链轨-45节";}
	if(pro.equals("part08")){proname="斗山主泵";}
...
<%=proname%>在线询价<!--<font style="color:grey">（成功询价后，我们会24小时之内与您联系！）</font>--></div>
<div class="orderbg" style="margin:5px 0px 0px 10px;">
  ...
  <form action="/action/order_save_used_part.jsp" method="post" name="theform" id="theform" onSubmit="return submitYN(this);">
     ...
     <td><select name="zd_province" id="zd_province" onChange="set_my_city(this);" style="width:87px;"  dataType="Require"  msg="请选择省份">
      ...
      <tr>
        ...
        <td height="22"  style="padding-top:5px; padding-left:10px;">
		 ...
		 <input type="hidden" name="zd_proname" id="zd_proname" value="<%=proname%>"/>
...
<script type="text/javascript">
jQuery("#zd_message").text("您好，我对<%=proname%>感兴趣，想要咨询，请您给我回复，谢谢。");
jQuery("#zd_proname").value("<%=proname%>");
