...
<div class="topLinks">
  <div class="contain980">
	...
	<%
    	if(!username.equals("")){
    %>
    	欢迎您，<%=username %>！<a href="javascript:void(0);" onclick="logout()">【退出】</a>
    <%		
    	}
    %>
...
<div class="topbg mb10">
 ...
 <div style="width:220px; float: left; padding-top: 15px; padding-left: 9px;">
    ...
    <div class="new_topMid">
	  ...
	  <a class="link09"  href="/search/卡特彼勒挖机_0_0_0.htm" target="_blank"> 卡特彼勒挖机</a> </div>    </div>
    <div class="topHot">
      <div><img src="/images/tel_0728.png" width="176" height="46" alt="4006-521-526" /></div>
      <div class="link"><a href="http://product.21-sun.com/tuan/" target="_blank">进入优买团</a><a href="http://product.21-sun.com/activity/yingxiaobao/" target="_blank">加入订单宝</a></div>
    </div>
  </div>
  <div class="nav contain980">
    ...
    <div class="bigBtn"> <span class="btname" title="全部产品分类">全部产品分类</span> 
    ...
    <ul class="navlist">
      <li id="top_1"><a href="http://product.21-sun.com/">首页</a></li>
      <li id="top_2"><a href="http://product.21-sun.com/products/">产品大全</a></li>
      <li id="top_3"><a href="http://product.21-sun.com/brand/">品牌大全</a></li>
      <li id="top_8"><a href="http://product.21-sun.com/news/">行情▪导购</a></li>
      <li id="top_9" style="position:relative;"><a href="http://koubei.21-sun.com/" style="color:#f8454b!important;" target="_blank">口碑</a><img src="/images/new_ico.gif" width="23" height="11" style="position:absolute; right:5px; top:-5px;" /></li>
      <li id="top_4"><a href="http://product.21-sun.com/inquiry/">采购询价</a></li>
      <li id="top_5"><a href="http://photo.21-sun.com/">图库</a></li>
      <li id="top_6"><a href="http://top.21-sun.com/">排行榜</a></li>
      <li id="top_7"><a href="http://product.21-sun.com/agent/">代理商</a></li>
    </ul>
  </div>
</div>
<%
