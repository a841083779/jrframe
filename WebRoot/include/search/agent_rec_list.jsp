...
<cache:cache cron="* * */1 * *">
  <div class="rp clearfix mb10 nwx_zxlist repairList border05  mt10">
    <div class="title" style="border-right:1px solid #ccc;border-bottom:1px solid #ccc;">
      <h3 style="color:#000;">代理商推荐</h3>
    </div>
    <div class="content r_add">
      <div class="agent_list border0">
        <ul class="fix">
<%
       List<Map> list = dbHelper.getMapList("select top 4 id,logo,name,usern,full_name,address,city,agent_fac_name,agent_fac,telphone from pro_agent_factory where logo<>'' and is_show=1 and flag=2 order by is_shop desc,flag ASC , name DESC , id DESC");
