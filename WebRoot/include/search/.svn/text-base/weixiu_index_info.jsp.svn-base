...
%>
    <div class="rp clearfix mb10 nwx_zxlist repairList border0 mt10">
        <div class="title border04">
          <h3>维修知识</h3>
          <a style=" float:right; padding-right:25px;" target="_blank"  href="/<%=keywordCheck%>_info_0_0_0_0_0.htm">更多</a> </div>
		...
		%>
            ...
            <li>
			  ...
			  <a  target="_blank" href="http://weixiu.21-sun.com/knowledge/" title="维修知识" style="color: #ff6600">[维修知识]</a> </span> 
			  <a target="_blank" href="http://weixiu.21-sun.com/info_<%=id%>.htm" title="<%=title%>"><%=title%></a></h3>
