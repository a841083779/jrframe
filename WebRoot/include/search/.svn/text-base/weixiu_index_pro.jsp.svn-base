...
%>
    <div class="rp clearfix mb10 nwx_zxlist repairList border0 mt10">
        <div class="title border04">
          <h3>产品维修</h3>
          <a style=" float:right; padding-right:25px;" target="_blank"  href="/<%=keywordCheck%>_pro_0_0_0_0_0.htm">更多</a> </div>
		...
		%>
            ...
            <li>
			  ...
			  <a  target="_blank" href="http://weixiu.21-sun.com/knowledge/" title="产品维修" style="color: #ff6600">[产品维修]</a> </span> 
			  <a target="_blank" href="http://weixiu.21-sun.com/pro_<%=id%>.htm" title="<%=title%>"><%=title%></a></h3>
