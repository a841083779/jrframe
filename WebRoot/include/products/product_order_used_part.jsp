<%@page contentType="text/html;charset=utf-8" import="java.sql.Connection,com.jerehnet.util.common.*,com.jerehnet.util.dbutil.*,java.util.*" %><% 
	...
	if(pro.equals("used01")){pro="临工LG685二手挖掘机";}
	if(pro.equals("used02")){pro="沃尔沃EC290BLC二手挖掘机";}
	if(pro.equals("used03")){pro="小松PC240LC-8二手挖掘机";}
	if(pro.equals("used04")){pro="小松PC200-3二手挖掘机";}
	
	if(pro.equals("part01")){pro="卡特312D GC-RXZ";}
	if(pro.equals("part02")){pro="卡特3.5寸斗齿";}
	if(pro.equals("part03")){pro="广州骏之隆EX200-3";}
	if(pro.equals("part04")){pro="斗山柱塞和泵胆";}
	if(pro.equals("part05")){pro="卡特铲斗";}
	if(pro.equals("part06")){pro="卡特液压油先导过滤器";}
	if(pro.equals("part07")){pro="卡特链轨-45节";}
	if(pro.equals("part08")){pro="斗山主泵";}
...
<%=pro%>在线询价<!--<font style="color:grey">（成功询价后，我们会24小时之内与您联系！）</font>--></div>
     ...
     <td><select name="zd_province" id="zd_province" onChange="set_my_city(this);" style="width:87px;"  dataType="Require"  msg="请选择省份">
      ...
      <tr>
        ...
        <td height="22"  style="padding-top:5px; padding-left:10px;">
		 ...
		 <input type="hidden" name="zd_pro" id="<%=pro%>"/>
...
<script type="text/javascript">
jQuery("#zd_message").text("您好，我对<%=pro%>感兴趣，想要咨询，请您给我回复，谢谢。");
