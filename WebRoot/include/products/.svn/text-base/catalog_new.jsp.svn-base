...
%>
          <div class="pllist">
            <a href="<%=url%>?catalog=101" class="plfl" target="_top"> <strong style="color:#3355AC"> 土方机械</strong> </a> <br/>                
             ...
             <a href="<%=url%>?catalog=101001" target="_top"> 挖掘机 </a>
			   <a href="<%=url%>?catalog=101002008" target="_top"> 挖掘装载机(两头忙) </a>
             ...
             <div class="pllist">
            <a href="<%=url%>?catalog=101001" class="plfl" target="_top"> <strong style="color:#3355AC"> 挖掘机械</strong> </a> <br/> 
             <a href="<%=url%>?catalog=101001001" target="_top"> 履带式挖掘机 </a>			
             ...
             <a href="<%=url%>?catalog=101001&tonandmeter=grab_1_13" target="_top"> 小挖(1T～13T) </a>
             <a href="<%=url%>?catalog=101001&tonandmeter=grab_14_30" target="_top"> 中挖(14T～30T) </a>
             <a href="<%=url%>?catalog=101001&tonandmeter=grab_30_1" target="_top"> 大挖(30T以上) </a>
          ...
          <div class="pllist">
            <a href="<%=url%>?catalog=103" class="plfl" target="_top"><strong style="color:#3355AC"> 混凝土机械</strong> </a> <br/>                
             <a href="<%=url%>?catalog=103001" target="_top"> 泵车 </a>
			 <a href="<%=url%>?catalog=103017" target="_top"> 车载泵 </a>
			 <a href="<%=url%>?catalog=103018" target="_top"> 拖泵/输送泵 </a>
			 <a href="<%=url%>?catalog=103019" target="_top"> 混凝土搅拌车 </a>
             <a href="<%=url%>?catalog=103002" target="_top"> 混凝土搅拌站/楼 </a>
			 <a href="<%=url%>?catalog=103002001" target="_top"> 搅拌机 </a>
			 <a href="<%=url%>?catalog=103005002" target="_top"> 布料机/布料杆 </a>
             <a href="<%=url%>?catalog=103009" target="_top"> 粉粒物料运输车 </a>
             <a href="<%=url%>?catalog=103012" target="_top"> 干粉砂浆生产设备 </a>
             <a href="<%=url%>?catalog=103008" target="_top"> 干混砂浆背罐车 </a>
			 <a href="<%=url%>?catalog=103010" target="_top"> 喷湿机 </a>
             <a href="<%=url%>?catalog=103015" target="_top"> 其它混凝土设备 </a>
             
      </div>       
          <div class="pllist">
            <a href="<%=url%>?catalog=104010" class="plfl" target="_top"><strong style="color:#3355AC"> 路面机械 </strong></a> <br/>                
	   ...
	   <div class="pllist">
            <a href="<%=url%>?catalog=104" class="plfl" target="_top"><strong style="color:#3355AC">  养护机械 </strong></a> <br/>                
          ...
          <div class="pllist">
            <a href="<%=url%>?catalog=107" class="plfl" target="_top"> <strong style="color:#3355AC"> 叉车</strong> </a> <br/>             
             ...
             <a href="<%=url%>?catalog=107002" target="_top"> 其他种类叉车 </a>
      </div> 
          <div class="pllist">
          ...
          <div class="pllist">
            <a href="<%=url%>?catalog=111" class="plfl" target="_top"><strong style="color:#3355AC">  港口机械</strong> </a> <br/>                
             ...
             <a href="<%=url%>?catalog=111004" target="_top"> 港口起重机 </a>
             <a href="<%=url%>?catalog=111008" target="_top"> 海工装备 </a>
			 <a href="<%=url%>?catalog=111003" target="_top"> 吊具 </a>
             <a href="<%=url%>?catalog=111009" target="_top"> 其他港口机械 </a>
      </div>       
          <div class="pllist">
          ...
          <div class="pllist">
			...
			<a href="<%=url%>?catalog=118001" target="_top"> 半挂车 </a>
			<a href="<%=url%>?catalog=118005" target="_top"> 油罐车 </a>
			<a href="<%=url%>?catalog=118006" target="_top"> 化工液体运输车 </a>
			 <a href="<%=url%>?catalog=118007" target="_top"> 冷藏车 </a>
			  <a href="<%=url%>?catalog=103015" target="_top"> 水泥运输车 </a>
			   <a href="<%=url%>?catalog=118009" target="_top"> 厢式车 </a>
          ...
          <div class="pllist">
            <a href="<%=url%>?catalog=119" class="plfl" target="_top"><strong style="color:#3355AC">  煤炭机械</strong> </a> <br/>                
             <a href="<%=url%>?catalog=119002" target="_top"> 采煤机 </a>
			 <a href="<%=url%>?catalog=119005" target="_top"> 输送机 </a>
			 <a href="<%=url%>?catalog=119001" target="_top"> 其他煤炭机械 </a>
      </div>       
    <div class="pllist">
            <a href="<%=url%>?catalog=104002010" class="plfl" target="_top"><strong style="color:#3355AC">  环卫机械</strong> </a> <br/>                
             <a href="<%=url%>?catalog=104002008" target="_top"> 清扫机 </a>
			 <a href="<%=url%>?catalog=104002007" target="_top"> 洒水车 </a>
			 <a href="<%=url%>?catalog=104002002" target="_top"> 垃圾车 </a>
			 <a href="<%=url%>?catalog=104002011" target="_top"> 其他环卫机械 </a>
      </div>     