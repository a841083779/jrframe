...
<div class="orderbg" style="margin:5px 0px 0px 10px; position:relative; padding-bottom:60px;">
  ...
  <form action="/action/order_save.jsp" method="post" name="theform" id="theform" onSubmit="return submitYN(this);">
    <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="list_border_bg">
      <tr>
        <th height="22" align="right" nowrap="nowrap" class="list_left_title" style="padding:5px 0px;">您的姓名：</th>
       ...
       <tr>
        ...
        <td nowrap="nowrap" class="list_cell_bg"><input class="input01" name="zd_mobile_phone" type="text" id="zd_mobile_phone" size="30" maxlength="15" />
          * <span style="font-size:12px; color:#666;">提交后收到最低价短信</span></td>
      </tr>
      <tr>
	 ...
	 <input type="hidden" name="source" id="source" value="<%=source %>" />
      ...
      <tr>
        <td height="30" colspan="4"><input class="btn02" name="Submit" type="submit" value=" "/></td>
      </tr>
    </table>
  </form>
  <div class="tc_agent_rec">
    ...
    <div class="t_bd">
      <ul>
        <li>
          ...
          <div class="box">
            <div class="bo1"><font color="red">4S店</font>-烟台荣和丰田 <span class="tip">(提交询价后会立即收到最低价短信)</span></div>
            <div class="bo2">地址：烟台市福山区上庄工业园北京南路8号</div>
          </div>
        </li>
      </ul>
    </div>
