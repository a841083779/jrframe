...
<%   
	...
	String sql = " select top 15 file_name,name,factoryname,catalogname,img2,view_count,factoryid from pro_products where catalognum_new like '"+catalog+"%' and is_show = 1 order by view_count desc ";
