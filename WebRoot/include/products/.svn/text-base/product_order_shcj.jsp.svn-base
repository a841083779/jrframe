...
<div class="orderbg" style="margin:5px 0px 0px 10px;">
  ...
  <form action="/action/order_save_shcj.jsp" method="post" name="theform" id="theform" onSubmit="return submitYN(this);">
     ...
     <td><select name="zd_province" id="zd_province" onChange="set_my_city(this);" style="width:87px;"  dataType="Require"  msg="请选择省份">
      ...
      <tr>
        ...
        <!--   <input name="zd_id" type="hidden" id="zd_id" value="0" />  -->
          ...
          <input name = "zd_factoryname" type="hidden" id="zd_factoryname" value="上海成基"/>
          <input name = "zd_product_name" type="hidden" id="zd_product_name" value="<%=proName%>"/>
		   <input name = "zd_product_name" type="hidden" id="zd_product_name" value="<%=proName%>"/>
