...
<div class="top">
  <div class="wrapper clearfix">
    <h1 class="logo l"><img src="images/logo_sany.jpg" alt="三一" width="244" height="59" /></h1>
  ...
  <div class="formbg png">
    ...
    <table width="385" border="0" cellspacing="0" cellpadding="0" class="formTable">
      ...
      <tr>
		...
		<input type="hidden" name="zd_product_id" id="zd_product_id" value="7208"/>
		<input type="hidden" name="zd_product_name" id="zd_product_name" value="SY75C-9"/>
