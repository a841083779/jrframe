...
<div class="topbg mb10">
  ...
  <div class="nav contain980">
    ...
    <ul class="navlist">
      <li id="top_1" class="cur"><a href="/products/list_param.jsp">参数</a></li>
      <li id="top_1"><a href="/products/list_message.jsp">口碑</a></li>
      <li id="top_1"><a href="/products/list_pic.jsp">图片</a></li>
      <li id="top_1"><a href="/products/list_tech.jsp">维修</a></li>
      <li id="top_1"><a href="/products/list_video.jsp">实拍</a></li>
      <li id="top_3"><a href="/products/list_story.jsp">品牌故事</a></li>
    </ul>
  </div>
</div>
<%
