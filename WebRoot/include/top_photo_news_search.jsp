...
<div class="topLinks">
  <div class="contain980" >
	...
	<%}else{%>
    	...
    	<div style="float: left;line-height: 31px;">欢迎您，<a  href="javascript:void(0)"  onclick="goTO();" ><%=username %></a>！<a href="javascript:void(0);" onclick="loginOut()">【退出】</a></div>
...
function loginOut(){
	jQuery.ajax({
      ...
      <div class="hotWords">热门搜索： <a href="/挖掘机_0_0_0_0.htm" target="_blank"><b>挖掘机</b></a> 
	  <a href="/装载机_0_0_0_0.htm" target="_blank">装载机</a> 
	  <a href="/search/起重机_0_0_0_0.htm" target="_blank">起重机</a> 
	  <a class="link09"  href="/卡特彼勒挖机_0_0_0_0.htm" target="_blank"> 卡特彼勒挖机</a> </div>
    </div>
