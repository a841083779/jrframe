<%@ tag body-content="empty" import="java.util.*,java.sql.*,com.jerehnet.util.common.*" pageEncoding="UTF-8" %><%@ attribute name="pageBean" required="true" rtexprvalue="true" type="com.jerehnet.util.dbutil.PageBean" %><%@ attribute name="url" required="false" rtexprvalue="true" type="java.lang.String" %><%
	...
	if(pageBean.getTotal() > 0 && pageBean.getPageCount()>1){ // 2012年12月26日13:23:35 改
		if(pageBean.getNowPage()==1 ){
			...
			pageBar.append("<a class='pre noPre' title='上一页' href='/" + ""+catalog + "-" + ((preInt-1)*pageBean.getPageSize()) +"-"+factory +".htm'></a>") ;
		}
	}
	if (pageBean.getNowPage() > 1) {
	} else {
		...
		if (middle <= 5 && middle < rightCount) {
			for(int i=0;i<5;i++){
				if((i+1)==pageBean.getNowPage()){
					...
					pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ (i*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(i+1)+"&nbsp;</a>");
				}
			}
			if(middle==5){
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog +"-"+ ((5)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+6+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog +"-"+ ((6)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+7+"&nbsp;</a>");
			}
			pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
			pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((pageBean.getPageCount()-2)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(pageBean.getPageCount()-1)+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((pageBean.getPageCount()-1)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(pageBean.getPageCount())+"&nbsp;</a>");
		}else if( middle > 5 && middle > rightCount){
			pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((1-1)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+1+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((2-1)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+2+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
			if(middle==(rightCount+1)){
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((middle-2-1)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(middle-2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((middle-1-1)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(middle-1)+"&nbsp;</a>");
			}
			for(int i = rightCount;i<(pageBean.getPageCount());i++){
				...
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((2-1)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+2+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((middle-3)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(middle-2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((middle-2)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(middle-1)+"&nbsp;</a>");
				pageBar.append("<span class=\"current\"><b>&nbsp;"+middle+"&nbsp;</b></span>");
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((middle)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(middle+1)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog + "-"+ ((middle+1)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(middle+2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog +"-"+ ((pageBean.getPageCount()-2)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(pageBean.getPageCount()-1)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + ""+catalog +"-"+ ((pageBean.getPageCount()-1)*pageBean.getPageSize()) + "-"+factory +".htm\">&nbsp;"+(pageBean.getPageCount())+"&nbsp;</a>");
		}
	...
	if (pageBean.getNowPage() <= (pageBean.getPageCount()-1)) {
			pageBar.append("<a href='/" + ""+catalog +"-"+ ((nextInt-1)*pageBean.getPageSize()) + "-"+factory +".htm' class='next'></a>");
	} else {
		pageBar.append(" ");
	}
	pageBar.append("</div>") ;
