...
<%  
	...
	if(total> 0 && totalPage>1){ // 2012年12月26日13:23:35 改
		if(nowPage==1 ){
			...
			pageBar.append("<a class='pre noPre' title='上一页' href='/"+keyword+"_" +factory+"_"+catalog+"_"+preInt+".htm'></a>") ;
		}
	}
	if (nowPage > 1) {
	} else {
		...
		if (middle <= 5 && middle < rightCount) {
			for(int i=0;i<5;i++){
				if((i+1)==nowPage){
					...
					pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+(i+1)+".htm"+"\">&nbsp;"+(i+1)+"&nbsp;</a>");
				}
			}
			if(middle==5){
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((5)+1)+".htm"+"\">&nbsp;"+6+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((6)+1)+".htm"+"\">&nbsp;"+7+"&nbsp;</a>");
			}
			pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
			pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((totalPage-2)+1)+".htm"+"\">&nbsp;"+(totalPage-1)+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((totalPage-1)+1)+".htm"+"\">&nbsp;"+(totalPage)+"&nbsp;</a>");
		}else if( middle > 5 && middle > rightCount){
			pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((1-1)+1)+".htm"+"\">&nbsp;"+1+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((2-1)+1)+".htm"+"\">&nbsp;"+2+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
			if(middle==(rightCount+1)){
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((middle-2-1)+1)+".htm"+"\">&nbsp;"+(middle-2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((middle-1-1)+1)+".htm"+"\">&nbsp;"+(middle-1)+"&nbsp;</a>");
			}
			for(int i = rightCount;i<(totalPage);i++){
					if((i+1)==nowPage){
						pageBar.append("<span class=\"current\"><b>&nbsp;"+(i+1)+"&nbsp;</b></span>");
					}else{
						//pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+(i+1)+".htm"+"\" onclick=\"getAgentList("+(i+1)+",\"search\");\">&nbsp;"+(i+1)+"&nbsp;</a>");
					}
				}
			} else {
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((1-1)+1)+".htm"+"\">&nbsp;"+1+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((2-1)+1)+".htm"+"\">&nbsp;"+2+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((middle-3)+1)+".htm"+"\">&nbsp;"+(middle-2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((middle-2)+1)+".htm"+"\">&nbsp;"+(middle-1)+"&nbsp;</a>");
				pageBar.append("<span class=\"current\"><b>&nbsp;"+middle+"&nbsp;</b></span>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((middle)+1)+".htm"+"\">&nbsp;"+(middle+1)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((middle+1)+1)+".htm"+"\">&nbsp;"+(middle+2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((totalPage-2)+1)+".htm"+"\">&nbsp;"+(totalPage-1)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\""+url+"/"+keyword+"_" +factory+"_"+catalog+"_"+((totalPage-1)+1)+".htm"+"\">&nbsp;"+(totalPage)+"&nbsp;</a>");
		}
	...
	if (nowPage <= (totalPage-1)) {
			pageBar.append("<a href='/"+url+keyword+"_" +factory+"_"+catalog+"_"+((nextInt-1)+1)+".htm' class='next'></a>");
	} else {
		pageBar.append(" ");
	}
	pageBar.append("</div>") ;
