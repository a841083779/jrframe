<%@ tag body-content="empty" import="java.util.*,java.sql.*,com.jerehnet.util.common.*" pageEncoding="UTF-8" %><%@ attribute name="pageBean" required="true" rtexprvalue="true" type="com.jerehnet.util.dbutil.PageBean" %><%@ attribute name="url" required="false" rtexprvalue="true" type="java.lang.String" %><%
	...
	if(pageBean.getTotal() > 0 && pageBean.getPageCount()>1){ // 2012年12月26日13:23:35 改
		if(pageBean.getNowPage()==1 ){
			...
			pageBar.append("<a class='pre noPre' title='上一页' href='/" + catalog + "-" + factory +"-"+  ((preInt-1)*pageBean.getPageSize()) + ".htm'></a>") ;
		}
	}
	if (pageBean.getNowPage() > 1) {
	} else {
		...
		if (middle <= 5 && middle < rightCount) {
			for(int i=0;i<5;i++){
				if((i+1)==pageBean.getNowPage()){
					...
					pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + (i*pageBean.getPageSize()) + ".htm\">&nbsp;"+(i+1)+"&nbsp;</a>");
				}
			}
			if(middle==5){
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((5)*pageBean.getPageSize()) + ".htm\">&nbsp;"+6+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((6)*pageBean.getPageSize()) + ".htm\">&nbsp;"+7+"&nbsp;</a>");
			}
			pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
			pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((pageBean.getPageCount()-2)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(pageBean.getPageCount()-1)+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((pageBean.getPageCount()-1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(pageBean.getPageCount())+"&nbsp;</a>");
		}else if( middle > 5 && middle > rightCount){
			pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-"+ ((1-1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+1+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory+"-"  + ((2-1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+2+"&nbsp;</a>");
			pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
			if(middle==(rightCount+1)){
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((middle-2-1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(middle-2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory  +"-"+ ((middle-1-1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(middle-1)+"&nbsp;</a>");
			}
			for(int i = rightCount;i<(pageBean.getPageCount());i++){
					if((i+1)==pageBean.getNowPage()){
						pageBar.append("<span class=\"current\"><b>&nbsp;"+(i+1)+"&nbsp;</b></span>");
					}else{
						pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + (i*pageBean.getPageSize()) + ".htm\" onclick=\"getAgentList("+(i+1)+",\"search\");\">&nbsp;"+(i+1)+"&nbsp;</a>");
					}
				}
			} else {
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((1-1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+1+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-"+ ((2-1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+2+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory+"-"  + ((middle-3)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(middle-2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((middle-2)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(middle-1)+"&nbsp;</a>");
				pageBar.append("<span class=\"current\"><b>&nbsp;"+middle+"&nbsp;</b></span>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((middle)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(middle+1)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((middle+1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(middle+2)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"javascript:void(0);\" style=\"cursor: default;border:none;color:#000;\">...</a>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory+"-" + ((pageBean.getPageCount()-2)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(pageBean.getPageCount()-1)+"&nbsp;</a>");
				pageBar.append("<a class=\"num\" href=\"/" + catalog + "-" + factory +"-" + ((pageBean.getPageCount()-1)*pageBean.getPageSize()) + ".htm\">&nbsp;"+(pageBean.getPageCount())+"&nbsp;</a>");
		}
	...
	if (pageBean.getNowPage() <= (pageBean.getPageCount()-1)) {
			pageBar.append("<a href='/" + catalog + "-" + factory +"-" + ((nextInt-1)*pageBean.getPageSize()) + ".htm' class='next'></a>");
	} else {
		pageBar.append(" ");
	}
	pageBar.append("</div>") ;
