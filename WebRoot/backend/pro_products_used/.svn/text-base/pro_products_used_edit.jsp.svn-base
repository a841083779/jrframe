...
<%
	...
	String tableName = "pro_products_used";
	try{
  ...
  <div class="formDiv">
    ...
    <div class="formRight">
      <input type="text" class="jr_text" name="zd_catalogname" id="zd_catalogname" value="<%=CommonString.getFormatPara(model.get("catalogname")) %>" style="width:270px" />
		...
		<div style="clear:left;"></div>
    		<div class="formLeft">新旧类型</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_old" id="zd_old" value="<%=CommonString.getFormatPara(model.get("old")) %>" />
   			 </div>
    		<div class="formLeft">新旧程度</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_deep" id="zd_deep" value="<%=CommonString.getFormatPara(model.get("deep")) %>" />
   			 </div>
   			 <div style="clear:left;"></div>
    		<div class="formLeft">地区</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_place" id="zd_place" value="<%=CommonString.getFormatPara(model.get("place")) %>" />
   			 </div>
   			
   			 <div class="formLeft">设备来源</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_source" id="zd_source" value="<%=CommonString.getFormatPara(model.get("source")) %>" />
   			</div>
   			<div style="clear:left;"></div>
   			 <div class="formLeft">吨位/马力</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_weight" id="zd_weight" value="<%=CommonString.getFormatPara(model.get("weight")) %>" />
   			</div>
   			 
   			 <div class="formLeft">当前状态</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_condition" id="zd_condition" value="<%=CommonString.getFormatPara(model.get("condition")) %>" />
   			 </div>
   			 <div style="clear:left;"></div>
   			 <div class="formLeft">设备报价</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_price" id="zd_price" value="<%=CommonString.getFormatPara(model.get("price")) %>" />
   			</div>
   			 
   			 <div class="formLeft">工作小时</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_worktime" id="zd_worktime" value="<%=CommonString.getFormatPara(model.get("worktime")) %>" />
   			 </div>
   			 <div style="clear:left;"></div>
   			 <div class="formLeft">产地</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_origin" id="zd_origin" value="<%=CommonString.getFormatPara(model.get("origin")) %>" />
   			 </div>
    		<div class="formLeft">生产年份</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_birth_year" id="zd_birth_year" value="<%=CommonString.getFormatPara(model.get("birth_year")) %>" />
   			 </div>
   			 <div style="clear:left;"></div>
   			  <div class="formLeft">地址</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_address" id="zd_address" value="<%=CommonString.getFormatPara(model.get("address")) %>" />
   			 </div>
   			  <div class="formLeft">联系人</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_contact_user" id="zd_contact_user" value="<%=CommonString.getFormatPara(model.get("contact_user")) %>" />
   			 </div>
   			 <div style="clear:left;"></div>
   			  <div class="formLeft">联系人电话</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_phone" id="zd_phone" value="<%=CommonString.getFormatPara(model.get("phone")) %>" />
   			 </div>
   			 <div class="formLeft">序列号</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_number" id="zd_number" value="<%=CommonString.getFormatPara(model.get("number")) %>" />
   			 </div>
   			 <div style="clear:left;"></div>
   			  <div class="formLeft">浏览次数</div>
  		    <div class="formRight">
      		<input type="text" class="jr_text" style="width:100%;" name="zd_view_count" id="zd_view_count" value="<%=CommonString.getFormatPara(model.get("view_count")) %>" />
   			 ...
   			 <div style="clear:left;"></div>
    		<div class="formLeft">有无发票</div>
    		 <div class="formRight"> <%=CommonForm.createIsRadio(CommonString.getFormatPara(model.get("invoice")),"zd_invoice") %> </div>
   			
   			<div class="formLeft">有无合格证</div>
    		 <div class="formRight"> <%=CommonForm.createIsRadio(CommonString.getFormatPara(model.get("warranty")),"zd_warranty") %> </div>
   
   			
    		<div class="formLeft">有无大修</div>
   			 <div class="formRight"> <%=CommonForm.createIsRadio(CommonString.getFormatPara(model.get("rest")),"zd_rest") %> </div>
...
<span class="groupTitle">拓展信息</span>
  ...
  <input type="hidden" name="zd_lastvisitedate" id="zd_lastvisitedate"  value="<%=CommonDate.getToday("yyyy-MM-dd HH:mm:ss") %>"/>
</form>
</body>
</html>
