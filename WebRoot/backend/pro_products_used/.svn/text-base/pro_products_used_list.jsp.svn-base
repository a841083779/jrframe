<%@ page language="java" import="java.util.*,com.jerehnet.util.common.*" pageEncoding="UTF-8"%><%
	...
	String fileds = "id,add_date,factoryname,catalogname,name,img2,is_show,lastvisitedate";
...
<script type="text/javascript"><!--
   ...
   { display : 'ID', name : 'id', align : 'left' , type : 'string' , width : 50 } ,
	...
	{ display : '最后修改日期', name : 'lastvisitedate', align : 'center' , type : 'string' , width : 100 } ,
	...
	{ display : '操作', align : 'center' , type : 'is' , width : 250 ,render : function(row){
		...
		"&nbsp;&nbsp;<a href='javascript:;' class='link' onclick='commonSort({tableName:\"pro_products_used\",value:\""+row.factoryid+"\",catalognum:\""+row.catalognum+"\"})'>同类型产品排序</a>"+
		"&nbsp;&nbsp;<a href='javascript:;' class='link' onclick='commonSort({tableName:\"pro_products_used\",value:\""+row.factoryid+"\"})'>全部产品排序</a>" ;			 
	}
	} 
	];
