  ...
  <body style="margin: 0;padding: 0; overflow-x: hidden; overflow-y: auto; ">
	<form name="theform" id="theform" action="/backend/action/crud.jsp">
		<div class="formDiv">
			    ...
			    <div class="formRight">
			      	<input type="text" style="width: 300px;" class="jr_text" name="zd_img" id="zd_img" value="<%=CommonString.getFormatPara(model.get("img")) %>" />
			    </div>
			    <div class="formRight" style="padding-left: 140px; position: relative; top:-2px;width:240px">
				<div style="float:right"> 尺寸：300*180</div>
					<input style="float:right;" type="button" class="btn" onclick="chooseFile('zd_img',700,480);" value="选择图片" />
					<a href="javascript:void(0);" class='highslide' onclick='return smallToBig(this,"zd_img");'>
					<input style="float:right; margin-right: 5px;" type="button" class="btn" value="预览" />
					</a>
				</div>
				<div style="clear:left;"></div>
				<div class="formLeft">询底价链接</div>
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_url1" id="zd_url1" value="<%=CommonString.getFormatPara(model.get("url1")) %>" />
				</div>
				<div style="clear:left;"></div>
				<div class="formLeft">性能链接</div>
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_url2" id="zd_url2" value="<%=CommonString.getFormatPara(model.get("url2")) %>" />
				</div>
				<div style="clear:left;"></div>
				<div class="formLeft">参数链接</div>
				<div class="formRight">
				...
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_url4" id="zd_url4" value="<%=CommonString.getFormatPara(model.get("url4")) %>" />
				</div>
				<div style="clear:left;"></div>
				<div class="formLeft">图库链接</div>
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_url5" id="zd_url5" value="<%=CommonString.getFormatPara(model.get("url5")) %>" />
				</div>
				<div style="clear:left;"></div>
