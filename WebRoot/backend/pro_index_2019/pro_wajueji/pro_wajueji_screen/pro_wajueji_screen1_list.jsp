...
<script type="text/javascript">
	...
	columnsArr =  [ 
		...
		{ display : '产品名称', name : 'title', isSort : false ,  id : 'no' , align : 'left' , type : 'string' , width : 250 , render : function(row){
	...
	function addAndEdit(index){
    	if(undefined==index){//如果是增加
    	    toolbarAdd({
	    		...
	    		height:610,
	    		title:'增加',
				fileName:"pro_wajueji/pro_wajueji_screen/pro_wajueji_screen1",
