...
<script type="text/javascript">
	...
	columnsArr =  [ 
		...
		{ display : '代理商', name : 'title', isSort : false ,  id : 'no' , align : 'left' , type : 'string' , width : 250 , render : function(row){
				return "<a class='link' href='javascript:void(0);' onclick='addAndEdit("+row.__index+");'>"+row.title+"</a>";
		}},
		{ display : '代理品牌信息', name : 'sub_title', isSort : false ,  id : 'sub_title' , align : 'left' , type : 'string' , width : 150 },
	...
	function addAndEdit(index){
    	if(undefined==index){//如果是增加
    	    toolbarAdd({
	    		...
	    		height:500,
	    		title:'增加',
				fileName:"pro_wajueji/pro_wajueji_agent/pro_wajueji_agent",
