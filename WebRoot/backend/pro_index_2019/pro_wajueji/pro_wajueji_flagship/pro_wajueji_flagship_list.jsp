...
<script type="text/javascript">
	...
	columnsArr =  [ 
		...
		{ display : '品牌旗舰店', name : 'title', isSort : false ,  id : 'no' , align : 'left' , type : 'string' , width : 250 , render : function(row){
	...
	function addAndEdit(index){
    	if(undefined==index){//如果是增加
    	    toolbarAdd({
	    		...
	    		height:500,
	    		title:'增加',
				fileName:"pro_wajueji/pro_wajueji_brand/pro_wajueji_brand",
