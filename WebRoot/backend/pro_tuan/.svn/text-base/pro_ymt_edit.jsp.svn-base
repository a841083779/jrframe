...
function getShowName(row){
	...
	var num=ids.lastIndexOf(",");   
		...
		if(parent.document.getElementById("jr_ids").value==''){
			parent.document.getElementById("jr_ids").value = ids;
		}else{
			parent.document.getElementById("jr_ids").value =parent.document.getElementById("jr_ids").value+","+ids;
		}
