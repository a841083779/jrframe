...
<form name="theform" id="theform" action="/backend/action/crud.jsp">
  ...
  <div style="clear: left;"></div>
   <div class="group"> <span><img src="/plugin/ui/ligerUI/ligerUI/skins/icons/communication.gif" /></span> <span class="groupTitle">SEO信息</span> </div>
  <div style="clear: left;"></div>
    <div style="clear: left;"></div>
  <div class="formLeft">Title关键词</div>
  <div class="formRight">
    <input type="text"  class="jr_text" name="zd_title_keyword" id="zd_title_keyword" value="<%=CommonString.getFormatPara(model.get("title_keyword")) %>" />
  </div>
