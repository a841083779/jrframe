		...
		grid = jQuery("#maingrid").ligerGrid({
					...
					toolbar : {
						items : [{
									...
									if(uuid=='DD365058-E99A-4DFB-9533-FF2F4E89BACD'){
									window.open("/index_new/index_new/index_zhuangzaiji_F2_01.htm","_blank");
									}else if(uuid=='85EC635D-3011-4169-8FCD-3744717E7A4B'){
									window.open("/index_new/index_new/index_zhuangzaiji_F2_02.htm","_blank");
									}else if(uuid=='EB159382-AED4-4FBE-9624-4ABAA4707B40'){
									window.open("/index_new/index_new/index_zhuangzaiji_F2_03.htm","_blank");
									}
	...
	function addAndEdit(index){
    	if(undefined==index){//如果是增加
    	    toolbarAdd({
	    		...
	    		height:500,
	    		title:'增加',
				fileName:"pro_zhuangzaiji_F2/pro_zhuangzaiji_F2",
...
//静态页生成
	function create(){
		jQuery.ajax({
			type:'post' ,
			url:'/tools/create_index/create_index_sub.jsp?cuuid=<%=channelUUID%>' ,
