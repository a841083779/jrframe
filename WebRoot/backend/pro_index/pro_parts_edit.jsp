  ...
  <body style="margin: 0;padding: 0; overflow-x: hidden; ">
	<form name="theform" id="theform" action="/backend/action/crud.jsp">
		<div class="formDiv">
				...
				<div class="formLeft">公司名称</div>
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_sub_title" id="zd_sub_title" value="<%=CommonString.getFormatPara(model.get("sub_title")) %>" />
				</div>
				<div style="clear:left;"></div>
				<div class="formLeft">价格</div>
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_cate" id="zd_cate" value="<%=CommonString.getFormatPara(model.get("cate")) %>" />
				</div>
				<div style="clear:left;"></div>
