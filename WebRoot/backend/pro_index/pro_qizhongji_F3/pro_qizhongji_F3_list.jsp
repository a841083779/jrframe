		...
		grid = jQuery("#maingrid").ligerGrid({
					...
					toolbar : {
						items : [{
									...
									if(uuid=='5B559042-3E60-439C-B294-CE7C6DA0BD72'){
									window.open("/create/index_new/index_qizhongji_F3_01.htm","_blank");
									}else if(uuid=='728F22B1-2CBC-4635-911B-8F55101C53CE'){
									window.open("/create/index_new/index_qizhongji_F3_02.htm","_blank");
									}else if(uuid=='60569883-FBA4-4AF7-9793-EFD9185697B0'){
									window.open("/create/index_new/index_qizhongji_F3_03.htm","_blank");
									}
	...
	function addAndEdit(index){
    	if(undefined==index){//如果是增加
    	    toolbarAdd({
	    		...
	    		height:500,
	    		title:'增加',
				fileName:"pro_qizhongji_F3/pro_qizhongji_F3",
