	...
	<form name="theform" id="theform" action="/backend/action/crud.jsp">
		<div class="formDiv">
				...
				<div style="clear:left;"></div>
					<div class="formLeft" style="margin-bottom: 35px;">简介</div>
				<div class="formRight">
				<textarea  class="jr_textarea" name="zd_intro" id="zd_intro"><%=CommonString.getFormatPara(model.get("intro")) %></textarea>
					
				</div>
				<div style="clear:left;"></div>
				<div class="formLeft">作者</div>
				<div class="formRight">
