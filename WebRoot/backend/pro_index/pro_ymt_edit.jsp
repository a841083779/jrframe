	...
	<form name="theform" id="theform" action="/backend/action/crud.jsp">
		<div class="formDiv">
			 ...
			 <div class="formLeft">产品图片</div>
				...
				<div style="clear:left;"></div>
				<div class="formLeft">总台数/原价</div>
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_area"  Style="width:100px;float: left;" id="zd_area" value="<%=CommonString.getFormatPara(model.get("area")) %>" />
				</div>
				<div style="clear:left;"></div>
				<div class="formLeft">剩余台数/优惠价</div>
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_area_name"  Style="width:100px;float: left;" id="zd_area_name" value="<%=CommonString.getFormatPara(model.get("area_name")) %>" />
				</div>
				<div style="clear:left;"></div>
				...
				%>
				<%=CommonForm.createRadio(ymtMap,position,"zd_sort_flag") %>
				</div>
				<div style="clear:left;"></div>
				<div class="formLeft">结束时间</div>
				<div class="formRight" style="width:120px;">
				<%
					String end_time = CommonString.getFormatPara(model.get("end_time"));
					if(end_time==null || end_time.equals("")){
						end_time = CommonDate.getToday("yyyy-MM-dd HH:mm:ss");
					}
					
					%>
					<input type="text" name="zd_end_time" id="zd_end_time" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" value="<%=end_time %>">
				</div>
				<div style="clear:left;"></div>
