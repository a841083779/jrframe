...
<%
	...
	String fileds = "id,add_date,factoryname,cataname,name,product_name,contact_address,contact_tel,state,mobile_phone,product_id,city,is_success,uuid";
...
<form name="theform" id="theform" method="get">
  <div class="searchForm">
    <div class="searchCondition" style="width:88%">
      ...
      <div class="searchLeft">主动咨询</div>
      <div class="searchRight"> <%=commonForm.createRadio(stateMap,"-1","is_first") %> </div>
      <div class="searchLeft">删除时间</div>
      <div class="searchRight">
        <input type="text" onfocus="WdatePicker()" class="Wdate" name="del_date" id="del_date" />
      </div>
    </div>
...
<script type="text/javascript">
	...
	{ display : '订购产品', name : 'product_name', align : 'left' , type : 'string' , width : 100 ,render:function(row){
	   return (row.product_name==null?"":row.product_name) ;
	  }
	} ,
	...
	{ display : '删除时间', name : 'del_date', align : 'center' , type : 'string' , width : 150 ,render:function(row){
	      return (row.del_date.length>=19)?row.del_date.substr(0,19):row.del_date ;
	  }
	} ,

	{ display : '删除人', name : 'add_user', align : 'left' , type : 'string' , width : 90 } 
   ...
   // 	} 
	...
	//		if(row.factoryid=="174"||row.factoryid=="138"){
