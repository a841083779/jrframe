...
<%
		...
		try {
				...
				sql = " INSERT INTO pro_products_20140321 ( add_user , add_date , add_ip , uuid ,catalogid,factoryid,factoryname,catalogname,name,introduce,file_name,img2,page_hot_flag,is_show) ";
				sql += " VALUES ( ? , ? , ? , ? , ? , ?,?,?,?,?,?,? ,?,?) ";
