<%@ page language="java" import="java.util.*,com.jerehnet.util.common.*" pageEncoding="UTF-8"%><%
	...
	String tableName = "pro_factory_category";
...
<script type="text/javascript">
	...
	columnsArr =  [ 
		...
		return "<a class='link' href='javascript:void(0);' onclick=commonSort({tableName:\"<%=tableName %>\",value:\""+row.parentid+"\",factoryid:\""+row.factoryid+"\"});>同级排序</a>";
			}
		}
	];
