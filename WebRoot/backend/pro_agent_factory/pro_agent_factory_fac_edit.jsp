	...
	<form name="theform" id="theform" action="/backend/action/crud.jsp">
		<div class="formDiv">
				...
				<div class="formRight"  style="width:200px;">
					...
					<div style="clear:left;"></div>
				<div class="formLeft">厂商英文名</div>
				<div class="formRight" style="width:200px;">
					<input type="text" style="width:100%" dataType='Require' msg='请输入厂商英文名' class="jr_text" name="zd_english_name" id="zd_english_name" value="<%=CommonString.getFormatPara(model.get("english_name")) %>" />
				</div>
				<div style="clear:left;"></div>
	    ...
	    <div class="formRight" style="height: 220px; text-align: left;"> 
	      ...
	      <input type="hidden" name="zd_introduce" id="zd_introduce" value='' />
				...
				<div class="formRight" style="padding-left: 220px; position: relative; top:-2px;">
					<input style="float:right;" type="button" class="btn" onclick="chooseFiles('zd_logo',700,480);" value="选择图片" />
				...
				<div class="formRight">
					...
					<div class="formRight" style="padding-left: 220px; position: relative; top:-2px;">
					<input style="float:right;" type="button" class="btn" onclick="chooseFiles('zd_img1',700,480);" value="选择图片" />
				...
				<div class="formRight" style="padding-left: 220px; position: relative; top:-2px;">
					<input style="float:right;" type="button" class="btn" onclick="chooseFiles('zd_banner',700,480);" value="选择图片" />
		...
		<%if(!CommonString.getFormatPara(model.get("id")).equals("141")){%>
		<input type="hidden" name="eventAfter" id="eventAfter" value="updateBrand,open_mem_shop,updateBrandSpec,brandCreate"/>
		<%}else{%>
		<input type="hidden" name="eventAfter" id="eventAfter" value="updateBrand"/>
		<%}%>
...
<script type="text/javascript">
	...
	function doSub(){
		...
		jQuery.post("/tools/create/create_one_brand_detail_new.jsp?usern="+user,function(out){ 
		if(rs){
 ...
 *            id
 */
function chooseFiles(id, w, h) {
	var url = "/backend/function/file/choose_list_no.jsp?id=" + id;
	var title = "选择";
	var width = 650;
	if (w != undefined) {
		width = w;
