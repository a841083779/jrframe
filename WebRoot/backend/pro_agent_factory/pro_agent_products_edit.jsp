...
.l-grid-body-table tr td {
	...
	<div class="searchForm" style="width:750px;">
...
<script type="text/javascript">
	...
	{ display : '产品排序', align : 'center' , type : 'is' , width : 150 ,render : function(row){
		return "<a href='javascript:;' class='link' onclick='common_Agent_product_Sort({tableName:\"pro_agent_product_vi\",value:\""+row.factoryid+"\",agentid:\""+row.agentid+"\"})'>同品牌产品排序</a>";
	}}
	];
