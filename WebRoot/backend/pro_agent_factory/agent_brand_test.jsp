...
<head>
	...
	<script src="http://www.ligerui.com/lib/jquery/jquery-1.9.0.min.js" type="text/javascript"></script> 
    <script src="http://www.ligerui.com/lib/ligerUI/js/core/base.js" type="text/javascript"></script>
    <script src="http://www.ligerui.com/lib/ligerUI/js/plugins/ligerResizable.js" type="text/javascript"></script>
    <script src="http://www.ligerui.com/lib/ligerUI/js/plugins/ligerTree.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		$(function ()
        {
            ...
            var combo1 = $("#txt1").ligerComboBox({
                ...
                tree: { url: 'tree/json.txt', ajaxType: 'get', idFieldName: 'text' }
            }); 
            ...
            var combo2 = $("#txt2").ligerComboBox({
                ...
                tree: { url: 'tree/json.txt', checkbox: false, ajaxType: 'get', idFieldName: 'text' }
            });
