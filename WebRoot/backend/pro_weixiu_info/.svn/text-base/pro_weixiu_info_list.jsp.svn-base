<%@ page language="java" import="java.util.*,com.jerehnet.util.common.*" pageEncoding="UTF-8"%><%
	...
	String fileds = "title,content,is_show,view_count,username,factory,catalog";
...
<script type="text/javascript"><!--
   ...
   { display : 'ID', name : 'id', align : 'left' , type : 'string' , width : 50 } ,
	...
	{ display : '作者', name : 'username', align : 'left' , type : 'string' , width : 110 } ,
	
	{ display : '点击量', name : 'view_count', align : 'left' , type : 'string' , width : 150 } ,
