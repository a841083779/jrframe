...
<%
	...
	try{
	    ...
	    List<Map> list=dbHelper.getMapList("select   catanum,count(catanum) as counts,province from pro_product_form where is_deleted=0 "+whereStr+" group by catanum,province   ");
	    
		List<Map> list1=dbHelper.getMapList("select   catanum,count(catanum) as counts,province from pro_product_form where product_id in(select id from pro_products   where is_show=1 and  tonandmeter=3  and catalognum like '101002%') and  is_deleted=0 "+whereStr+" group by catanum,province   ");
		
		List<Map> list2=dbHelper.getMapList("select   catanum,count(catanum) as counts,province from pro_product_form where product_id in(select id from pro_products   where is_show=1 and  tonandmeter=5  and catalognum like '101002%') and  is_deleted=0 "+whereStr+" group by catanum,province   ");
	...
	if(list != null && list.size() > 0){
				for(Map m : list){
					...
					if(CommonString.getFormatPara(m.get("province")).equals("北京")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_1=a_1+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
							b_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001004")){
							c_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_1=d_1+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_1=g_1+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_1=h_1+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
							i_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102002")){
							j_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102003")){
							k_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_1=l_1+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
							m_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103019")){
							n_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_1=o_1+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
							p_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("105009")){
							q_1=CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_1=r_1+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_1=s_1+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_1=t_1+CommonString.getFormatInt(m.get("counts"));
						}
						
	 
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("天津")){
						
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_2=a_2+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_2=d_2+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_2=g_2+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_2=h_2+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_2=l_2+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_2=o_2+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_2=r_2+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_2=s_2+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_2=t_2+CommonString.getFormatInt(m.get("counts"));
						}
						
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("上海")){

						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_3=a_3+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_3=d_3+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_3=g_3+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_3=h_3+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_3=l_3+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_3=o_3+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_3=r_3+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_3=s_3+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_3=t_3+CommonString.getFormatInt(m.get("counts"));
						}
					
					}
					if(CommonString.getFormatPara(m.get("province")).equals("广西")){
						
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_4=a_4+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_4=d_4+CommonString.getFormatInt(m.get("counts"));	
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_4=g_4+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_4=h_4+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_4=l_4+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_4=o_4+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_4=r_4+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_4=s_4+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_4=t_4+CommonString.getFormatInt(m.get("counts"));
						}
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("河北")){
						
                        if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_5=a_5+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_5=d_5+CommonString.getFormatInt(m.get("counts"));	
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_5=g_5+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_5=h_5+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_5=l_5+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_5=o_5+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_5=r_5+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_5=s_5+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_5=t_5+CommonString.getFormatInt(m.get("counts"));
						}
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("江西")){
						
					    if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_6=a_6+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_6=d_6+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_6=g_6+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_6=h_6+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_6=l_6+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_6=o_6+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_6=r_6+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_6=s_6+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_6=t_6+CommonString.getFormatInt(m.get("counts"));
						}
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("安徽")){
						
                        if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_7=a_7+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_7=d_7+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_7=g_7+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_7=h_7+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_7=l_7+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_7=o_7+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_7=r_7+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_7=s_7+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_7=t_7+CommonString.getFormatInt(m.get("counts"));
						}
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("河南")){
						
                        if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_8=a_8+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_8=d_8+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_8=g_8+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_8=h_8+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_8=l_8+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_8=o_8+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_8=r_8+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_8=s_8+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_8=t_8+CommonString.getFormatInt(m.get("counts"));
						}
						
 
					}
					if(CommonString.getFormatPara(m.get("province")).equals("贵州")){
						

                        if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_9=a_9+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_9=d_9+CommonString.getFormatInt(m.get("counts"));	
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_9=g_9+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_9=h_9+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_9=l_9+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_9=o_9+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_9=r_9+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_9=s_9+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_9=t_9+CommonString.getFormatInt(m.get("counts"));
						}
						
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("山东")){
						
                        if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_10=a_10+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_10=d_10+CommonString.getFormatInt(m.get("counts"));	
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_10=g_10+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_10=h_10+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_10=l_10+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o
CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_27=g_27+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_27=h_27+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_27=l_27+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_27=o_27+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_27=r_27+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_27=s_27+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_27=t_27+CommonString.getFormatInt(m.get("counts"));
						}
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("重庆")){
						
                        if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_28=a_28+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_28=d_28+CommonString.getFormatInt(m.get("counts"));		
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_28=g_28+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_28=h_28+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_28=l_28+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_28=o_28+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_28=r_28+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_28=s_28+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_28=t_28+CommonString.getFormatInt(m.get("counts"));
						}
						
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("四川")){
						
                        if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_29=a_29+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_29=d_29+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_29=g_29+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_29=h_29+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_29=l_29+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_29=o_29+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_29=r_29+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_29=s_29+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_29=t_29+CommonString.getFormatInt(m.get("counts"));
						}
						
						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("宁夏")){
						
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_30=a_30+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_30=d_30+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_30=g_30+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_30=h_30+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_30=l_30+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_30=o_30+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_30=r_30+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_30=s_30+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_30=t_30+CommonString.getFormatInt(m.get("counts"));
						}

						
					}
					if(CommonString.getFormatPara(m.get("province")).equals("西藏")){
						
                        if(CommonString.getFormatPara(m.get("catanum")).indexOf("101001")>=0){
							a_31=a_31+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("101001001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("101002")>=0){
							d_31=d_31+CommonString.getFormatInt(m.get("counts"));
							
						} 
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("106001")>=0){
							g_31=g_31+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("102")>=0){
							h_31=h_31+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("102007")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("103")>=0){
							l_31=l_31+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("103001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("104")>=0){
							o_31=o_31+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).equals("104001")){
						...
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("118")>=0){
							r_31=r_31+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("122")>=0){
							s_31=s_31+CommonString.getFormatInt(m.get("counts"));
						}
						if(CommonString.getFormatPara(m.get("catanum")).indexOf("107")>=0){
							t_31=t_31+CommonString.getFormatInt(m.get("counts"));
						}
	   ...
	   //List<Map> list2=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='天津' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list3=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='上海' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list4=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='广西' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list5=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='河北' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list6=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='江西' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list7=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='安徽' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list8=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='河南' group by catanum  order by count(catanum) desc,catanum desc  ");
	   
	   //List<Map> list9=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='贵州' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list10=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='山东' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list11=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='云南' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list12=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='青海' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list13=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='海南' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list14=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='内蒙古' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list15=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='福建' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list16=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='广东' group by catanum  order by count(catanum) desc,catanum desc  ");
	   
	   //List<Map> list17=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='新疆' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list18=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='湖北' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list19=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='山西' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list21=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='吉林' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list22=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='辽宁' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list23=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='黑龙江' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list24=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='甘肃' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list25=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='陕西' group by catanum  order by count(catanum) desc,catanum desc  ");
	   
	   //List<Map> list26=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='湖南' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list27=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='江苏' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list28=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='浙江' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list29=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='重庆' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list30=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='四川' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list31=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='宁夏' group by catanum  order by count(catanum) desc,catanum desc  ");
	   //List<Map> list32=dbHelper.getMapList("select top 50  catanum,count(catanum) as a from pro_product_form where is_deleted=0 and province='西藏' group by catanum  order by count(catanum) desc,catanum desc  ");
...
<div style="width:100% ;float:left;margin-top:-9px;height:100%;">
  <div style="height:72%;">
    <table width="100%;height:100%;" cellspacing="0" cellpadding="0" border="0" class="tableList tableList01">
      <tbody>
        ...
        <tr class="">
          <td style="text-align:center;">挖机及属具</td>
        ...
        <tr class="">
          <td style="text-align:center;">履带挖掘机</td>
        ...
        <tr class="">
          <td style="text-align:center;">轮式挖掘机</td>
		 ...
		 <tr class="">
          <td style="text-align:center;">装载机</td>
        ...
        <tr class="">
          <td style="text-align:center;">3吨装载机</td>
        ...
        <tr class="">
          <td style="text-align:center;">5吨装载机</td>
        ...
        <tr class="">
          <td style="text-align:center;">压路机</td>
        ...
        <tr class="">
          <td style="text-align:center;">起重机</td>
        ...
        <tr class="">
          <td style="text-align:center;">汽车起重机</td>
        ...
        <tr class="">
          <td style="text-align:center;">塔式起重机</td>
        ...
        <tr class="">
          <td style="text-align:center;">高空作业车</td>
        ...
        <tr class="">
          <td style="text-align:center;">混凝土设备</td>
        ...
        <tr class="">
          <td style="text-align:center;">混凝土泵车</td>
        ...
        <tr class="">
          <td style="text-align:center;">搅拌运输车</td>
        ...
        <tr class="">
          <td style="text-align:center;">路面设备</td>
        ...
        <tr class="">
          <td style="text-align:center;">摊铺机</td>
        ...
        <tr class="">
          <td style="text-align:center;">桩机</td>
        ...
        <tr class="">
          <td style="text-align:center;">专用车</td>
	     ...
	     <tr class="">
          <td style="text-align:center;">环卫车</td>
		  ...
		  <tr class="">
          <td style="text-align:center;">叉车</td>
          <td style="text-align: center;color: #000;"><%=t_1%></td>
          <td style="text-align: center;color: #000;"><%=t_2%></td>
          <td style="text-align: center;color: #000;"><%=t_3%></td>
          <td style="text-align: center;color: #000;"><%=t_4%></td>
          <td style="text-align: center;color: #000;"><%=t_5%></td>
          <td style="text-align: center;color: #000;"><%=t_6%></td>
          <td style="text-align: center;color: #000;"><%=t_7%></td>
          <td style="text-align: center;color: #000;"><%=t_8%></td>
          <td style="text-align: center;color: #000;"><%=t_9%></td>
          <td style="text-align: center;color: #000;"><%=t_10%></td>
          <td style="text-align: center;color: #000;"><%=t_11%></td>
          <td style="text-align: center;color: #000;"><%=t_12%></td>
          <td style="text-align: center;color: #000;"><%=t_13%></td>
          <td style="text-align: center;color: #000;"><%=t_14%></td>
          <td style="text-align: center;color: #000;"><%=t_15%></td>
          <td style="text-align: center;color: #000;"><%=t_16%></td>
          <td style="text-align: center;color: #000;"><%=t_17%></td>
          <td style="text-align: center;color: #000;"><%=t_18%></td>
          <td style="text-align: center;color: #000;"><%=t_19%></td>
          <td style="text-align: center;color: #000;"><%=t_20%></td>
          <td style="text-align: center;color: #000;"><%=t_21%></td>
          <td style="text-align: center;color: #000;"><%=t_22%></td>
          <td style="text-align: center;color: #000;"><%=t_23%></td>
          <td style="text-align: center;color: #000;"><%=t_24%></td>
          <td style="text-align: center;color: #000;"><%=t_25%></td>
          <td style="text-align: center;color: #000;"><%=t_26%></td>
          <td style="text-align: center;color: #000;"><%=t_27%></td>
          <td style="text-align: center;color: #000;"><%=t_28%></td>
          <td style="text-align: center;color: #000;"><%=t_29%></td>
          <td style="text-align: center;color: #000;"><%=t_30%></td>
          <td style="text-align: center;color: #000;"><%=t_31%></td>
        </tr>
...
jQuery(function(){
	...
	jQuery("#catanum option").each(function(){
	      if(jQuery(this).val()=='<%=catanum%>'){
	      	jQuery(this).attr("selected","selected") ;
	      	return  ;
	      }
	}) ;
