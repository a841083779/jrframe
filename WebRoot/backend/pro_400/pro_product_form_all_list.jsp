<%@ page language="java" import="java.util.*,com.jerehnet.util.common.*,com.jerehnet.util.dbutil.*" pageEncoding="UTF-8"%><%
	...
	String fileds = "id,province,city,name,mobile_phone,factoryname,product_name,cataname,buy_time,buy_type,add_date,call_rs,is_buy_self,call_rs_task2,is_success,is_first";
	...
	String whereStr = " and is_garbage!=1 and  ( task1_over = 0 or task2_over = 0 )";
        ...
        <div class="jr_radio_group">
          ...
          <label for="is_first2">全部</label>
		  		...
		  		<div class="searchRight">
					...
					<!--
		  			<input type="button" value="一键导出EXCEL" title="导出前一天16点至第二天16点的订单" onclick="dosubmitOld(2);"/>
				    -->
		  		</div>
  		</div>
  		<div class="searchBtn">
...
<script type="text/javascript">
	...
	function agentList(index){
		...
		if(''!=jQuery.trim(is_360)){
			if(is_360=='1'){
				conditionStr += " and  add_user='360youli' ";
			}
			if(is_360=='0'){
				conditionStr += " and  (add_user!='360youli' or add_user='' or add_user is null ) ";
			}
		}
		...
		if(''!=jQuery.trim(cat_catalog)){
			if(cat_catalog=='0'){
			    conditionStr += " and product_id in(29171,29172,29173,29176,29178,29444,25480,23906,25477,23911,23910,23909,23908,23907,19946,11366,9555,9554,9553,9552,9551,9550,9548,9547,3525,3503,522,445,407,403,400,390,378) ";
			}
			if(cat_catalog=='1'){
