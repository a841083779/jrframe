...
<%
		...
		try {
				...
				List<Map> proList= (ArrayList)(dbHelper.getMapList(" select id,name from pro_products where is_show=1 and  factoryid =  "+CommonString.getFormatPara(formMap.get("factoryid")),connection));
