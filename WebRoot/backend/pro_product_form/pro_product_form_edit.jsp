	...
	<form name="theform" id="theform" action="/backend/action/crud.jsp">
		...
		<div class="group">
			...
			<span class="groupTitle">产品信息</span>
				...
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_cataname" id="zd_cataname" value="<%=CommonString.getFormatPara(model.get("cataname")) %>" />
				</div>
				<div style="clear:left;"></div>
				...
				<%if(usern.equals("zhangjx")||usern.equals("admin")||usern.equals("zhangxuan")){%>
				<div style="clear:left;"></div>
				<div class="formLeft">产品ID</div>
				<div class="formRight">
					<input type="text" class="jr_text" name="zd_product_id" id="zd_product_id" value="<%=CommonString.getFormatPara(model.get("product_id")) %>" />
				</div>
				<%}%>
				<div class="group">
				<span>
				...
				<div style="clear:left;"></div>
				<div style="clear:left;"></div>
				<div class="formLeft">所在省</div>
				<div class="formRight" style="width:200px;" >
					<input type="text"  style="width:200px;" class="jr_text" name="zd_province" id="zd_province" value="<%=CommonString.getFormatPara(model.get("province")) %>" />
				</div>
				<div class="formLeft">所在市</div>
				<div class="formRight" >
					<input type="text" style="width:230px;" class="jr_text" name="zd_city" id="zd_city" value="<%=CommonString.getFormatPara(model.get("city")) %>" />
				    <input type="hidden" style="width:230px;" class="jr_text" name="zd_contact_address" id="zd_contact_address" value="<%=CommonString.getFormatPara(model.get("contact_address"))%>" />
				</div>
				<div style="clear:left;"></div>
...
jQuery(function(){
	...
	function doSub(){
	   $("#zd_contact_address").val($("#zd_province").val()+$("#zd_city").val());
	   //alert($("#zd_contact_address").val());
