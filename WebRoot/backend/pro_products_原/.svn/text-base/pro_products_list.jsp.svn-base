...
<script type="text/javascript">
   ...
   { display : 'ID', name : 'id', align : 'left' , type : 'string' , width : 50 } ,
	...
	{ display : '关注度', name : 'view_count', align : 'center' , type : 'string' , width : 50 } ,
	...
	{ display : '操作', align : 'center' , type : 'is' , width : 250 ,render : function(row){
		...
		"&nbsp;&nbsp;<a href='javascript:;' class='link' onclick='commonSort({tableName:\"pro_products\",value:\""+row.factoryid+"\",catalognum:\""+row.catalognum+"\"})'>同类型产品排序</a>"+
		"&nbsp;&nbsp;<a href='javascript:;' class='link' onclick='commonSort({tableName:\"pro_products\",value:\""+row.factoryid+"\"})'>全部产品排序</a>" ;			 
	}
	},
	{ display : '优买团', align : 'center' , type : 'is' , width : 50,render:function(row){
	  		return "<a class='link' href='javascript:void(0);' onclick='pushOrder("+row.__index+");'>添加</a>";
    	   } 
	} 
	];
